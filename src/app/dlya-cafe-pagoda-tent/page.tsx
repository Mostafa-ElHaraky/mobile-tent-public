...
export const metadata: Metadata = {
  title: "Купить шатры Пагода для кафе, ресторанов, торговых точек по доступным ценам на MOBILE TENT",
  description: "Закажите шатры Пагода для кафе, ресторанов, торговых точек по оптимальной цене с доставкой по всей РФ. Покупайте прямо сейчас на MOBILE TENT!",
