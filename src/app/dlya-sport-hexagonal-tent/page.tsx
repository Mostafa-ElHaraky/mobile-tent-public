...
export const metadata: Metadata = {
  title: "Купить гексагональные шатры для спорта по доступной цене в MOBILE TENT",
  description: "Заказать гексагональные спортивные шатры для спортивно-массовых мероприятий по сниженной стоимости от производителя. Доставка, гарантии, скидки.",
