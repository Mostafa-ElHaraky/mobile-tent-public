...
export const metadata: Metadata = {
  title: "Купить натяжные шатры для спорта по лучшей цене от производителя",
  description: "Купить натяжные шатры для спортивно-массовых мероприятий по выгодной стоимости в MOBILE TENT. Доставляем по всей России. Предоставляем скидки, качество гарантируем!",
