  ...
  return (
    <main className="relative w-full max-w-[1440px] bg-white mx-auto">
      ...
      <h1 className="absolute w-[1px] h-[1px] p-0 -m-[1px] overflow-hidden whitespace-nowrap border-0 clip-[rect(0,0,0,0)]">
        Натяжные шатры для спортивно-массовых мероприятий в Москве напрямую от производителя MobilTent с гарантией сохранения внешнего вида в течении 15 лет
      </h1>
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <div className="flex flex-col items-start gap-3 w-full">
                  ...
                  <div className="w-full font-medium text-2xl sm:text-2xl text-left [font-family:'Raleway',Helvetica] leading-tight" role="heading" aria-level={2}>
                    <span className="text-[#335dc2]">ДЛЯ СПОРТИВНО-МАССОВЫХ МЕРОПРИЯТИЙ — НАТЯЖНЫЕ ШАТРЫ</span>
