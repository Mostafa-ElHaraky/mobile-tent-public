...
export const metadata: Metadata = {
  title: "Арочные ангары для временных складов и гаражей купить по доступной цене от производителя",
  description: "Заказать арочные ангары для временных складов и гаражей недорого от производителя. Быстрая доставка по стране и приятные скидки!",
