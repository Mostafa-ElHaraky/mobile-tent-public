...
export const metadata: Metadata = {
  title: "Купить шатры пагода для временных ангаров по оптимальной цене в MOBILE TENT",
  description: "Заказать временные шатры пагода для ангаров, гаражей, складов по ценам от производителя. Быстрая доставка по РФ, гарантии от производителя, скидки.",
