...
export const metadata: Metadata = {
  title: "Купить гексагональный шатер для выставки - выгодные цены от MOBILE TENT",
  description: "Купить гексагональный шатер для выставки по выгодной цене. Большой выбор гексагональных шатров для выставок различных размеров и конфигураций. Узнайте цены и получите консультацию на Mobile Tent.",
