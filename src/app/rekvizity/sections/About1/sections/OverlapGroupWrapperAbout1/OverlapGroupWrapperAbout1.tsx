  ...
  const teamMembers: Member[] = [
    {
      ...
      skills: ["Стратегия", "Операционное управление", "B2B"],
    ...
    },
    {
      ...
      skills: ["Лиды", "Аналитика", "Контент"],
      links: { linkedin: "https://linkedin.com", email: "marketing@grand-tent.ru" },
    },
    {
      id: 3,
      name: "Демидова Юлия",
    ...
    },
    {
      ...
      location: "Москва",
      tenureYears: 4,
      skills: ["Координация", "Документооборот"],
    },
    {
      id: 5,
      name: "Альхераки Мостафа",
      role: "Full Stack разработчик , Cпециалист по кибербезопасности",
      image: "/Альхераки Мостафа.webp",
      objectPosition: "center 40%",
      department: "Финансы",
      location: "Москва",
      tenureYears: 6,
      skills: ["МСФО", "Налоги", "1С"],
    },
    {
      id: 6,
      ...
      location: "Удалённо",
      tenureYears: 8,
      experience: "Обеспечение качества с 2017 года",
      skills: ["UI тесты", "Автотесты", "Jest"],
    },
    {
      id: 7,
      ...
      location: "Москва",
      tenureYears: 7,
      experience: "Анализ данных с 2018 года",
      skills: ["ML", "Python", "ETL"],
    },
  ];
