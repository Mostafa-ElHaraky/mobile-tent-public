...
export const About1 = (): ReactElement => {
  ...
  return (
    <>
      ...
      <h1 className="sr-only">О компании MobileTent - Производство и продажа тентовых конструкций и шатров по всей России и СНГ</h1>
