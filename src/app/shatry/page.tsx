...
export const metadata: Metadata = {
  title: "Купить тент шатер: каталог шатров с ценами - тентовые павильоны в продаже на MOBILE TENT",
  description: "Ищете идеальный тент шатер по выгодной цене? Обратите внимание на наш обширный каталог шатров. У нас вы найдёте разнообразие тентовых павильонов на любой вкус и бюджет. Выберите и купите идеальный шатёр для вашего мероприятия у нас!",
