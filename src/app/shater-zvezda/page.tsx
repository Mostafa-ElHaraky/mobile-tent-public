...
export const metadata: Metadata = {
  title: "Купить шатры Звезда по доступной цене от MOBILE TENT",
  description: "Купить шатры звезда в Москве и России. Заказать шатры звезда по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
