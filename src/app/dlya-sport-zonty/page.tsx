...
export const metadata: Metadata = {
  title: "Купить зонты для спортивных мероприятий недорого по цене от производителя",
  description: "Заказать зонты для спортивных мероприятий по цене производителя. Широкий ассортимент, быстрая доставка, скидки.",
