...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Классический шатёр 20х35
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Классический шатёр 20х35",
      text: `Классический шатёр 20х35 м просто идеален для проведения спортивных и корпоративных мероприятий, праздников и свадеб на природе. Хорошую прибыль принесёт он ресторанам и кафе, организующим в тёплое время года обслуживание клиентов вне капитальных строений.`,
    },
    {
      title: "Рекомендации по использованию",
      text: `Для непродолжительной эксплуатации советуем арендовать классический шатёр 20х35 м. Компания изготавливает тентовые конструкции не только по собственным проектам, но и по разработкам и эскизам, предоставленным клиентами. Специалисты нашей компании также помогут вам провести комплексное обслуживание всех элементов шатра или их ремонт.`,
    },
    {
      title: "Особенности монтажа",
      text: `Монтаж конструкции:
• подготовка площадки;
• установка стоек и растяжек;
• натягивание полотна;
• укладка настила;
• закрепление шатра.

Разборка выполняется в обратной последовательности. Не рекомендуется устанавливать тентовые шатры при сильном ветре и в дождь.`,
    },
    {
...
Крепёжные элементы — оцинкованная сталь DIN 50976.`,
    ...
    {
      title: "Эксплуатация и опции",
      text: `Эксплуатировать классический шатёр размером 20х35 м рекомендуется при температуре окружающего воздуха от +15°C и выше.
По желанию клиента мы меблируем шатёр, устанавливаем пол, кондиционеры и другое оборудование.`,
    },
    {
      title: "Услуги компании",
      text: `Услуги нашей компании привлекательны в первую очередь тем, что оказываются качественно, недорого и в сжатые сроки.`,
    },
  ];

  // TECH SPECS — UPDATED with data for 20x35m tent
