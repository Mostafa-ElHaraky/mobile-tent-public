...
const tentSequences = [
  ...
  const specifications = [
    { label: "Размер:", value: "12 м" },
    { label: "Площадь:", value: "113.04 м²" },
    { label: "Форма:", value: "Звезда" },
    { label: "Вместимость:", value: "48 человек" },
    { label: "Ширина:", value: "12м" },
    { label: "Длина:", value: "12м" },
