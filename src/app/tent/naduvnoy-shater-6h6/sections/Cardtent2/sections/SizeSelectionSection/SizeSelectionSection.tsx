...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Надувной шатер 6х6
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Надувной шатёр 6х6",
      text: "Технические характеристики и параметры модели ниже.",
    },
    {
      title:
        "Надувной шатёр 6х6 от Мобайл-тент — быстрое и удобное решение для мероприятий",
...
Компания Мобайл-тент более 10 лет успешно занимается производством шатров и заслужила доверие клиентов по всей России.`,
    ...
    {
      title: "Технические характеристики и преимущества Надувного шатра 6х6",
      text: `Особенности конструкции:

• Быстрая установка (5–10 минут) с помощью электрического насоса.  
...
Ответ: Конструкция выполнена из усиленного ПВХ и выдерживает нагрузку ветра и дождя.`,
    },
    {
      ...
      text: `Закажите надувной шатёр 6х6 сегодня и обеспечьте своему событию надежное и стильное пространство!`,
    },
  ];

  // TECH SPECS — UPDATED for Надувной шатер 6х6
  const specs: { label: string; value: string }[] = [
    { label: "Серия/Модель", value: "Надувной шатёр 6х6" },
    { label: "Площадь", value: "36 м²" },
    { label: "Размер", value: "6х6 м" },
    { label: "Высота стенки", value: "около 2.5 м" },
    { label: "Высота в коньке", value: "около 3.5 м" },
