...
const tentSequences = [
  {
    basePath: "/24x16/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "24x16 м" },
    { label: "Площадь:", value: "384 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "256 человек" },
    { label: "Длина:", value: "24м" },
    { label: "Ширина:", value: "16м" },
    { label: "Высота входной арки:", value: "8м" },
    { label: "Высота в коньке:", value: "24м" },
  ...
  const thumbnails = [
  { id: 1, src: "/30x20.webp", alt: "Product 1" },
  { id: 2, src: "/30x20,2.webp", alt: "Product 2" },
  { id: 3, src: "/30x20,3.webp", alt: "Product 3" },
  ...
  const performDownloadKP = async () => {
    ...
    const productImage = thumbnails[0]?.src || "/30x20.webp";
        ...
        <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
          <div className="flex flex-col w-full max-w-[658px]">
            <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
              {pageName || "Арочный шатёр 24х16 — 384 м²"}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="absolute top-[5px] left-[750px] z-10">
              <div className="font-normal text-[#394355] text-base leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0] mb-4">
                ...
                <span className="font-semibold underline">195</span>
              </div>
