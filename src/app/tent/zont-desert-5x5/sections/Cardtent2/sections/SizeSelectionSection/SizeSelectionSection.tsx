...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Desert 5×5
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Desert 5×5 — 25 м² защиты от солнца и осадков",
      text: `Квадратный зонтовый навес с центральной стойкой — аккуратное и функциональное решение для летних веранд, уличных кафе, зон ожидания и мероприятий. Компактный размер 5×5 м обеспечивает 25 м² полезной площади при лёгком и быстром монтаже.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — квадрат. Стойка расположена по центру для равномерного распределения нагрузки.
Все элементы каркаса изготовлены из высококачественной стали; крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
    },
  ];

  // TECH SPECS — UPDATED for Зонт Desert 5×5
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Desert 5×5" },
    ...
    { label: "Каркас", value: "Все элементы изготовлены из высококачественной стали" },
    { label: "Крепёж", value: "Оцинкованная сталь" },
  ];
