...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр Звезда (Диаметр 14 м)
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр Звезда (Диаметр 14 м) — надёжное решение для мероприятий",
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
  ...
  // TECH SPECS — UPDATED for Шатёр Звезда (Диаметр 14 м)
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шатёр Звезда (Диаметр 14 м)" },
    { label: "Форма", value: "Круг" },
    { label: "Площадь", value: "153,86 м²" },
    { label: "Длина", value: "14 м" },
    { label: "Ширина", value: "14 м" },
    { label: "Высота в коньке", value: "6 м" },
    { label: "Материал купола", value: "ПВХ 460 г/м²" },
  ];
