...
const tentSequences = [
  {
    basePath: "/large_star/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "14 м" },
    { label: "Площадь:", value: "153.86 м²" },
    { label: "Форма:", value: "Звезда" },
    { label: "Вместимость:", value: "103 человек" },
    { label: "Ширина:", value: "14м" },
    { label: "Длина:", value: "14м" },
...
const thumbnails = [
  { id: 1, src: "/zvezda.webp", alt: "Product 1" },
  { id: 2, src: "/zvezda1.webp", alt: "Product 2" },
  { id: 3, src: "/zvezda2.webp", alt: "Product 3" },
  ...
  const configOptions = [
    ...
    { 
      ...
      isActive: false,
      currentPrice: 890200,
      originalPrice: 1186000,
      discount: 25
    },
    { 
      name: "Максимальная", 
      isActive: false,
      currentPrice: 1290200,
      originalPrice: 1586000,
      discount: 18
    },
  ];
  ...
  const [activeConfig, setActiveConfig] = useState<string>("Базовая");
  const [currentPrice, setCurrentPrice] = useState(configOptions[0].currentPrice);
  const [originalPrice, setOriginalPrice] = useState(configOptions[0].originalPrice);
  const [discount, setDiscount] = useState(configOptions[0].discount);
