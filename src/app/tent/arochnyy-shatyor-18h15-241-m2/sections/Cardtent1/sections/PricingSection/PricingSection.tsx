...
const tentSequences = [
  {
    basePath: "/WALLS_ORIGINAL/LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "18x15 м" },
    { label: "Площадь:", value: "241 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "160 человек" },
    { label: "Длина:", value: "18м" },
    { label: "Ширина:", value: "15м" },
    { label: "Высота входной арки:", value: "8м" },
    { label: "Высота в коньке:", value: "18м" },
  ...
  const thumbnails = [
  { id: 1, src: "/20x17,1.webp", alt: "Product 1" },
  { id: 2, src: "/20x17,2.webp", alt: "Product 2" },
  ...
  const performDownloadKP = async () => {
    ...
    const productImage = thumbnails[0]?.src || "/20x17,1.webp";
        ...
        <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
          <div className="flex flex-col w-full max-w-[658px]">
            <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
              {pageName || "Арочный шатёр 18х15 — 241 м²"}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="absolute top-[5px] left-[750px] z-10">
              <div className="font-normal text-[#394355] text-base leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0] mb-4">
                ...
                <span className="font-semibold underline">188</span>
              </div>
