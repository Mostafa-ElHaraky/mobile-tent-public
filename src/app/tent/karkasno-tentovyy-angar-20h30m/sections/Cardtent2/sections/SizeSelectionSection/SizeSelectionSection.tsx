...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасно-тентовый ангар 20×30м (600 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасно-тентовых ангаров и тентовых конструкций. Каркасно-тентовый ангар 20×30м (600 м²) — это просторное прямоугольное сооружение для складов, производственных цехов, логистических центров, спортивных залов и сельскохозяйственных нужд.",
    },
    {
      title: "Особенности модели",
      text: "Ангар выполнен в прямоугольной форме с арочным или двускатным верхом. Площадь 600 м² позволяет разместить стеллажи, оборудование, спортивные площадки. Конструкция не требует капитального фундамента, монтируется за 7–10 дней. Возможно использование как сезонное, так и круглогодичное (с утеплением).",
    },
    {
      title: "Практичность и применение",
      text: "Идеален для: складских помещений, производственных цехов, спортивных залов, выставочных павильонов, укрытия техники, сельскохозяйственных нужд, автосервисов. Быстрый монтаж и демонтаж, возможность многократного использования.",
    },
    {
      title: "Материалы",
    ...
    },
    {
      ...
      text: "Установка производится профессиональной бригадой, не требует тяжёлой техники (для лёгких версий). Фундамент не требуется — достаточно ровной площадки (грунт, асфальт, бетон, блоки). Демонтаж и повторный монтаж возможны без потери качества.",
    },
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 20×30м. Можно комбинировать с другими типоразмерами: 20×20м, 20×40м, 20×50м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame-tent hangar 20×30m
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Прямоугольная (каркасно-тентовая)" },
    { label: "Площадь", value: "600 м²" },
    { label: "Длина", value: "30 м (может быть увеличена модулями)" },
    { label: "Ширина (пролёт)", value: "20 м" },
    { label: "Высота стенки", value: "2,5 / 3 / 3,5 / 4 м (на выбор)" },
    { label: "Высота в коньке", value: "до 6,5 м" },
    { label: "Вес металлоконструкции", value: "~3 500 кг" },
    ...
    { label: "Монтаж", value: "7–10 дней профессиональной бригадой" },
