...
const PAGE_CODE = "karkasno-tentovyy-angar-20h30m";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 213,
        name: "Каркасный ангар 20×30м Тип Д (600 м²)",
        code: PAGE_CODE
      },
      seo: {
        title: "Каркасный ангар 20×30м (600 м²) Тип Д – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Каркасный ангар 20×30м (600 м²) Тип Д от производителя MOBILE TENT. Усиленный металлокаркас, сэндвич-панели или ПВХ тент. Для складов, производств, спорта. Цена от 1 250 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "каркасный ангар 20х30, ангар 20 на 30, купить каркасный ангар 20х30, быстровозводимый ангар, ангар тип Д, ангар 600 кв м, цена ангара 20х30",
        h1: "Каркасный ангар 20×30м Тип Д (600 м²)",
        url: `/tent/karkasno-tentovyy-angar-20h30m`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Каркасный ангар 20×30м (600 м²) Тип Д – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Каркасный ангар 20×30м (600 м²) Тип Д от производителя MOBILE TENT. Усиленный металлокаркас, сэндвич-панели или ПВХ тент. Для складов, производств, спорта. Цена от 1 250 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "каркасный ангар 20х30, ангар 20 на 30, купить каркасный ангар 20х30, быстровозводимый ангар, ангар тип Д, ангар 600 кв м";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Каркасный ангар 20×30м Тип Д (600 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "description": "Производство и продажа каркасных ангаров 20×30м, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации каркасного ангара 20×30м Тип Д",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": pageData.page?.name || "Каркасный ангар 20×30м Тип Д",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у каркасного ангара 20×30м Тип Д?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Каркасный ангар 20×30м Тип Д имеет ширину 20 метров, длину 30 метров, высоту стенки до 7 метров, высоту в коньке до 9 метров. Полезная площадь — 600 м². Это оптимальный размер для складов, производственных цехов и спортивных залов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит каркасный ангар 20×30м под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 20×30м как производственный цех круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели 100-150 мм) и установке системы отопления, ангар 20×30м можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на строительство каркасного ангара 20×30м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на каркасный ангар 20×30м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 20×30м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 20×30м ворота, двери, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 20×30м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
          "name": "Доставляете ли ангары 20×30м в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается каркасный ангар 20×30м Тип Д | MOBILE TENT",
    "description": "Видео-инструкция по монтажу каркасного ангара 20×30м (600 м²). Быстровозводимая конструкция для складов и производства.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Каркасный ангар 20×30м Тип Д (600 м²)"}
      </h1>
