...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Tiger Ø2 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Tiger Ø2 м — компактная тень и комфорт",
      text: `Восьмиугольный зонт с центральной стойкой — практичное решение для летних веранд, уличных кафе, лаунж-зон и небольших открытых площадок.
Диаметр 2 м обеспечивает укрытие площадью около 3,14 м², а лаконичный дизайн легко вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Tiger Ø2 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Tiger Ø2 м" },
    ...
    {
      label: "Каркас",
      value: "Все элементы каркаса конструкции изготовлены из стали высокого качества.",
    },
