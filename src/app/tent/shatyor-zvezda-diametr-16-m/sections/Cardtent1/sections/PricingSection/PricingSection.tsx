...
const tentSequences = [
  ...
  const specifications = [
    { label: "Размер:", value: "16 м" },
    { label: "Площадь:", value: "200.96 м²" },
    { label: "Форма:", value: "Звезда" },
    { label: "Вместимость:", value: "86 человек" },
    { label: "Ширина:", value: "16м" },
    { label: "Длина:", value: "16м" },
