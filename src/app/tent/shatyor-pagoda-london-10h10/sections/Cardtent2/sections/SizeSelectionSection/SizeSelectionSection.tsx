...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Лондон 10×10 м (100 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Лондон 10×10 м (100 м²) — это премиальная конструкция в классическом британском стиле. Острая крыша и элегантный дизайн делают его идеальным выбором для масштабных банкетов, свадеб, выставок, конференций и VIP-зон.",
    },
    {
      title: "Особенности модели Лондон 10×10",
      text: "Пагодный шатер Лондон выполнен в форме квадрата с характерной острой крышей (увеличенный угол наклона). Площадь 100 м² позволяет комфортно разместить до 70-80 гостей за столами или до 100-120 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 5–6 часов. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Британский стиль и эстетика",
      text: "Классическая форма с острой крышей выделяет шатёр Лондон среди стандартных конструкций. Размер 10×10 м идеально подходит для масштабных мероприятий. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Премиальные материалы отделки подчёркивают статус события.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Лондон 10×10 м идеально подходит для: масштабных банкетов и свадеб (до 80 гостей), крупных корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, бутиков временной торговли, лаунж-зон на фестивалях, фотостудий.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent London 10×10 m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота стенки", value: "4,0 м" },
    { label: "Высота в коньке", value: "до 10,0 м" },
    { label: "Вес конструкции (алюминий)", value: "~800 кг" },
    { label: "Вес конструкции (сталь)", value: "~1500 кг" },
    { label: "Транспортный объём", value: "3,5 м³" },
    ...
    { label: "Монтаж", value: "5–6 часов профессиональной бригадой" },
