...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your original code (15×13 — 163 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Описание",
      text: `Под куполом арочного шатра 15×13 м можно провести масштабный ивент в весенне-летний период. Компания MOBILE TENT создала надёжный и красивый шатёр, который вместителен и выглядит при этом очень респектабельно.

Площадь арочного шатра 163 м² — это громадное пространство, где с комфортом можно разместить большое количество людей. Такой шатёр станет идеальной конструкцией для случаев, когда хочется провести праздник на открытом воздухе и не переживать по поводу изменений погоды.

Производитель предлагает огромный выбор мобильных навесных конструкций для торговли или проведения праздников. У нас можно купить или арендовать тенты и шатры любой площади и дизайна.`,
    },
    {
      title: "Применение",
      text: `Арочный шатёр 15×13 м станет превосходной площадкой, где можно отпраздновать свадьбу, устроить праздник или провести выставку. Цены на аренду или покупку этой или подобных конструкций невысокие, учитывая срок окупаемости.`,
    },
  ];

  // Default specs from your original code (15×13 — 163 м²)
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Шестигранник" },
    { label: "Площадь", value: "163 м²" },
    { label: "Длина", value: "13,7 м" },
    { label: "Ширина", value: "15,6 м" },
    { label: "Высота входной арки", value: "3,6 м" },
    { label: "Высота в коньке", value: "5 м" },
    { label: "Вес конструкции", value: "2500 кг" },
    { label: "Нагрузка на опорную пятку", value: "416 кг" },
    { label: "Ветровая нагрузка", value: "24 м/сек" },
    { label: "Нагрузка подвеса на арку", value: "до 35 кг/п.м." },
    {
      label: "Основание",
      value: "Не требует специального фундамента, устанавливается на любой земляной поверхности.",
    },
    {
      label: "Монтаж",
    ...
    {
      label: "Модульность",
      value: 'Возможность увеличения площади путём соединения нескольких конструкций со стороной 8 м: "VIP Дюна 8×8 м", "VIP 8×8 м", "VIP 16×16 м", "Гексагональ 15×13 м", "Гексагональ 15×13 м Long-1", "Гексагональ 15×13 м LONG-2", "Октогональ 21×19 м".',
    },
    {
