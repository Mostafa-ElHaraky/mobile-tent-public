...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасно-тентовый ангар 10×30м (300 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасно-тентовых ангаров и тентовых конструкций. Каркасно-тентовый ангар 10×30м (300 м²) — это оптимальное решение для складов, производственных цехов, спортивных залов, выставочных павильонов и сельскохозяйственных нужд.",
    },
    {
      title: "Особенности модели",
      text: "Ангар выполнен в прямоугольной форме с арочным или двускатным верхом. Площадь 300 м² позволяет разместить стеллажи, оборудование, спортивные площадки. Конструкция не требует капитального фундамента, монтируется за 5–7 дней. Возможно использование как сезонное, так и круглогодичное (с утеплением).",
    },
    {
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 10×30м. Можно комбинировать с другими типоразмерами: 10×20м, 10×40м, 10×50м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame-tent hangar 10×30m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота в коньке", value: "до 5,5 м" },
    { label: "Вес металлоконструкции", value: "~1 800 кг" },
    ...
    { label: "Монтаж", value: "5–7 дней профессиональной бригадой" },
