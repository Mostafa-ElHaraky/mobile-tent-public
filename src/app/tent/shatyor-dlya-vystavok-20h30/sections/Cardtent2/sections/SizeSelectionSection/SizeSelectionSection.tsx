...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 20×30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 20×30 м",
      text: `Прямоугольный шатёр для выставок размером 20×30 м и общей площадью 600 м² — это прекрасное решение для проведения мероприятия. Мобильность конструкции позволяет провести культурный праздник в любом месте — гостям неординарная задумка непременно понравится.

Компания предлагает услуги по проектированию, изготовлению, монтажу и обслуживанию шатровых конструкций. Каркасно-тентовую продукцию можно купить или арендовать с доставкой и установкой.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `• Отличный дизайн позволяет вписать шатёр в любое место.
• Шатёр для выставок 20×30 м — закрытого типа и обеспечивает уютные, комфортные условия при любой погоде.
• ПВХ-полотно DICKSON пропитано противопожарным составом и не выгорает на солнце.
• Шатёр может быть изготовлен в любом цвете; выполняем брендирование поверхности тента.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Установка шатра 20×30 м производится на ровную поверхность.
• После монтажа каркас необходимо закрепить и утяжелить бетонными блоками.

Звоните нам прямо сейчас для покупки или аренды шатра!`,
    },
  ];
  ...
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "9 000 кг" },
