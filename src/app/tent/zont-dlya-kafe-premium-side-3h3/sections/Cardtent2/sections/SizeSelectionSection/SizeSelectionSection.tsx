...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт для кафе Premium Side 3×3
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт для кафе Premium Side 3×3 — 9 м² тени и комфорта",
      text: `Квадратный зонтовый навес с боковой стойкой — идеален для летних веранд, уличных кафе, лаунж-зон и небольших мероприятий. 
Размер 3×3 м обеспечивает 9 м² полезной площади, а боковая стойка освобождает центр от опоры и делает пространство более удобным для расстановки мебели.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — квадрат. Стойка расположена сбоку, что даёт свободную центральную зону.
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт для кафе Premium Side 3×3
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт для кафе Premium Side 3×3" },
    { label: "Форма в плане", value: "Квадратная" },
    { label: "Расположение стойки", value: "Сбоку" },
