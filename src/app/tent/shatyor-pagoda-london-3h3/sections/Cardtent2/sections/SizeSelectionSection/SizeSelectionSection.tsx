...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Лондон 3×3 м (9 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Лондон 3×3 м (9 м²) — это премиальная конструкция в классическом британском стиле. Острая крыша и элегантный дизайн делают его идеальным выбором для статусных мероприятий, бутиков и VIP-зон.",
    },
    {
      title: "Особенности модели Лондон 3×3",
      text: "Пагодный шатер Лондон выполнен в форме квадрата с характерной острой крышей (увеличенный угол наклона). Площадь 9 м² позволяет комфортно разместить до 8-10 гостей за столами или до 12-15 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 1–2 часа. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Британский стиль и эстетика",
      text: "Классическая форма с острой крышей выделяет шатёр Лондон среди стандартных конструкций. Компактные размеры (3×3 м) удобны для небольших площадок. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Премиальные материалы отделки подчёркивают статус события.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Лондон 3×3 м идеально подходит для: премиальных фотозон на свадьбах, бутиков временной торговли, VIP-зон на фестивалях, выставочных стендов, ресторанных веранд, кофеен, фотостудий, лаунж-зон.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent London 3×3 m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота стенки", value: "2,2 м" },
    { label: "Высота в коньке", value: "до 4,2 м" },
    { label: "Вес конструкции (алюминий)", value: "~120 кг" },
    { label: "Вес конструкции (сталь)", value: "~230 кг" },
    { label: "Транспортный объём", value: "0,45 м³" },
    ...
    { label: "Монтаж", value: "1–2 часа профессиональной бригадой" },
