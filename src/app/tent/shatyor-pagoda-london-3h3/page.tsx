...
const PAGE_CODE = "shatyor-pagoda-london-3h3";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent London 3×3 m
    return {
      success: false,
      page: {
        id: 270,
        name: "Шатёр Пагода Лондон 3×3 м (9 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатёр Пагода Лондон 3×3 м (9 м²) – купить премиальный пагодный шатер в Москве | MOBILE TENT",
        description:
          "Шатёр Пагода Лондон 3×3 метра (площадь 9 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция в британском стиле для мероприятий, торговли, кафе. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 65 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода лондон 3х3, пагода лондон 3х3, шатер лондон 3 на 3, пагодный шатер премиум 3х3, шатер для мероприятий 3х3, шатер для свадьбы, шатер лондон тип",
        h1: "Шатёр Пагода Лондон 3×3 м – британская элегантность для вашего бизнеса",
        url: `/tent/${PAGE_CODE}`,
      },
      ...
      priceConfigurations: [
        {
          ...
          discount: 21,
          description:
            "Премиальный алюминиевый каркас, ПВХ тент 650 г/м², боковые стенки, входная дверь. Для статусных мероприятий, свадеб, корпоративов, бутиков.",
        },
        {
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатёр Пагода Лондон 3×3 м (9 м²) – купить премиальный пагодный шатер в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатёр Пагода Лондон 3×3 метра (площадь 9 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция в британском стиле для мероприятий, торговли, кафе. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 65 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода лондон 3х3, пагода лондон 3х3, шатер лондон 3 на 3, пагодный шатер премиум 3х3";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатёр Пагода Лондон 3×3 метра с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaLondon3x3Page() {
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [65000, 95000, 135000];
  ...
  const productSchema = {
    ...
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda4.webp",
    name: pageData.page?.name || "Шатёр Пагода Лондон 3×3 м (9 м²)",
    description:
      pageData.seo?.description ||
      "Шатёр Пагода Лондон 3×3 метра – премиальная пагодная конструкция в британском стиле с острой крышей для мероприятий, торговли, кафе. Элегантный дизайн, площадь 9 м², высота в коньке 4.2 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-LONDON-3x3`,
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Лондон 3×3 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатёр Пагода Лондон 3×3 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Чем отличается шатёр Пагода Лондон 3×3 м от стандартной пагоды?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Какую площадь имеет шатёр Пагода Лондон 3×3 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Площадь шатра составляет 9 м², высота стенки – 2,2 метра, высота в коньке – до 4,2 метров. Это позволяет комфортно разместить до 8-10 гостей за столами или до 12-15 человек на фуршет.",
        },
      },
      {
        "@type": "Question",
        name: "Сколько стоит шатёр Пагода Лондон 3×3 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "65 000"} ₽ за базовую комплектацию Лондон, премиум версия – от ${prices[1]?.toLocaleString() || "95 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "135 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Лондон 3×3 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатёр Пагода Лондон 3×3 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Лондон 3×3 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей лучше всего подходит шатёр Пагода Лондон 3×3 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Идеален для: премиальных свадебных фотозон, бутиков временной торговли, VIP-зон на фестивалях, выставочных стендов премиум-класса, ресторанных веранд, фотостудий.",
        },
      },
    ],
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатёр Пагода Лондон 3×3 м – британская элегантность для вашего бизнеса"}</h1>
