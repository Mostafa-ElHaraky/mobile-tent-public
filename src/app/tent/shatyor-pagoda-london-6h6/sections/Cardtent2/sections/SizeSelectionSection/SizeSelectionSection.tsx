...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Лондон 6×6 м (36 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Лондон 6×6 м (36 м²) — это премиальная конструкция в классическом британском стиле. Острая крыша и элегантный дизайн делают его идеальным выбором для банкетов, свадеб, выставок, конференций и VIP-зон.",
    },
    {
      title: "Особенности модели Лондон 6×6",
      text: "Пагодный шатер Лондон выполнен в форме квадрата с характерной острой крышей (увеличенный угол наклона). Площадь 36 м² позволяет комфортно разместить до 25-30 гостей за столами или до 35-40 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 3–4 часа. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Британский стиль и эстетика",
      text: "Классическая форма с острой крышей выделяет шатёр Лондон среди стандартных конструкций. Размер 6×6 м идеально подходит для крупных мероприятий. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Премиальные материалы отделки подчёркивают статус события.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Лондон 6×6 м идеально подходит для: банкетов и свадеб (до 30 гостей), корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, бутиков временной торговли, лаунж-зон на фестивалях, фотостудий.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent London 6×6 m
