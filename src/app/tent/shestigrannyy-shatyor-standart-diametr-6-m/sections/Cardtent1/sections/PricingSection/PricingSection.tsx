...
const tentSequences = [
  {
    basePath: "/6-8м/01_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
...
const thumbnails = [
  { id: 1, src: "/shesteg1.webp", alt: "Product 1" },
  { id: 2, src: "/shesteg2.webp", alt: "Product 2" },
      ...
      <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
        <div className="flex flex-col w-full max-w-[658px]">
          <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
           Шестигранный шатёр Стандарт (Диаметр 6 м)
          </div>
        </div>
