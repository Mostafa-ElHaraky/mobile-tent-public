...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт для кафе Standart Ø2 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт для кафе Standart Ø2 м — компактная тень и комфорт",
      text: `Восьмиугольный зонтовый навес с центральной стойкой — практичное решение для летних веранд, уличных кафе, зон ожидания и небольших площадок. 
Диаметр 2 м обеспечивает локальную зону укрытия (≈3,14 м²), а классическая геометрия выглядит аккуратно и лаконично в любом окружении.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — восьмиугольная. Стойка расположена по центру для равномерного распределения нагрузки.
Все элементы каркаса конструкции изготовлены из стали высокого качества.
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
    },
  ];

  // TECH SPECS — UPDATED for Зонт для кафе Standart Ø2 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт для кафе Standart Ø2 м" },
    { label: "Форма в плане", value: "Восьмиугольная" },
    { label: "Расположение стойки", value: "В центре" },
    { label: "Площадь", value: "3,14 м²" },
    { label: "Длина", value: "2 м" },
    { label: "Ширина", value: "2 м" },
    { label: "Каркас", value: "Все элементы каркаса конструкции изготовлены из стали высокого качества." },
    { label: "Крепёж", value: "Крепёжные элементы — оцинкованная сталь." },
  ];
