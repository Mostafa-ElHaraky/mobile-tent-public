...
const PAGE_CODE = "arochnyy-shatyor-8h8-64m2v";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 179,
        name: "Арочный шатёр 8х8 — 64м²(V)",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный шатёр 8х8 — 64м²(V) – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent",
        description: "Арочный шатёр 8х8 — 64м²(V) – купить в Москве под заказ в компании Mobile Tent. Просторный квадратный шатер с усиленной конструкцией, идеально подходящий для масштабных мероприятий, выставок, спортивных соревнований, складских комплексов и торговых центров. Усиленный каркас обеспечивает повышенную надежность и устойчивость к ветровым нагрузкам. Большая площадь позволяет организовать пространство любой сложности. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.",
        keywords: "арочный шатёр 8х8, купить арочный шатер 8х8, шатер 8 на 8, арочный шатер 64м2, усиленный шатер, шатер с усилением, большой шатер, квадратный шатер, шатер для мероприятий, шатер для выставки, тентовый шатер, быстровозводимый шатер, шатер для склада, шатер для спортивных мероприятий",
        h1: "Арочный шатёр 8х8 — 64м²(V)",
        url: `/tent/arochnyy-shatyor-8h8-64m2v`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный шатёр 8х8 — 64м²(V) – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Арочный шатёр 8х8 — 64м²(V) – купить в Москве под заказ в компании Mobile Tent. Просторный квадратный шатер с усиленной конструкцией, идеально подходящий для масштабных мероприятий, выставок, спортивных соревнований, складских комплексов и торговых центров. Усиленный каркас обеспечивает повышенную надежность и устойчивость к ветровым нагрузкам. Большая площадь позволяет организовать пространство любой сложности. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "арочный шатёр 8х8, купить арочный шатер 8х8, шатер 8 на 8, арочный шатер 64м2, усиленный шатер, шатер с усилением, большой шатер, квадратный шатер, шатер для мероприятий, шатер для выставки, тентовый шатер, быстровозводимый шатер, шатер для склада, шатер для спортивных мероприятий";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Арочный шатёр 8х8 - 64м²(V) усиленный от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const productSchema = {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Назначение",
        "value": "Масштабные мероприятия, выставки, спортивные соревнования, складские комплексы, торговые центры, концертные площадки, ангары"
      }
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  // ----- FAQ SCHEMA (customized for арочный шатер 8х8 усиленный) -----
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": `Какие размеры у арочного шатра 8х8 усиленного?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Арочный шатер имеет ширину 8 метров, длину 8 метров, высоту в коньке до 4.5 метров. Полезная площадь — ${area} м². Это просторная квадратная конструкция с усиленным каркасом, которая обеспечивает повышенную надежность при больших ветровых нагрузках и позволяет организовывать мероприятия любого масштаба.`
        }
      },
      {
        "@type": "Question",
        "name": `Сколько стоит усиленный арочный шатер 8х8?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Цена зависит от комплектации: базовая — от ${prices[0]?.toLocaleString() || '372 000'} ₽, средняя — от ${prices[1]?.toLocaleString() || '472 000'} ₽, максимальная — от ${prices[2]?.toLocaleString() || '572 000'} ₽. Усиленная конструкция может иметь дополнительную стоимость в зависимости от требуемых параметров надежности. Доставка по Москве и области рассчитывается отдельно. Для больших конструкций возможен индивидуальный расчет стоимости монтажа.`
        }
      },
      {
        "@type": "Question",
        "name": "Для каких целей подходит усиленный арочный шатер 8х8?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Усиленный арочный шатер 8х8 идеально подходит для: масштабных свадебных мероприятий и банкетов (до 100 гостей), выставочных павильонов, спортивных соревнований, складских комплексов, торговых центров, концертных площадок, фестивалей, корпоративных мероприятий, временных ангаров, укрытий для крупной техники и оборудования, особенно в регионах с повышенными ветровыми нагрузками."
        }
      },
      {
        "@type": "Question",
        "name": "Чем отличается усиленный шатер 8х8(V) от обычного?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Усиленный шатер 8х8(V) имеет более мощный каркас с увеличенным сечением профиля, дополнительные элементы жесткости, усиленные узлы соединений и может комплектоваться дополнительными опорами. Это обеспечивает повышенную устойчивость к ветровым нагрузкам (до 150 км/ч), позволяет использовать шатер в более сложных погодных условиях и увеличивает общий срок службы конструкции. Маркировка (V) обозначает усиленную версию."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку усиленного шатра 8х8 в Москве?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 64 м² может потребоваться уведомление или согласование в зависимости от места установки и срока использования. Для усиленных конструкций, которые планируется использовать длительное время, рекомендуется оформление необходимых документов. Мы помогаем с оформлением и консультируем по всем вопросам."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Гарантия от производителя — 5 лет на каркас и тент. Срок службы при правильной эксплуатации — более 20 лет благодаря усиленной конструкции. Алюминиевый каркас устойчив к коррозии, ПВХ ткань защищена от УФ-излучения. Усиленный вариант рекомендован для круглогодичного использования."
        }
      },
      {
        "@type": "Question",
        "name": "Можно ли установить стены и двери в усиленном шатре 8х8?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, возможна установка торцевых стен с дверями, окнами, воротами, в том числе усиленными для больших конструкций. Квадратная форма большой площади позволяет организовать несколько входных групп, зонировать внутреннее пространство, установить перегородки. Также доступны боковые стены, системы вентиляции, освещения, отопления и кондиционирования. Возможно брендирование тента."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок изготовления усиленного арочного шатра 8х8?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стандартный срок изготовления усиленного арочного шатра 8х8 — от 7 до 14 рабочих дней, так как требуется больше материалов, усиление конструкции и более сложная сборка. Для срочных заказов возможна ускоренная сборка за 3-5 дней."
        }
      },
      {
        "@type": "Question",
        "name": "Доставляете ли усиленные шатры 8х8 в Московскую область?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, доставляем по всей Москве и Московской области: Красногорск, Химки, Мытищи, Люберцы, Подольск, Одинцово, Балашиха, Раменское, Домодедово, Королев, Пушкино, Сергиев Посад, Коломна, Электросталь, Жуковский, Дмитров, Солнечногорск, Истра, Наро-Фоминск, Чехов, Ступино, Серпухов и другие города. Для усиленных конструкций обязательна доставка спецтранспортом. Стоимость доставки — от 4000 рублей в зависимости от удаленности."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько человек вмещает усиленный шатер 8х8?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "В усиленном арочном шатре 8х8 площадью 64 м² можно разместить: до 80-100 гостей с банкетными столами, до 120-150 человек на фуршете, до 50-60 посадочных мест в кафе/ресторане, либо использовать как выставочную площадь для 10-15 стендов. Усиленная конструкция позволяет устанавливать более тяжелое оборудование и декор."
        }
      },
      {
        "@type": "Question",
        "name": "Какая ветровая нагрузка выдерживает усиленный шатер 8х8?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Усиленный шатер 8х8(V) выдерживает ветровую нагрузку до 150 км/ч, что значительно выше, чем у стандартных конструкций. Это достигается за счет усиленного каркаса, дополнительных элементов жесткости и возможности установки дополнительных растяжек и якорей."
        }
      }
    ]
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный шатёр 8х8 — 64м²(V)"}
      </h1>
