...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасно-тентовый ангар 25×30м (750 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасно-тентовых ангаров и тентовых конструкций. Каркасно-тентовый ангар 25×30м (750 м²) — это просторное прямоугольное сооружение для крупных складов, производственных цехов, логистических центров, спортивных залов и сельскохозяйственных нужд.",
    },
    {
      title: "Особенности модели",
      text: "Ангар выполнен в прямоугольной форме с арочным или двускатным верхом. Площадь 750 м² позволяет разместить стеллажи, оборудование, спортивные площадки. Конструкция не требует капитального фундамента, монтируется за 8–12 дней. Возможно использование как сезонное, так и круглогодичное (с утеплением).",
    },
    {
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 25×30м. Можно комбинировать с другими типоразмерами: 25×20м, 25×40м, 25×50м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame-tent hangar 25×30m
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Прямоугольная (каркасно-тентовая)" },
    { label: "Площадь", value: "750 м²" },
    { label: "Длина", value: "30 м (может быть увеличена модулями)" },
    { label: "Ширина (пролёт)", value: "25 м" },
    { label: "Высота стенки", value: "2,5 / 3 / 3,5 / 4 м (на выбор)" },
    { label: "Высота в коньке", value: "до 7,5 м" },
    { label: "Вес металлоконструкции", value: "~4 200 кг" },
    ...
    { label: "Монтаж", value: "8–12 дней профессиональной бригадой" },
