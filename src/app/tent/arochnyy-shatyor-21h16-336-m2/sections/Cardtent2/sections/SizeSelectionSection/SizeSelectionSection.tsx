...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your first code (21×16 — 336 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Описание",
      text: `Под огромным куполом арочного шатра можно провести любое масштабное мероприятие. Несмотря на большую площадь, такая конструкция выглядит изящной и привлекает внимание гостей.

Купить или арендовать арочный шатёр 21×16 м площадью 336 м² — выгодно. Когда возникает потребность провести торжество или ивент на открытом воздухе, такая конструкция станет залогом успешного проведения события при любой погоде.`,
    },
    {
      title: "Применение",
      text: `Сфера использования арочного шатра размером 21×16 м достаточно широкая. Его можно купить или арендовать под масштабные мероприятия, где нужна большая площадь и свобода пространства. Роскошный купол шатра удивит гостей и оставит самые лучшие воспоминания о празднике.`,
    },
    {
      title: "Особенности монтажа",
      text: `Устанавливать такой гигантский шатёр должны исключительно профессионалы, это обеспечит безопасность креплений каркаса и конструкции. Цены на монтаж приемлемые, учитывая сроки и качество работы.`,
    },
  ];

  // Default specs from your first code (21×16 — 336 м²)
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Прямоугольник" },
    { label: "Площадь", value: "336 м²" },
    { label: "Длина", value: "21 м" },
    { label: "Ширина", value: "16 м" },
    { label: "Высота входной арки", value: "3,6 м" },
    { label: "Высота в коньке", value: "5 м" },
    { label: "Вес конструкции", value: "3700 кг" },
    { label: "Нагрузка на опорную пятку", value: "462 кг" },
    ...
    },
    {
      label: "Модульность",
      value:
        "Возможность увеличения площади путём соединения нескольких конструкций со стороной 8 м.",
    },
    {
