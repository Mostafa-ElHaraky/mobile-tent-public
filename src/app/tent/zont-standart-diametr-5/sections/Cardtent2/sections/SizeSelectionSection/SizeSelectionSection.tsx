...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Standart Ø5 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Standart Ø5 м — просторная тень и комфорт",
      text: `Восьмиугольный зонт с центральной стойкой — практичное решение для летних веранд, уличных кафе, лаунж-зон и открытых площадок.
Диаметр 5 м обеспечивает укрытие площадью около 19,625 м², а лаконичный дизайн легко вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Standart Ø5 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Standart Ø5 м" },
    { label: "Форма в плане", value: "Восьмиугольная" },
    { label: "Расположение стойки", value: "В центре" },
    { label: "Площадь", value: "19,625 м²" },
