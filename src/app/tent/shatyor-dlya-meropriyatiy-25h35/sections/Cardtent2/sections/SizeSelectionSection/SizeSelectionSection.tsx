...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 25×35 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 25×35 м",
      text: `Любое мероприятие можно успешно провести на свежем воздухе. Организаторы обязаны учесть множество факторов, наиболее важный — погодные условия.

Шатёр 25×35 м — мобильный и надёжный тент для мероприятий. Его отличает эстетичный внешний вид, высокое качество материалов и приемлемая цена. Площадь конструкции — 875 м². Высота стены тента — 3 / 3,5 / 4 / 4,5 / 5 м.

Мы занимаемся:
• проектированием и производством мобильных тентовых конструкций;
• продажей и арендой тентов;
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Изготовлен шатёр из брендового материала DICKSON с системой LoWick. Тент не промокает, материал устойчив к горению и гниению. Каркас не окисляется, изготовлен из анодированного алюминия.

Тент выдерживает значительную ветровую нагрузку — 30 м/сек. Вместительный размер шатра позволяет успешно использовать его на многих выездных мероприятиях: ярмарках, выставках, фестивалях, корпоративах и торжествах.`,
    },
    {
      title: "Особенности монтажа",
      text: `Шатёр устанавливается быстро и без использования специальной техники непосредственно на ровную поверхность. Обязательно крепление конструкции или утяжеление каркаса плитами из бетона.`,
    },
  ];
