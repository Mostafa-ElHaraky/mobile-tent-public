...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Premium 2×2
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Premium 2×2 — 4 м² тени и комфорта",
      text: `Квадратный зонтовый навес с центральной стойкой — практичное решение для летних веранд, уличных кафе, зон ожидания и компактных площадок.
Размер 2×2 м обеспечивает около 4 м² полезной площади укрытия, а лаконичный дизайн органично вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Premium 2×2
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Premium 2×2" },
