...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Premium 4×4
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Premium 4×4 — 16 м² тени и комфорта",
      text: `Квадратный зонтовый навес с центральной стойкой — практичное решение для летних веранд, уличных кафе, зон ожидания и площадок отдыха.
Размер 4×4 м обеспечивает около 16 м² полезной площади укрытия, а лаконичный дизайн органично вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Premium 4×4
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Premium 4×4" },
