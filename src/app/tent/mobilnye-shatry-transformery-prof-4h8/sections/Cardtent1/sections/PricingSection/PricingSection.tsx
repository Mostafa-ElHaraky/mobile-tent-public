...
const tentSequences = [
  {
    basePath: "/4х8_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "4x8 м" },
    { label: "Площадь:", value: "32 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "21 человек" },
    { label: "Ширина:", value: "4м" },
...
const thumbnails = [
  ...
  { id: 3, src: "/mobilny4x8.webp", alt: "Product 3" },
      ...
      <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
        <div className="flex flex-col w-full max-w-[658px]">
          <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
            Мобильные шатры-трансформеры Prof 4х8
          </div>
        </div>
