...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 25×30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 25×30 м",
      text: `Запланировали выставку, но не можете подобрать хороший и недорогой зал для её проведения? Предлагаем воспользоваться продукцией российской компании и установить временную шатровую конструкцию в любом подходящем месте.

Вместительный шатёр для выставок 25×30 м нашего производства имеет современный дизайн и прекрасный внешний вид. Продукцию компании можно арендовать на необходимый вам срок или купить.

Мы выполняем:
• проектирование,
• изготовление,
• ремонт каркасно-тентовых конструкций.

У нас можно арендовать дополнительные аксессуары и оборудование для шатров — мебель, кондиционеры, обогреватели, VIP-туалеты и т. д. Заказанную конструкцию мы доставим и установим в указанном вами месте.`,
    },
    {
...
• Крепежные элементы — оцинкованная сталь DIN 50976.
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `• Тент французского производства пропитан огнеупорной смесью и не выгорает на солнце.
• Каркас обладает высокой прочностью.
• Мы можем нанести любой логотип на тент или выполнить полное брендирование шатра в соответствии с тематикой вашего мероприятия.`,
    },
    {
      title: "Особенности монтажа",
      text: `• В сложенном виде шатёр для выставок 25×30 м имеет компактные размеры. Для его транспортировки подойдёт обычная грузовая машина.
• Шатёр следует установить на предварительно выровненную поверхность и надёжно закрепить.`,
    },
  ];

  // TECH SPECS — UPDATED for 25×30
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "11 250 кг" },
