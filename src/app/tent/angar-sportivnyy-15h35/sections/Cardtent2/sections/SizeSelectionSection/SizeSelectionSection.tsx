...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Ангар спортивный 15×35 (525 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Ангар спортивный 15×35",
      text: "Хотите начать свой бизнес или развить уже начатое дело, но не имеете подходящего помещения? Выберите тентовый ангар 15×35 м от производителя — прочная и вместительная каркасная конструкция с современным дизайном. Благодаря мобильности и простоте сборки ангар легко перевезти и установить в другом месте.",
    },
    {
      title: "Преимущества и применение",
      text: "Тентовый ангар 15×35 м подходит для овощехранилищ, свинарников, птицефабрик, коровников, торговых помещений, складов и других объектов. Конструкция уверенно выдерживает неблагоприятные погодные условия. Тентовое покрытие высокого качества — не выгорает, не гниёт, пропитано огнеупорной смесью.",
    },
    {
      title: "Практичность и монтаж",
      text: "Не требует специального фундамента — устанавливается на любую ровную земляную поверхность. Монтаж и демонтаж выполняются в кратчайшие сроки без применения спецтехники, многократно и без потери качества. Возможна модульная стыковка нескольких конструкций для увеличения площади. Обязательна фиксация к основанию или утяжеление бетонными блоками.",
    },
    {
      title: "Материалы тента",
      text: "Тентовое полотно и стены изготовлены из ПВХ DICKSON (Франция) с системой LoWick. Класс пожарной безопасности — М2, Г1. Тентовое покрытие — сертифицированное ПВХ-полотно с добавками, препятствующими горению (DIN 4102 B1, M2), прочность 0,3 кН/м², устойчиво к гниению.",
    },
    {
      title: "Каркас и крепёж",
      text: "Все элементы каркаса выполнены из анодированного алюминия (сплав 6063 DIN 573), сертификат QUALANOD. Крепёжные элементы — оцинкованная сталь по DIN 50976.",
    },
  ];

  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Прямоугольная / Арочная" },
    { label: "Площадь", value: "525 м²" },
    { label: "Длина", value: "35 м (регулируется)" },
    { label: "Ширина (пролёт)", value: "15 м" },
    ...
    { label: "Вес конструкции", value: "2 888 кг (алюминий)" },
    ...
    { label: "Модульность", value: "Возможна стыковка нескольких ангаров 15×N" },
