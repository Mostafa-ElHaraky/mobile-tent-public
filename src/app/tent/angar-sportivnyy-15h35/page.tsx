...
const PAGE_CODE = "angar-sportivnyy-15h35";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 250,
        name: "Ангар спортивный 15х35 (525 м²) тип В",
        code: PAGE_CODE
      },
      seo: {
        title: "Ангар спортивный 15х35 (525 м²) – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Спортивный ангар 15х35 (525 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для спортивных залов, тренировок, складов. Цена от 520 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "ангар спортивный 15х35, спортивный ангар 15 на 35, купить ангар 15х35, тентовый ангар 15х35, быстровозводимый ангар, ангар для спорта, ангар 525 кв м, цена ангара 15х35",
        h1: "Ангар спортивный 15х35 (525 м²) – надежное решение для спорта и хранения",
        url: `/tent/angar-sportivnyy-15h35`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Ангар спортивный 15х35 (525 м²) – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Спортивный ангар 15х35 (525 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для спортивных залов, тренировок, складов. Цена от 520 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "ангар спортивный 15х35, спортивный ангар 15 на 35, купить ангар 15х35, тентовый ангар 15х35, быстровозводимый ангар";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://mobile-tent.ru/B_15x35_1.webp',
          width: 1200,
          height: 630,
          alt: 'Ангар спортивный 15х35 (525 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "MOBILE TENT",
    "image": "https://mobile-tent.ru/B_15x35_1.webp",
    ...
    "description": "Производство и продажа спортивных ангаров 15х35, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "image": [
      "https://mobile-tent.ru/B_15x35_1.webp",
    ],
    "name": pageData.page?.name || "Ангар спортивный 15х35 (525 м²) тип В",
    "description": pageData.seo?.description || "Спортивный ангар 15х35 (525 м²) от производителя MOBILE TENT. Идеален для спортивных залов, тренировочных баз, складов, временных сооружений. Каркас из алюминия или стали, ПВХ тент 650-900 г/м². Устойчив к ветру до 120 км/ч, снеговым нагрузкам до 120 кг/м². Срок службы 15+ лет.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-SPORT-15x35-525`,
    "brand": {
      "@type": "Brand",
      "name": "MOBILE TENT",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации спортивного ангара 15х35",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": pageData.page?.name || "Ангар спортивный 15х35 (525 м²)",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у спортивного ангара 15х35?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Спортивный ангар 15х35 имеет ширину 15 метров, длину 35 метров, высоту в коньке до 6.2 метров. Полезная площадь — 525 м². Это оптимальный размер для мини-футбольных полей, баскетбольных площадок, тренажерных залов, складов и выставочных павильонов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит ангар 15х35 под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 15х35 как спортивный зал круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели или утепленный тент) и установке системы отопления, ангар 15х35 можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку ангара 15х35 в Москве или области?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 525 м² (включая ангар 15х35) разрешение на строительство не требуется, если объект устанавливается на срок до 1 года. Для длительной эксплуатации (более года) или в зонах с особыми требованиями может потребоваться уведомление администрации. Наши юристы помогают с оформлением всех необходимых документов."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на спортивный ангар 15х35?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 15х35?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 15х35 стены, двери, ворота, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 15х35?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Доставляете ли ангары 15х35 в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "В чем отличие тентового ангара 15х35 от металлического?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается спортивный ангар 15х35 | MOBILE TENT",
    "description": "Видео-инструкция по монтажу спортивного ангара 15х35 (525 м²). Быстровозводимая конструкция для спорта и складов.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Ангар спортивный 15х35 (525 м²) – купить по цене от 520 000 ₽ с доставкой по России"}
      </h1>
