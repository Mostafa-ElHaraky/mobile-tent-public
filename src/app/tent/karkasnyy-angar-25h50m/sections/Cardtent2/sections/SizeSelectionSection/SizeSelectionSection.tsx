...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасный ангар 25×50м (1 250 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасных ангаров и тентовых конструкций. Каркасный ангар 25×50м (1 250 м²) — это просторное прямоугольное сооружение для крупных промышленных объектов, логистических центров, сельскохозяйственных комплексов и выставочных павильонов.",
    },
    {
      title: "Особенности модели",
      text: "Ангар выполнен в прямостенной форме с двускатной кровлей. Площадь 1 250 м² позволяет разместить производственные линии, высотные стеллажи, спортивные площадки или выставочные стенды. Конструкция требует ленточного или свайного фундамента, монтируется за 18–25 дней.",
    },
    {
      title: "Практичность и применение",
      text: "Идеален для круглогодичного использования (с утеплением сэндвич-панелями). Подходит для: складских помещений, производственных цехов, логистических центров, спортивных залов, выставочных павильонов, укрытия техники, сельскохозяйственных нужд, автосервисов.",
    },
    {
      title: "Материалы",
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 25×50м. Можно комбинировать с другими типоразмерами: 25×30м, 25×40м, 25×60м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame hangar 25×50m
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Прямостенная (каркасная) с двускатной кровлей" },
    { label: "Площадь", value: "1 250 м²" },
    ...
    { label: "Вес металлоконструкции", value: "~22 000 кг" },
    ...
    { label: "Монтаж", value: "18–25 дней профессиональной бригадой с автокраном" },
