...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Арочный ангар 25×30 (750 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Арочный ангар 25×30 м",
      text: "Прямоугольный ангар площадью 750 м² предназначен для хранения, производства, выставочных мероприятий и других задач. Конструкция отличается надёжностью, долговечностью и функциональностью благодаря современным материалам.",
    },
    {
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "3 800 кг (алюминий)" },
    ...
    { label: "Модульность", value: "Возможна стыковка нескольких ангаров 25×N" },
