...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Quatro 6×6
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Quatro 6×6 — 36 м² тени и комфорта",
...
Размер 6×6 м обеспечивает около 36 м² полезной площади укрытия.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Quatro 6×6
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Quatro 6×6" },
