...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 15×30 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 15×30 м",
      text: `Наше предприятие готово выполнить ваш заказ на каркасно-тентовую продукцию любых размеров и конфигураций.

Шатёр для мероприятий 15×30 — компактное и одновременно вместительное решение общей площадью 450 м², которое подойдёт для деловых и частных событий, выставок и промо-акций.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `• Площадь — 450 м²: комфортно размещает большое количество гостей;
• Современный дизайн, подходящий под любое событие;
• Возможность выбрать цвет тента, нанести логотип или другое изображение;
• Наличие оконных и дверных проёмов — количество согласовывается заранее.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Шатёр устанавливается на ровную поверхность;
• В сложенном виде имеет компактные габариты и не требует спецтранспорта для перевозки;
• Доставим и установим конструкцию в самые короткие сроки.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Закажите шатёр для мероприятий 15×30 у нас — мы быстро рассчитаем смету, организуем доставку и монтаж.`,
    },
  ];
