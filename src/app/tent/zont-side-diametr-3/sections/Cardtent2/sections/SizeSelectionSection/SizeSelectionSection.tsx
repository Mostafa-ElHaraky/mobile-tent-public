...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Side Ø3 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Side Ø3 м — оптимальная тень и комфорт",
...
Диаметр 3 м обеспечивает укрытие площадью около 7,065 м², а свободная центральная зона удобна для расстановки мебели.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Side Ø3 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Side Ø3 м" },
