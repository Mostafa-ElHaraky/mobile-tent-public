...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Стандарт 8×8 м (64 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Стандарт 8×8 м (64 м²) — это классическая конструкция с острой крышей для крупных банкетов, свадеб, выставок, конференций и корпоративных мероприятий. Отличное соотношение цены и качества.",
    },
    {
      title: "Особенности модели Стандарт 8×8",
      text: "Пагодный шатер Стандарт выполнен в форме квадрата с характерной острой крышей. Площадь 64 м² позволяет комфортно разместить до 45-50 гостей за столами или до 60-70 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 4–5 часов. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Классический дизайн и эстетика",
      text: "Классическая форма с острой крышей придаёт шатру элегантный вид. Размер 8×8 м идеально подходит для крупных мероприятий. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Доступны различные цветовые решения тента.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Стандарт 8×8 м идеально подходит для: крупных свадеб и банкетов, корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, бутиков временной торговли, лаунж-зон на фестивалях, фотостудий.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent Standard 8×8 m
