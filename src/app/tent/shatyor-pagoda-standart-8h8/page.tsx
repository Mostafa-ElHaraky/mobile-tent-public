...
const PAGE_CODE = "shatyor-pagoda-standart-8h8";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent Standard 8×8 m
    return {
      success: false,
      page: {
        id: 276,
        name: "Шатёр Пагода Стандарт 8×8 м (64 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатёр Пагода Стандарт 8×8 м (64 м²) – купить пагодный шатер в Москве | MOBILE TENT",
        description:
          "Шатёр Пагода Стандарт 8×8 метров (площадь 64 м²) с острой крышей от производителя MOBILE TENT. Классическая пагодная конструкция для крупных банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 260 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода стандарт 8х8, пагода 8х8, шатер 8 на 8, пагодный шатер 8х8, шатер для банкета 8х8, шатер для свадьбы, шатер стандарт",
        h1: "Шатёр Пагода Стандарт 8×8 м – классическая элегантность для крупных мероприятий",
        url: `/tent/${PAGE_CODE}`,
      },
      content: { desktop: "", mobile: "" },
      priceConfigurations: [
        {
          name: "Базовая (Стандарт)",
          isActive: true,
          currentPrice: 260000,
          originalPrice: 340000,
          discount: 24,
          description:
            "Алюминиевый каркас, ПВХ тент 650 г/м², боковые стенки, входная дверь. Для мероприятий, банкетов, свадеб, выставок.",
        },
        {
          name: "Оптимальная (Премиум)",
          isActive: false,
          currentPrice: 380000,
        ...
        {
          name: "Максимальная (Эксклюзив)",
          isActive: false,
          currentPrice: 530000,
          originalPrice: 710000,
          discount: 25,
          description:
            "Стальной каркас с антикоррозийным покрытием, сэндвич-панели, освещение, отопление, кондиционирование, витрины, брендирование тента.",
        },
      ],
      contacts: {
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатёр Пагода Стандарт 8×8 м (64 м²) – купить пагодный шатер в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатёр Пагода Стандарт 8×8 метров (площадь 64 м²) с острой крышей от производителя MOBILE TENT. Классическая пагодная конструкция для крупных банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 260 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода стандарт 8х8, пагода 8х8, шатер 8 на 8, пагодный шатер 8х8";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатёр Пагода Стандарт 8×8 метров с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaStandard8x8Page() {
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [260000, 380000, 530000];
  ...
  const ridgeHeight = 8.5;

  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda1.webp",
    name: pageData.page?.name || "Шатёр Пагода Стандарт 8×8 м (64 м²)",
    description:
      pageData.seo?.description ||
      "Шатёр Пагода Стандарт 8×8 метров – классическая пагодная конструкция с острой крышей для крупных банкетов, выставок, свадеб, ресторанов. Элегантный дизайн, площадь 64 м², высота в коньке 8.5 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-STANDARD-8x8`,
    ...
    category: "Пагодные шатры / Классические конструкции",
    additionalProperty: [
      ...
      { "@type": "PropertyValue", name: "Срок изготовления", value: "от 10 до 16 рабочих дней" },
      { "@type": "PropertyValue", name: "Гарантия", value: "5 лет на каркас и тент" },
    ],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Стандарт 8×8 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатёр Пагода Стандарт 8×8 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Какую площадь имеет шатёр Пагода Стандарт 8×8 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Площадь шатра составляет 64 м², высота стенки – 3,5 метра, высота в коньке – до 8,5 метров. Это позволяет комфортно разместить до 45-50 гостей за столами или до 60-70 человек на фуршет.",
        },
      },
      {
        "@type": "Question",
        name: "Сколько стоит шатёр Пагода Стандарт 8×8 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "260 000"} ₽ за базовую комплектацию, премиум версия – от ${prices[1]?.toLocaleString() || "380 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "530 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Стандарт 8×8 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатёр Пагода Стандарт 8×8 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Стандарт 8×8 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей лучше всего подходит шатёр Пагода Стандарт 8×8 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Идеален для: крупных свадеб и банкетов, корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, фотостудий, лаунж-зон на фестивалях.",
        },
      },
      {
        "@type": "Question",
        name: "Можно ли установить в шатре Пагода окна и двери?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатёр Пагода Стандарт 8×8 м – классическая элегантность для крупных мероприятий"}</h1>
