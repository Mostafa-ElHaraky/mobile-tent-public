...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Арочный ангар 15×20 (300 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Арочный ангар 15×20 м",
      text: "Прямоугольный ангар площадью 300 м² предназначен для хранения, производства, выставочных мероприятий и других задач. Конструкция отличается надёжностью, долговечностью и функциональностью благодаря современным материалам.",
    },
    {
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Длина", value: "20 м (регулируется)" },
    ...
    { label: "Вес конструкции", value: "2 100 кг (алюминий)" },
