...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 15×30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 15×30 м",
      text: `Шатёр 15×30 м для выставок — мобильная быстровозводимая конструкция. Высота по стенке — 2,5 / 3 / 3,5 / 4 м, в коньке — до 7,5 м. Вес тента — 2 475 кг. Площадь — 450 м². Отлично противостоит порывам ветра, поэтому активно используется для организации выставок и презентаций на открытом воздухе.

Купить или арендовать недорого шатры для мероприятий можно в специализированной компании.

Услуги нашей компании:
• проектирование и изготовление каркасно-тентовых конструкций;
• аренда, продажа шатров и навесов;
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `Тент шатра — сертифицированный водонепроницаемый ПВХ с добавками, препятствующими гниению и горению. Для изготовления каркаса используется анодированный алюминий — высокопрочный сплав 6063 DIN 573. Крепёжные элементы выполнены из надёжной оцинкованной стали DIN 50976.

Площадь шатра — 450 м². Высота опоры — 2,5 / 3 / 3,5 / 4 м. Ветровая нагрузка — до 30 м/сек. Вес конструкции — 2 475 кг.`,
    },
    {
      title: "Особенности монтажа",
      text: `Монтируется конструкция на выровненную поверхность без использования специализированной техники. Требуется дополнительное крепление каркаса к поверхности или его утяжеление при помощи бетонных блоков.

Эстетичный вид шатра придаст престижности выставке, а его устойчивость гарантирует организаторам беспроблемное проведение мероприятия. Шатёр 15×30 м и мобильные конструкции других размеров и форм можно заказать с доставкой в компании.`,
    },
  ];

  // TECH SPECS — UPDATED for 15×30
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "2 475 кг" },
