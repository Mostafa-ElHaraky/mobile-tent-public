...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 10×15
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 10×15 — надёжное и универсальное решение",
      text: `Прямоугольный тентовый ангар 10×15 м можно использовать в качестве склада, торгового помещения, производственной зоны и для многих других задач. Металлические ангары от нашей компании — это прочные и долговечные конструкции, рассчитанные на многолетнюю эксплуатацию.`,
    },
    {
      title: "Наше предприятие успешно занимается",
      text: `• проектированием;
• изготовлением;
• выполнением ремонтных работ и комплексным обслуживанием тентовых ангаров.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Общая площадь ангара 10×15 м — 150 м².

• ПВХ-полотно французского производства DICKSON с системой LoWick — не горит (М2, Г1) и не поддаётся гниению, сохраняет свойства при многократном монтаже.
• Прочный анодированный алюминиевый каркас уверенно выдерживает ветровые нагрузки.
• Возможность брендирования: нанесём логотип вашей компании или другие изображения на тент.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Монтаж/демонтаж выполняются без применения спецтехники, быстро и без потери качества.
• Конструкция устанавливается на ровную поверхность и надёжно крепится к основанию.
• Рекомендуется утяжеление основания бетонными блоками или мешками с песком.
Свяжитесь с нами — менеджер ответит на вопросы и поможет изготовить ангар 10×15 в соответствии с вашими пожеланиями.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 10×15
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 10×15" },
