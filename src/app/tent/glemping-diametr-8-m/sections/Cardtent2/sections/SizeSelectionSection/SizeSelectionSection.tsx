...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your code
...
Свяжитесь со специалистами Mobile Tent и получите ответы на все ваши вопросы!`,
  ...
  // Default specs with updated data
  const defaultSpecs: { label: string; value: string }[] = [
    { 
      label: "Утепление", 
      value: "Подвесная оболочка из термостеганного полотна (oxford_210-holofiber_200-oxford_210)" 
    },
    { 
      label: "Тамбур", 
      value: "Вход - рама для дверей. Фанера ФСФ 18мм, обработка огне-био защитой, легкое водостойкое покрытие" 
    },
    { 
      label: "Быстровозводимый сантехнический модуль", 
      value: "туалет, душ" 
    },
    { 
      label: "Вентиляционный зонт", 
      value: "Листовая сталь+порошковая покраска" 
    },
    { 
      label: "Отопительный модуль", 
      value: "Информация об отопительном модуле" 
    },
  ];
