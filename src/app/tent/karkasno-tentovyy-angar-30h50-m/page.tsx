...
const PAGE_CODE = "karkasno-tentovyy-angar-30h50-m";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 215,
        name: "Каркасный ангар 30×50м Тип Д (1500 м²)",
        code: PAGE_CODE
      },
      seo: {
        title: "Каркасный ангар 30×50м (1500 м²) Тип Д – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Каркасный ангар 30×50м (1500 м²) Тип Д от производителя MOBILE TENT. Усиленный металлокаркас, сэндвич-панели или ПВХ тент. Для складов, производств, спорта. Цена от 1 250 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "каркасный ангар 30х50, ангар 30 на 50, купить каркасный ангар 30х50, быстровозводимый ангар, ангар тип Д, ангар 1500 кв м, цена ангара 30х50",
        h1: "Каркасный ангар 30×50м Тип Д (1500 м²)",
        url: `/tent/karkasno-tentovyy-angar-30h50-m`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Каркасный ангар 30×50м (1500 м²) Тип Д – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Каркасный ангар 30×50м (1500 м²) Тип Д от производителя MOBILE TENT. Усиленный металлокаркас, сэндвич-панели или ПВХ тент. Для складов, производств, спорта. Цена от 1 250 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "каркасный ангар 30х50, ангар 30 на 50, купить каркасный ангар 30х50, быстровозводимый ангар, ангар тип Д, ангар 1500 кв м";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Каркасный ангар 30×50м Тип Д (1500 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "description": "Производство и продажа каркасных ангаров 30×50м, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации каркасного ангара 25×30м Тип Д",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": pageData.page?.name || "Каркасный ангар 30×50м Тип Д",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у каркасного ангара 30×50м Тип Д?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Каркасный ангар 30×50м Тип Д имеет ширину 30 метров, длину 50 метров, высоту стенки до 7 метров, высоту в коньке до 9 метров. Полезная площадь — 1500 м². Это оптимальный размер для складов, производственных цехов и спортивных залов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит каркасный ангар 30×50м под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 30×50м как производственный цех круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели 100-150 мм) и установке системы отопления, ангар 30×50м можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на строительство каркасного ангара 30×50м?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для некапитальных сооружений площадью до 1500 м² разрешение не требуется. Наш ангар 1500 м² попадает в эту категорию. Для капитального строительства (с фундаментом) может потребоваться уведомление. Наши юристы помогают с оформлением всех необходимых документов."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на каркасный ангар 30×50м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 30×50м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 30×50м ворота, двери, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 30×50м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
          "name": "Доставляете ли ангары 30×50м в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается каркасный ангар 30×50м Тип Д | MOBILE TENT",
    "description": "Видео-инструкция по монтажу каркасного ангара 30×50м (1500 м²). Быстровозводимая конструкция для складов и производства.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Каркасный ангар 30×50м Тип Д (1500 м²)"}
      </h1>
