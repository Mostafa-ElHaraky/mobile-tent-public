...
const tentSequences = [
  {
    basePath: "/4х4_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "3x4.5 м" },
    { label: "Площадь:", value: "13.5 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "17 человек" },
    { label: "Ширина:", value: "3м" },
    { label: "Длина:", value: "4.5м" },
...
const thumbnails = [
  { id: 1, src: "/mobilny3x45,3.webp", alt: "Product 1" },
  { id: 2, src: "/mobilny3x45,2.webp", alt: "Product 2" },
  { id: 3, src: "/mobilny3x45,1.webp", alt: "Product 3" },
      ...
      <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
        <div className="flex flex-col w-full max-w-[658px]">
          <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
            Мобильный шатёр Slim Prof 3х4.5
          </div>
        </div>
