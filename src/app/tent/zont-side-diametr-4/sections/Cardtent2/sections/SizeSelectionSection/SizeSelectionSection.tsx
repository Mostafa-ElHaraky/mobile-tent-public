...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Side Ø4 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Side Ø4 м — больше тени и комфорта",
...
Диаметр 4 м обеспечивает укрытие площадью около 12,56 м², а свободная центральная зона удобна для расстановки мебели.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Side Ø4 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Side Ø4 м" },
