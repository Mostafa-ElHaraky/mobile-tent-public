...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Standart Ø4 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Standart Ø4 м — больше тени и комфорта",
...
Диаметр 4 м обеспечивает укрытие площадью около 12,56 м², а лаконичный дизайн легко вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Standart Ø4 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Standart Ø4 м" },
    { label: "Форма в плане", value: "Восьмиугольная" },
    { label: "Расположение стойки", value: "В центре" },
    { label: "Площадь", value: "12,56 м²" },
