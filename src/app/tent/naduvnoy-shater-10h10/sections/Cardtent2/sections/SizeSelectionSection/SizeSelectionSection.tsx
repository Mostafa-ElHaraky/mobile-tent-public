...
export const SizeSelectionSection = (): ReactElement => {
 ...
 const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Надувной шатёр 10х10",
      text: "Технические характеристики и параметры модели ниже.",
    },
    {
      title:
        "Надувной шатёр 10х10 от Мобайл-тент — быстрое и удобное решение для мероприятий",
...
Компания Мобайл-тент более 10 лет успешно занимается производством шатров и заслужила доверие клиентов по всей России.`,
    ...
    {
      title: "Технические характеристики и преимущества Надувного шатра 10х10",
      text: `Особенности конструкции:

• Быстрая установка (15–20 минут) с помощью электрического насоса.  
...
Ответ: Конструкция выполнена из усиленного ПВХ и выдерживает нагрузку ветра и дождя.`,
    },
    {
      ...
      text: `Закажите надувной шатёр 10х10 сегодня и обеспечьте своему событию надежное и стильное пространство!`,
    },
  ];

  // TECH SPECS — UPDATED for Надувной шатер 10х10
  const specs: { label: string; value: string }[] = [
    { label: "Серия/Модель", value: "Надувной шатёр 10х10" },
    { label: "Площадь", value: "100 м²" },
    { label: "Размер", value: "10х10 м" },
    { label: "Высота стенки", value: "около 3.5 м" },
    { label: "Высота в коньке", value: "около 5 м" },
