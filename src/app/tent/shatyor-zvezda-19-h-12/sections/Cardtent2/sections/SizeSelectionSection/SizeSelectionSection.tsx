...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр Звезда 19×12
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр Звезда 19×12 — просторное решение для масштабных мероприятий",
      text: `Шатёр формата «Звезда» создаёт эффектное пространство для фестивалей, презентаций, фуршетов и частных событий. Конструкция быстро монтируется, не требует фундамента и обеспечивает защищённое пространство для гостей и оборудования.`,
    },
    {
...
• Материал купола: 500 D 100% полиэстер с пропиткой ПВХ.`,
  ...
  // TECH SPECS — UPDATED for Шатёр Звезда 19×12
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шатёр Звезда 19×12" },
    { label: "Форма", value: "Круг" },
    { label: "Площадь", value: "231,11 м²" },
    { label: "Длина", value: "19,10 м" },
    { label: "Ширина", value: "12,10 м" },
