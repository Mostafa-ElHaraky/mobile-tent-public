...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Мобильный шатёр Hard Prof 3х4.5
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Мобильный шатёр Hard Prof 3х4.5",
      text:
        "Шатёр 3х4,5 м — это практичный мобильный тент. Он прекрасно защищает от прямых лучей солнца и небольшого дождя.",
    },
    {
      title: "Что предлагает MOBILE TENT",
      text:
        "Специализированное предприятие MOBILE TENT предлагает купить по доступной стоимости современные лёгкие защитные конструкции разных размеров. Кроме того, наша компания занимается:\n• проектированием;\n• изготовлением;\n• предоставлением в аренду шатров любого типа.",
    },
    {
      title: "Применение",
      text:
        "Шатёр рекомендуется эксплуатировать в тёплое время года. Использоваться такая конструкция может при проведении как спортивных, так и культурных мероприятий. Предлагаемые цены на приобретение или аренду понравятся каждому клиенту.",
    },
  ];

  // TECH SPECS — UPDATED for Hard Prof 3х4.5
  const specs: { label: string; value: string }[] = [
    { label: "Серия/Модель", value: "Hard Prof 3х4.5" },
    ...
    { label: "Размер упаковки", value: "163 x 40 x 32 см" },
