...
const PAGE_CODE = "bystrosbornye-shatry-transformery-prof-3h3"; 
...
async function getPageData() {
  try {
    ...
    return {
      ...
      page: {
        id: 206,
        name: "Быстросборные шатры трансформеры Prof 3х3",
        code: PAGE_CODE
      },
      seo: {
        title: "Быстросборные шатры трансформеры Prof 3х3 – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent",
        description: "Быстросборные шатры трансформеры Prof 3х3 – купить в Москве под заказ в компании Mobile Tent. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.",
        keywords: "",
        h1: "Быстросборные шатры трансформеры Prof 3х3",
        url: `/bystrosbornye-shatry-transformery-prof-3h3`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Быстросборные шатры трансформеры Prof 3х3 – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Быстросборные шатры трансформеры Prof 3х3 – купить в Москве под заказ в компании Mobile Tent. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "";
  const seoUrl = data.seo?.url || `/tent/bystrosbornye-shatry-transformery-prof-3h3`;
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Быстросборные шатры трансформеры Prof 3х3"}
      </h1>
