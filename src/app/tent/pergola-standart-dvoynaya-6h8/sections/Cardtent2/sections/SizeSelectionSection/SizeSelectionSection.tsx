...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Пергола для кафе Эконом 3х5
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Пергола для кафе Эконом 3х5",
      text: "Технические характеристики модели — во вкладке «Характеристики» ниже.",
    },
  ];

  // TECH SPECS — UPDATED for Пергола для кафе Эконом 3х5
  const specs: { label: string; value: string }[] = [
    { label: "Серия/Модель", value: "Пергола для кафе Эконом 3х5" },
    { label: "Форма в плане", value: "Прямоугольная" },
    { label: "Форма каркаса", value: "Арочная" },
    { label: "Площадь", value: "15 м²" },
    { label: "Размер", value: "3×5 м (Длина 5 м; Ширина 3 м)" },
    {
      label: "Основание",
      value:
    ...
    {
      label: "Тентовое полотно и стены",
      value:
        "ПВХ материала французского производства DICKSON с системой LoWick. Класс пожарной безопасности M2, Г1.",
    },
    {
      label: "Тентовое покрытие",
      value:
        "Сертифицированное ПВХ-полотно с добавками, препятствующими горению (DIN 4102 B1, M2), устойчиво к гниению.",
    },
    {
      label: "Каркас",
      value: "Все элементы каркаса изготовлены из стали высокого качества.",
    },
    { label: "Крепёжные элементы", value: "Оцинкованная сталь." },
  ];
            ...
            <div className="grid grid-cols-1 gap-4">
              {specs.map((item, i) => (
                ...
                >
                  ...
                  <span className="text-[#394355] text-base font-semibold whitespace-pre-line">
                    {item.value}
                  </span>
                </div>
              ))}
