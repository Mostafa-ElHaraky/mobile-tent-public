...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Классический шатёр 25х30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Классический шатёр 25х30",
      text: `Классический шатёр 25х30 м — это практичное решение вопроса с помещением при проведении свадьбы, юбилея, корпоративного и спортивного мероприятия. Компания рекомендует эксплуатировать сооружение в тёплое время года. Конструкция станет надёжной преградой для прямых солнечных лучей и дождя любой интенсивности.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Естественно, шатры всех моделей обязательно надёжно крепятся к поверхности площадки с помощью кольев или привязываются к тяжёлому основанию. Таким образом обеспечивается устойчивость классического шатра 25х30 м от воздействия сильного ветра.

Наша компания выполняет изготовление шатров всех размеров и типов, как по своим проектам, так и по эскизам клиентов. Мы осуществляем полный комплекс работ:
— проектирование;
— производство;
— ремонт;
— техническое обслуживание.

Все услуги мы оказываем по вполне приемлемой стоимости. Если вы не планируете приобретать тентовую конструкцию, то возьмите её в аренду. Экономическая выгода такого предложения для проведения разовых мероприятий неоспорима.`,
    },
    {
...
Тентовое покрытие — сертифицированное ПВХ-полотно с добавками, препятствующими горению DIN 4102 B1, М20,3 кН/м², стойкое к гниению.
...
Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
  ...
  // TECH SPECS — UPDATED with data for 25x30m tent
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Сертификация тента", value: "ПВХ DIN 4102 B1, М20,3 кН/м², стойкость к гниению" },
