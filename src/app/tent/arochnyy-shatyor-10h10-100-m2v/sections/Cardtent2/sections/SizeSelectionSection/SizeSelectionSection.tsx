...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your original code (10×10 — 100 м² variant)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Описание",
      text: `Арочный шатер площадью 100 кв. м станет отличным решением для проведения мероприятия на открытой площадке. 
Для его установки требуется лишь наличие ровной поверхности, а об остальном позаботятся наши специалисты.`,
    },
    {
      title: "Преимущества и применение арочных шатров 10×10",
      text: `Усиленный каркас арочного шатра поможет достичь особой устойчивости, не перегружая его визуально. 
На площади такого сооружения можно с успехом провести свадьбу, банкет, корпоратив или юбилей — его эстетичный внешний вид подойдет для любых случаев, а устойчивая конструкция не заставит беспокоиться о непогоде.`,
    },
    {
      title: "Дополнительные возможности",
      text: `При желании вы можете установить дополнительные модули — это позволит расширить пространство и зонировать его.`,
    },
    {
      title: "Почему Mobile Tent",
      text: `За покупкой или арендой арочного шатра обращайтесь в Mobile Tent! 
Мы предлагаем не только качественные тенты, но и любые сопутствующие услуги по установке, декорированию, благоустройству и доставке шатра.`,
    },
  ];

  // Default specs from your original code (10×10 — 100 м² variant)
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота в коньке", value: "5,5 м" },
    { label: "Вес конструкции", value: "1450 кг" },
    { label: "Нагрузка на опорную пятку", value: "362 кг" },
    ...
    {
      label: "Модульность",
      value: 'Возможность увеличения площади путём соединения нескольких конструкций со стороной 10 м: "VIP-модуль 10×10 м", "VIP-модуль Дюна 10×10 м", "VIP-модуль 20×20 м", "VIP-модуль Гексагональ 20×17 м", "VIP Дополнительный модуль 10×5 м", "VIP-модуль Октогональ 26×24 м", "VIP-модуль 17×20 м LONG-1", "VIP-модуль 17×20 м LONG-2".',
    },
    {
