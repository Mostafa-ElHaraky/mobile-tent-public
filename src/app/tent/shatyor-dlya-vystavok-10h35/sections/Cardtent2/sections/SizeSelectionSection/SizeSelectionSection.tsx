...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 10×35
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 10х35 м",
      text: `Производитель навесных конструкций поможет подобрать оптимальный по площади шатёр для проведения выставок. Сотрудничая с производителем, вы получаете выгодные цены и гарантии качества.

Мобильные тенты — удобные и недорогие конструкции, позволяющие проводить презентации, выставки, торговые ярмарки под открытым небом. ПВХ таких конструкций служит надёжной защитой от непогоды.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `Закрытый со всех сторон от ветра и очень просторный (350 м²).
Площадь может быть увеличена соединением с другими шатровыми конструкциями, а установка пола и заказ дополнительных опций повысит комфорт проведения мероприятия.
Длительный срок службы — каркас из анодированного алюминия не подвержен коррозии, французское ПВХ не горит и не гниёт.`,
    },
    {
      title: "Особенности монтажа",
      text: `Для сооружения шатра для выставок 10×35 м не нужно задействовать спецтехнику.
Разборный каркас из анодированного алюминия просто собрать, ПВХ-полотно не доставляет сложностей при закреплении и плотно натягивается.
Сборка и демонтаж выполняются в короткие сроки, предусмотрено многократное использование конструкции без потери её эксплуатационных характеристик.
Специалисты компании помогут подобрать, доставить на место и установить функциональный и просторный шатёр для проведения презентаций и выставок. Наша продукция отличается высоким качеством сборки; для изготовления используются безопасные материалы европейского производства.`,
    },
  ];
