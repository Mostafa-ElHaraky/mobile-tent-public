...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Premium 5×5
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Premium 5×5 — 25 м² тени и комфорта",
...
Размер 5×5 м обеспечивает около 25 м² полезной площади укрытия, а лаконичный дизайн органично вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Premium 5×5
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Premium 5×5" },
