...
const tentSequences = [
  {
    basePath: "/classic_small_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  const specifications = [
    { label: "Размер:", value: "3.5x3.5 м" },
    { label: "Площадь:", value: "12.25 м²" },
    { label: "Форма:", value: "Квадрат" },
    { label: "Вместимость:", value: "8 человек" },
    { label: "Длина:", value: "3.5м" },
    { label: "Ширина:", value: "3.5м" },
    { label: "Высота входной арки:", value: "3,5м" },
    { label: "Высота в коньке:", value: "3,5м" },
  ...
  const thumbnails = [
  { id: 1, src: "/small1.webp", alt: "Product 1" },
  { id: 2, src: "/small2.webp", alt: "Product 2" },
  ...
  const performDownloadKP = async () => {
    ...
    const productImage = thumbnails[0]?.src || "/small1.webp";
        ...
        <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
          <div className="flex flex-col w-full max-w-[658px]">
            <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
              {pageName || "Арочный шатёр 3,5х3,5 — 12,25 м² (V)"}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="absolute top-[5px] left-[750px] z-10">
              <div className="font-normal text-[#394355] text-base leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0] mb-4">
                ...
                <span className="font-semibold underline">201</span>
              </div>
              ...
              <div className="w-[660px] h-[660px] rounded-[20px] overflow-hidden relative z-10">
                {selectedMode === "3d" ? (
                  ...
                  <Image
                    ...
                    alt="Арочный шатёр 3,5х3,5 — 12,25 м² (V)"
                    width={1280}
                    height={720}
