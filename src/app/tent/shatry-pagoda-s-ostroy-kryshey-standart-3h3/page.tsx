...
const PAGE_CODE = "shatry-pagoda-s-ostroy-kryshey-standart-3h3";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 0,
        name: "Шатры Пагода с острой крышей Стандарт 3×3 м (9 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатер Пагода Стандарт 3×3 м (9 м²) – купить пагодный шатер с острой крышей в Москве | MOBILE TENT",
        description:
          "Шатер Пагода Стандарт 3×3 метра (площадь 9 м²) с острой крышей от производителя MOBILE TENT. Компактная пагодная конструкция для мероприятий, торговли, кафе. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 52 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода 3х3, пагода с острой крышей 3х3, шатер 3 на 3, пагодный шатер 3х3, торговый шатер 3х3, шатер для мероприятий 3х3, шатер кафе 3х3",
        h1: "Шатер Пагода Стандарт 3×3 м – компактное решение для вашего бизнеса",
        url: `/tent/${PAGE_CODE}`,
      },
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатер Пагода Стандарт 3×3 м (9 м²) – купить пагодный шатер с острой крышей в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатер Пагода Стандарт 3×3 метра (площадь 9 м²) с острой крышей от производителя MOBILE TENT. Компактная пагодная конструкция для мероприятий, торговли, кафе. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 52 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода 3х3, пагода с острой крышей 3х3, шатер 3 на 3, пагодный шатер 3х3, торговый шатер 3х3";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатер Пагода Стандарт 3×3 метра с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaStandard3x3Page() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda4.webp",
    name: pageData.page?.name || "Шатры Пагода с острой крышей Стандарт 3×3 м (9 м²)",
    description:
      pageData.seo?.description ||
      "Шатер Пагода Стандарт 3×3 метра – компактная пагодная конструкция с острой крышей для мероприятий, торговли, кафе. Элегантный дизайн, площадь 9 м², высота в коньке 4.2 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-STANDARD-3x3`,
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Стандарт 3×3 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатер Пагода Стандарт 3×3 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Какую площадь имеет шатер Пагода Стандарт 3×3 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Сколько стоит шатер Пагода Стандарт 3×3 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода 3×3 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатер Пагода 3×3 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода 3×3 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей подходит шатер Пагода 3×3 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли установить в шатре Пагода 3×3 м окна и двери?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатер Пагода Стандарт 3×3 м – компактное решение для вашего бизнеса"}</h1>
