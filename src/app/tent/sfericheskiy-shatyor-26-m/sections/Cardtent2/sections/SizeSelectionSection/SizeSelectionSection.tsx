...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Сферический шатёр диаметр 26 м (≈531 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых сферических шатров и купольных конструкций. Сферический шатёр диаметром 26 метров (≈531 м²) — это грандиозное купольное сооружение для масштабных мероприятий, концертов, выставочных центров, складов и временных объектов. Уникальная геодезическая форма обеспечивает максимальную прочность при минимальном весе.",
    },
    {
      title: "Особенности модели",
      text: "Сферический шатёр выполнен в форме полусферы, что даёт равномерное распределение нагрузок. Диаметр 26 метров создаёт полезную площадь около 531 м² и высоту в центре до 26 метров. Конструкция не требует капитального фундамента, монтируется за 10–14 дней. Благодаря утеплённой версии шатёр можно использовать круглый год даже при -40°C.",
    },
    {
      title: "Практичность и применение",
      text: "Сфера‑шатёр 26 м идеально подходит для: концертов и фестивалей (до 600–700 зрителей), корпоративов, свадеб на 400+ гостей, выставок, ярмарок, ресторанов под открытым небом, торговых центров, складов, укрытия техники, авиационных ангаров, спортивных сооружений, выставочных павильонов, конгресс-центров.",
    },
    {
      title: "Материалы",
    ...
    },
    {
      ...
      text: "Возможность соединения нескольких сфер в единый комплекс (кластер). Можно комбинировать с шатрами других форм и размеров. Сферические шатры легко масштабируются: диаметры 6 м, 8 м, 10 м, 12 м, 14 м, 16 м, 20 м, 26 м и более.",
    },
  ];

  // Technical specifications for sphere tent diameter 26 m
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Сферическая (полусфера)" },
    { label: "Диаметр", value: "26 м" },
    { label: "Площадь пола", value: "≈531 м²" },
    { label: "Высота в центре", value: "26 м" },
    { label: "Высота стенки", value: "0 м (купол)" },
    { label: "Вес металлоконструкции (алюминий)", value: "~3 500 кг" },
    { label: "Вес металлоконструкции (сталь)", value: "~7 500 кг" },
    ...
    { label: "Монтаж", value: "10–14 дней профессиональной бригадой" },
