...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 20×30 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 20×30 м",
      text: `Шатёр для мероприятий 20×30 — это очень прочный и практичный тент, который станет отличным дополнением вашего пикника или отдыха. 
Шатёр мобилен и не занимает много места при транспортировке. 
Благодаря плотной ткани он замечательно защищает от солнечных лучей и дождя. 
Под таким шатром можно укрыться во время сильного ливня большой компанией и продолжать праздник.`,
    },
    {
      title: "Аренда и производство",
      text: `Кроме имеющихся в наличии моделей, мы занимаемся разработкой и проектированием защитных конструкций. 
Вы можете арендовать у нас любой понравившийся шатёр на необходимое вам время. 
Все наши услуги порадуют вас приятными ценами и высоким качеством работы.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Чаще всего шатры используются в тёплое время года: весной, летом и осенью. 
У таких конструкций широкий спектр применения — спортивные и культурные мероприятия, семейные торжества на свежем воздухе, когда собирается большое число гостей. 
Наши цены на изготовление и аренду шатров для мероприятий порадуют каждого покупателя!`,
    },
    {
      title: "Особенности монтажа",
      text: `Если планируется мероприятие на открытой местности, где возможны сильные порывы ветра, шатёр необходимо надёжно закрепить к поверхности. 
При хорошем креплении даже сильный ветер не сможет повредить конструкцию.`,
    },
  ];

  // TECH SPECS — UPDATED for 20×30
