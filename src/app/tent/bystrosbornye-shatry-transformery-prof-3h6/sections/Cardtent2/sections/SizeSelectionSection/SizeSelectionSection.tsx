...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your code (3×6 — 18 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр 3х6: чем обусловлена его популярность?",
      text: `Шатер 6х3 является мобильным строением, которое возводится в самые короткие сроки, не теряя качества и надежности. Что касается цветовой гаммы, то конструкции имеют множество окрасок: красные, голубые, зеленые - это лишь малая часть палитры.
...
Водонепроницаемость;
Защита от гниения.
К тому же шатёр 6х3 легко оснастить подходящей мебелью, освещением, стильными декорациями, техническим оборудованием и иными дополнительными опциями, которые легко взять в аренду.`,
    },
    {
...
Свяжитесь со специалистами Mobile Tent и получите ответы на все ваши вопросы!`,
  ...
  // Default specs from your code (3×6 — 18 м²)
