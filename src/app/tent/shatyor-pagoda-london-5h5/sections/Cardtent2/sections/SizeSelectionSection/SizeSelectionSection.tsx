...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Лондон 5×5 м (25 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Лондон 5×5 м (25 м²) — это премиальная конструкция в классическом британском стиле. Острая крыша и элегантный дизайн делают его идеальным выбором для банкетов, свадеб, выставок и VIP-зон.",
    },
    {
      title: "Особенности модели Лондон 5×5",
      text: "Пагодный шатер Лондон выполнен в форме квадрата с характерной острой крышей (увеличенный угол наклона). Площадь 25 м² позволяет комфортно разместить до 18-22 гостей за столами или до 25-30 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 2–3 часа. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Британский стиль и эстетика",
      text: "Классическая форма с острой крышей выделяет шатёр Лондон среди стандартных конструкций. Размер 5×5 м идеально подходит для средних и крупных мероприятий. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Премиальные материалы отделки подчёркивают статус события.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Лондон 5×5 м идеально подходит для: банкетов и свадеб, корпоративных мероприятий, выставочных павильонов, ресторанных веранд, бутиков временной торговли, лаунж-зон на фестивалях, фотостудий.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent London 5×5 m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота стенки", value: "2,8 м" },
    { label: "Высота в коньке", value: "до 6,5 м" },
    { label: "Вес конструкции (алюминий)", value: "~260 кг" },
    { label: "Вес конструкции (сталь)", value: "~480 кг" },
    { label: "Транспортный объём", value: "1,2 м³" },
    { label: "Ветровая нагрузка", value: "до 65 км/ч (18 м/с)" },
    { label: "Нагрузка подвеса на арку", value: "до 20 кг/п.м." },
