...
const PAGE_CODE = "shatyor-pagoda-london-5h5";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent London 5×5 m
    return {
      success: false,
      page: {
        id: 271,
        name: "Шатёр Пагода Лондон 5×5 м (25 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатёр Пагода Лондон 5×5 м (25 м²) – купить премиальный пагодный шатер в Москве | MOBILE TENT",
        description:
          "Шатёр Пагода Лондон 5×5 метров (площадь 25 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция в британском стиле для банкетов, выставок, торговли, кафе. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 120 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода лондон 5х5, пагода лондон 5х5, шатер лондон 5 на 5, пагодный шатер премиум 5х5, шатер для банкета 5х5, шатер для свадьбы, шатер лондон тип",
        h1: "Шатёр Пагода Лондон 5×5 м – британская элегантность для масштабных мероприятий",
        url: `/tent/${PAGE_CODE}`,
      },
      ...
      priceConfigurations: [
        {
          ...
          discount: 23,
          description:
            "Премиальный алюминиевый каркас, ПВХ тент 650 г/м², боковые стенки, входная дверь. Для статусных мероприятий, банкетов, свадеб, торговли.",
        },
        {
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатёр Пагода Лондон 5×5 м (25 м²) – купить премиальный пагодный шатер в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатёр Пагода Лондон 5×5 метров (площадь 25 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция в британском стиле для банкетов, выставок, торговли, кафе. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 120 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода лондон 5х5, пагода лондон 5х5, шатер лондон 5 на 5, пагодный шатер премиум 5х5";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатёр Пагода Лондон 5×5 метров с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaLondon5x5Page() {
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [120000, 175000, 250000];
  ...
  const ridgeHeight = 6.5;

  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda5x5,3.webp",
    name: pageData.page?.name || "Шатёр Пагода Лондон 5×5 м (25 м²)",
    description:
      pageData.seo?.description ||
      "Шатёр Пагода Лондон 5×5 метров – премиальная пагодная конструкция в британском стиле с острой крышей для банкетов, выставок, кафе. Элегантный дизайн, площадь 25 м², высота в коньке 6.5 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-LONDON-5x5`,
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Лондон 5×5 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатёр Пагода Лондон 5×5 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Чем отличается шатёр Пагода Лондон 5×5 м от стандартной пагоды?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Какую площадь имеет шатёр Пагода Лондон 5×5 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Площадь шатра составляет 25 м², высота стенки – 2,8 метра, высота в коньке – до 6,5 метров. Это позволяет комфортно разместить до 18-22 гостей за столами или до 25-30 человек на фуршет.",
        },
      },
      {
        "@type": "Question",
        name: "Сколько стоит шатёр Пагода Лондон 5×5 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "120 000"} ₽ за базовую комплектацию Лондон, премиум версия – от ${prices[1]?.toLocaleString() || "175 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "250 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Лондон 5×5 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатёр Пагода Лондон 5×5 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Лондон 5×5 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей лучше всего подходит шатёр Пагода Лондон 5×5 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Идеален для: премиальных свадеб и банкетов, корпоративных мероприятий, выставочных павильонов, бутиков временной торговли, ресторанных веранд, фотостудий, лаунж-зон.",
        },
      },
    ],
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатёр Пагода Лондон 5×5 м – британская элегантность для масштабных мероприятий"}</h1>
