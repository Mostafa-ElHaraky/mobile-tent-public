...
<div className="absolute bottom-[190px] right-[-60px] w-[180px] h-[180px]"> {/* تم التكبير من 150x150 إلى 180x180 */}
  <Image
...
<section className={`${isMobile ? 'px-4' : 'px-12'} py-8`}>
  ...
  <Badge className="absolute bottom-[-90px] right-4 flex items-center gap-[15px] px-6 py-3 bg-white rounded-[50px] border-[3px] border-solid shadow-md">
...
<DialogTrigger asChild>
  <Button
    ...
    className="relative top-[-110px] gap-[15px] h-[68px] rounded-2xl shadow-2 [background:linear-gradient(180deg,rgba(115,168,255,1)_0%,rgba(111,167,255,1)_37%,rgba(60,108,236,1)_100%)] max-w-[499px]"
  >
    <div className="w-[50px] h-[50px] flex items-center justify-center">
...
<DialogContent className="sm:rounded-2xl">
  <DialogHeader className="flex items-start justify-between">
    <div>
      <DialogTitle className="text-xl text-black">Документы по ткани</DialogTitle>
    ...
    <DialogClose asChild>
      <button
        type="button"
        className="ml-4 inline-flex items-center justify-center rounded-full p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 focus:outline-none"
      >
        <X className="w-5 h-5" />
      </button>
    </DialogClose>
      ...
      <Card key={doc.path} className="border border-[#e5e7eb]">
        ...
        <CardContent className="p-4 flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="flex items-center gap-3 min-w-0 sm:flex-1">
            ...
            <span className="font-medium truncate w-full">{doc.title}</span>
          </div>

          {/* Right: actions */}
          <div className="flex gap-2 sm:shrink-0 w-full sm:w-auto">
            <Link
              href={doc.encodedPath}
              target="_blank"
            ...
            >
              <Button
                variant="outline"
                className="h-9 w-full sm:w-auto px-3 sm:px-4"
              >
            ...
            <a href={doc.encodedPath} download className="flex-1 sm:flex-none">
              <Button className="h-9 w-full sm:w-auto px-3 sm:px-4">
...
<Dialog open={open} onOpenChange={setOpen}>
  ...
  <DialogContent className="max-w-[720px] sm:rounded-2xl">
    ...
    <DialogClose asChild>
      <button
        type="button"
        className="absolute top-3 right-3 inline-flex items-center justify-center rounded-full p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 focus:outline-none"
      >
        <X className="w-5 h-5" />
      </button>
    </DialogClose>
