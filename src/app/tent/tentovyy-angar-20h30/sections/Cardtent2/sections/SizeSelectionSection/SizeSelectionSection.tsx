...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 20×30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 20×30 — быстрый и выгодный формат помещения",
      text: `Приобретение в собственность или аренда тентового ангара 20×30 м от производителя выгоднее, чем длительное строительство капитального сооружения. При тех же эксплуатационных характеристиках готовой конструкции стоимость материалов ниже, а результат можно получить уже через несколько часов.

Производитель навесных конструкций изготавливает надёжные тентовые ангары в полной заводской комплектации. Для их возведения не нужны никакие дополнительные работы, помимо монтажных. Сотрудничая напрямую с производителем, вы получаете гарантии качества и низкую цену.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Площадь — 600 м², длина ангара — 30 м, высота стены (опоры) — 3/3,5/4/4,5/5 м, максимальная высота в коньке — 8,5 м, вес конструкции — 9 т.
Прочный металлический каркас (анодированный алюминий), крепежи изготовлены из оцинкованной стали.
Конструкция выдерживает ветровую нагрузку до 30 м/сек, нагрузка подвеса на арку — до 30 кг/п.м.`,
    },
    {
      title: "Сфера применения и преимущества",
      text: `Практичный тентовый ангар размером 20×30 м можно приобрести или арендовать; использовать — в качестве производственного цеха, складского помещения, крытой автостоянки или спортивного комплекса.
Специальная конструкция обтекаемой формы и скатная крыша не допускают скопления атмосферных осадков — ангар можно эксплуатировать круглый год.
Тентовое полотно ПВХ не горит, не пропускает осадки, надёжно защищает от сквозняков.`,
    },
    {
      title: "Особенности монтажа",
      text: `Транспортировка ангара на место установки производится в сложенном состоянии.
Не нужно заливать фундамент — достаточно крепления каркаса к ровной поверхности с использованием утяжелителей.
Конструкция мобильна: возможен оперативный демонтаж и установка в другом месте.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 20×30
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 20×30" },
    ...
    { label: "Вес конструкции", value: "9000 кг" },
