...
const tentSequences = [
  {
    basePath: "/20x30_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "25x30 м" },
    { label: "Площадь:", value: "750 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "500 человек" },
...
const thumbnails = [
  { id: 1, src: "/20x20,4.webp", alt: "Product 1" },
  { id: 2, src: "/20x20,5.webp", alt: "Product 2" },
  { id: 3, src: "/20x20,6.webp", alt: "Product 3" },
