...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 15×40
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 15×40 м",
      text: `Шатёр для выставок 15×40 м — быстровозводимая переносная конструкция для проведения мероприятий на открытом воздухе. Высота стенки — 2,5/3/3,5/4 м, в коньке — максимум 7,5 м. Вес конструкции — 3 300 кг. Площадь — 600 м².

Отлично противостоит ветрам, применяется для организации выставок и презентаций на открытом воздухе. Купить шатры и навесы разных размеров, цветов и моделей можно в компании.

Мы предлагаем клиентам широкий спектр услуг:
• проектирование тентовых конструкций;
• продажу и аренду шатров и навесов;
• обслуживание и ремонт шатровых изделий.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `Шатёр имеет прямоугольную форму и может объединяться с другими тентами как модульная конструкция. Каркас изготовлен из высокопрочного сертифицированного анодированного алюминия (сплав 6063 DIN 573). 
Тент выполнен из ПВХ-ткани, которой характерны водонепроницаемость, повышенная плотность и прочность. Конструкция устойчива к ветровым нагрузкам до 30 м/сек.`,
    },
    {
      title: "Особенности монтажа",
      text: `Быстровозводимая конструкция устанавливается без задействования специальной техники. Может легко демонтироваться для переноса в другое место.
При установке необходимо обязательное крепление конструкции к поверхности или утяжеление каркаса блоками из бетона. Купить или взять в аренду шатёр для выставок 15×40 м с доставкой и сборкой можно по приемлемой цене в компании.`,
    },
  ];
  ...
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "3 300 кг" },
