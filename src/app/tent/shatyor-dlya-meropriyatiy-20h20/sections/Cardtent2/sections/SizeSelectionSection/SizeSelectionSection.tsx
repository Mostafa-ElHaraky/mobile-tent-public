...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 20×20 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 20×20 м",
      text: `Функциональный и практичный мобильный тент 20×20 м станет отличным дополнением к спортивному, культурному или праздничному мероприятию. Конструкция не только хорошо защищает от солнечных лучей и дождя, но и может стать украшением события.`,
    },
    {
      title: "Услуги и индивидуальные решения",
      text: `Каждый шатёр уникален. Если вы не нашли нужную каркасно-тентовую конструкцию в каталоге, мы поможем — занимаемся проектированием и созданием шатров, изготовлением защитных тентов, а также предоставляем шатры и защитные конструкции в аренду.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Лучше всего использовать каркасно-тентовые конструкции в тёплое время года. Шатры подходят для организации выступлений, создания зоны отдыха на культурных мероприятиях или зоны кафе на спортивных соревнованиях. Шатёр большой и прочный, главное — надёжно закрепить конструкцию на поверхности. При правильном креплении шатёр защитит большое количество людей даже от сильного ветра и дождя.`,
    },
  ];
