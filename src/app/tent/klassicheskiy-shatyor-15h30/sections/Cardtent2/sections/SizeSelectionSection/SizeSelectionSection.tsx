...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Классический шатёр 15х30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Классический шатёр 15х30",
      text: `Классический шатёр 15х30 м — это надёжная и практичная каркасно-тентовая конструкция для мероприятий, летних кафе и выездных проектов.
...
• продажу и аренду шатров.`,
    },
    {
      ...
      text: `Мобильный шатёр 15х30 м отлично подходит для организации пространства на открытом воздухе. Основные размеры:
• длина — 30 м,
• ширина — 15 м,
• общая площадь — 450 м².

Предусмотрены оконные и дверные проёмы, возможна комплектация съёмными стенками и дополнительными модулями.`,
    },
    {
      title: "Особенности монтажа и эксплуатации",
      text: `Шатёр не требует специального фундамента и устанавливается на любую ровную земляную поверхность.
Монтируется и демонтируется без применения спецтехники в минимальные сроки и без потери качества — любое количество раз.
Есть возможность увеличения площади путём соединения нескольких конструкций.`,
    },
    {
...
Тентовое покрытие — сертифицированное ПВХ-полотно с добавками, препятствующими горению DIN 4102 B1, M20,3 кН/м², гниению.
Каркас выполнен из анодированного алюминия (сплав 6063 DIN 573), сертификат QUALANOD.
Крепежные элементы — оцинкованная сталь DIN 50976.`,
    },
    {
      title: "Дополнительно",
      text: `Особенности монтажа: обязательное крепление конструкции к поверхности установки или утяжеление бетонными блоками.

Цену можно снизить путём снижения качества профиля, ткани ПВХ и фурнитуры. Уточняйте у менеджера!`,
    },
  ];

  // TECH SPECS — UPDATED with data for 15x30m tent
