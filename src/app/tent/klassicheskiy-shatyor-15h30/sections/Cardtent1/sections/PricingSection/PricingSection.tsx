...
const tentSequences = [
  ...
  const specifications = [
    ...
    { label: "Вместимость:", value: "62 человек" },
...
const thumbnails = [
  { id: 1, src: "/15x30,1.webp", alt: "Product 1" },
  { id: 2, src: "/15x30,2.webp", alt: "Product 2" },
  { id: 3, src: "/15x30,3.webp", alt: "Product 3" },
