...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 15×25
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 15×25 — надёжное и экономичное решение",
      text: `Тентовый ангар 15×25 м отлично подойдёт в качестве склада, торгового помещения, объекта для животноводства и других целей. Приобретение или аренда ангара зачастую выгоднее, чем традиционное капитальное строительство.`,
    },
    {
      title: "О компании",
      text: `Проектированием, изготовлением, обслуживанием и ремонтом каркасно-тентовых конструкций уже много лет успешно занимается российская компания. Нашу продукцию можно купить или арендовать — менеджер ответит на все вопросы и поможет с подбором решения.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `• Прямоугольный тентовый ангар 15×25 м имеет современный дизайн и гармонично выглядит на любой площадке.
• В упакованном виде компактный, перевозится обычным грузовым транспортом.
• ПВХ французского производства не выцветает на солнце, не горит (DIN 4102 B1, М2) и устойчиво к гниению.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Установка и демонтаж выполняются быстро — в течение нескольких часов.
• Допускаются многократные циклы сборки/разборки без потери качества тента и каркаса.`,
    },
    {
      title: "Свяжитесь с нами",
      text: `Свяжитесь с нами по телефону или напишите — изготовим тентовый ангар 15×25 м с учётом ваших пожеланий.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 15×25
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 15×25" },
    ...
    { label: "Требования к основанию", value: "Не требует специального фундамента; установка на любой земляной поверхности." },
