...
const PAGE_CODE = "angar-sportivnyy-15h40";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 251,
        name: "Ангар спортивный 15х40 (600 м²) тип В",
        code: PAGE_CODE
      },
      seo: {
        title: "Ангар спортивный 15х40 (600 м²) – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Спортивный ангар 15х40 (600 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для спортивных залов, тренировок, складов. Цена от 520 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "ангар спортивный 15х40, спортивный ангар 15 на 40, купить ангар 15х40, тентовый ангар 15х40, быстровозводимый ангар, ангар для спорта, ангар 600 кв м, цена ангара 15х40",
        h1: "Ангар спортивный 15х40 (600 м²) – надежное решение для спорта и хранения",
        url: `/tent/angar-sportivnyy-15h40`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Ангар спортивный 15х40 (600 м²) – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Спортивный ангар 15х40 (600 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для спортивных залов, тренировок, складов. Цена от 520 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "ангар спортивный 15х40, спортивный ангар 15 на 40, купить ангар 15х40, тентовый ангар 15х40, быстровозводимый ангар";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Ангар спортивный 15х40 (600 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "description": "Производство и продажа спортивных ангаров 15х40, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "name": pageData.page?.name || "Ангар спортивный 15х40 (600 м²) тип В",
    "description": pageData.seo?.description || "Спортивный ангар 15х40 (600 м²) от производителя MOBILE TENT. Идеален для спортивных залов, тренировочных баз, складов, временных сооружений. Каркас из алюминия или стали, ПВХ тент 650-900 г/м². Устойчив к ветру до 120 км/ч, снеговым нагрузкам до 120 кг/м². Срок службы 15+ лет.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-SPORT-15x40-600`,
    "brand": {
      "@type": "Brand",
      "name": "MOBILE TENT",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации спортивного ангара 15х40",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": pageData.page?.name || "Ангар спортивный 15х40 (600 м²)",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у спортивного ангара 15х40?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Спортивный ангар 15х40 имеет ширину 15 метров, длину 40 метров, высоту в коньке до 6.6 метров. Полезная площадь — 600 м². Это оптимальный размер для мини-футбольных полей, баскетбольных площадок, тренажерных залов, складов и выставочных павильонов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит ангар 15х40 под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 15х40 как спортивный зал круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 600 м² (включая ангар 15х40) разрешение на строительство не требуется, если объект устанавливается на срок до 1 года. Для длительной эксплуатации (более года) или в зонах с особыми требованиями может потребоваться уведомление администрации. Наши юристы помогают с оформлением всех необходимых документов."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на спортивный ангар 15х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "В чем отличие тентового ангара 15х40 от металлического?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается спортивный ангар 15х40 | MOBILE TENT",
    "description": "Видео-инструкция по монтажу спортивного ангара 15х40 (600 м²). Быстровозводимая конструкция для спорта и складов.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Ангар спортивный 15х40 (600 м²) – купить по цене от 520 000 ₽ с доставкой по России"}
      </h1>
