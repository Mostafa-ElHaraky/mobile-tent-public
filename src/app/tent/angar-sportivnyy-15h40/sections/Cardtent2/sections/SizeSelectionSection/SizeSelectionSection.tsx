...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Ангар спортивный 15×40 (600 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Ангар спортивный 15×40",
      text: "Прямоугольная конструкция площадью 600 м² подходит для спортивных тренировок и мероприятий, а также для хранения и производственных задач. Надёжная и функциональная, собирается в кратчайшие сроки.",
    },
    {
      title: "Практичность и монтаж",
      text: "Не требует специального фундамента — устанавливается на любой земляной поверхности. Монтируется и демонтируется без спецтехники в минимальные сроки, многократно, без потери качества. Обязательна фиксация к основанию или утяжеление бетонными блоками. Возможна модульная стыковка нескольких конструкций для увеличения площади.",
    },
    {
      title: "Материалы тента",
      text: "Тентовое полотно и стены — ПВХ DICKSON (Франция) с системой LoWick. Класс пожарной безопасности — М2, Г1. Тентовое покрытие — сертифицированное ПВХ-полотно с добавками, препятствующими горению (DIN 4102 B1, M2), прочность 0,3 кН/м², устойчиво к гниению.",
    },
    {
      title: "Каркас и крепёж",
      text: "Каркас из анодированного алюминия (сплав 6063 DIN 573), сертификат QUALANOD. Крепёжные элементы — оцинкованная сталь по DIN 50976. Нагрузка подвеса на арку — до 30 кг/п.м.",
    },
  ];
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "3 300 кг (алюминий)" },
    ...
    { label: "Монтаж", value: "Без спецтехники, быстрый, многократный" },
