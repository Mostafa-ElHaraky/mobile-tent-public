...
const tentSequences = [
  {
    basePath: "/10x10_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "10x15 м" },
    { label: "Площадь:", value: "150 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "100 человек" },
    { label: "Ширина:", value: "10м" },
    { label: "Длина:", value: "15м" },
...
const thumbnails = [
  { id: 1, src: "/events10x10,1.webp", alt: "Product 1" },
  { id: 2, src: "/events10x10,2.webp", alt: "Product 2" },
  { id: 3, src: "/events10x10,3.webp", alt: "Product 3" },
