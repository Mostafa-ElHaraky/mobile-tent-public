...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 10×15 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 10×15 м",
      text: `Тент 10×15 м — прямоугольная конструкция площадью 150 м². Идеален для мероприятий примерно на 100 человек: защищает гостей от дождя и зноя, выдерживает сильные порывы ветра и при этом легко декорируется.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности установки или утяжеление бетонными блоками.`,
    ...
    {
      title: "Идеально для мероприятий на 100 человек",
      text: `Если вы решили организовать мероприятие на сто человек, тент 10×15 м обеспечит комфорт и надёжную защиту от погодных условий — от яркого солнца до дождя и ветра.`,
    },
    {
      title: "Аренда — удобно и выгодно",
      text: `В компании Mobile Tent можно не только заказать изготовление шатра индивидуальных цветов, форм и размеров, но и арендовать его для вашего события — это отличный вариант, если не планируете повторное использование.`,
    },
    {
      title: "Качество и дополнительные услуги",
      text: `Помимо изготовления шатров мы предоставляем сопутствующие услуги:
• обслуживание и ремонт шатров;
• доставка, установка и демонтаж;
• установка освещения, вентиляции/обогрева и пола;
• установка мебели.`,
    },
    {
      title: "Доставка и поддержка",
      text: `Остались вопросы по аренде шатра на 100 человек, покупке или монтажу? Позвоните по номеру, указанному на сайте — специалисты Mobile Tent помогут с выбором и проконсультируют по всем нюансам.`,
    },
  ];
