...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Арочный ангар 40×100 (4 000 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Арочный ангар 40×100 м",
      text: "Большой ангар прямоугольной формы, рассчитанный на различные задачи: хранение, производство, выставочные мероприятия и другие виды использования. Благодаря продуманной конструкции и современным материалам, обеспечивает надёжность, долговечность и функциональность.",
    },
    {
    ...
    {
      title: "Материалы",
      text: "Тентовое полотно и стены изготовлены из ПВХ материала французского производства DICKSON с системой LoWick. Класс пожарной безопасности — М2, Г1. Покрытие сертифицировано (DIN 4102 B1, M2), устойчиво к горению, гниению и разрывам (0,3 кН/м²).",
    },
    {
      title: "Каркас и крепёж",
      text: "Все элементы каркаса изготовлены из анодированного алюминия, крепёжные элементы — из оцинкованной стали, что обеспечивает прочность и устойчивость конструкции.",
    },
  ];
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Длина", value: "100 м (регулируется)" },
    ...
    { label: "Вес конструкции", value: "15 000+ кг (алюминий)" },
    ...
    { label: "Модульность", value: "Возможна стыковка нескольких ангаров 40×N" },
