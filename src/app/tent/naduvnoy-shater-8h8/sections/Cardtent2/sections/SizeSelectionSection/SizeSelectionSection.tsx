...
export const SizeSelectionSection = (): ReactElement => {
  ...
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Надувной шатёр 8х8",
      text: "Технические характеристики и параметры модели ниже.",
    },
    {
      title:
        "Надувной шатёр 8х8 от Мобайл-тент — быстрое и удобное решение для мероприятий",
...
Компания Мобайл-тент более 10 лет успешно занимается производством шатров и заслужила доверие клиентов по всей России.`,
    ...
    {
      title: "Технические характеристики и преимущества Надувного шатра 8х8",
      text: `Особенности конструкции:

• Быстрая установка (10–15 минут) с помощью электрического насоса.  
...
Ответ: Конструкция выполнена из усиленного ПВХ и выдерживает нагрузку ветра и дождя.`,
    },
    {
      ...
      text: `Закажите надувной шатёр 8х8 сегодня и обеспечьте своему событию надежное и стильное пространство!`,
    },
  ];

  // TECH SPECS — UPDATED for Надувной шатер 8х8
  const specs: { label: string; value: string }[] = [
    { label: "Серия/Модель", value: "Надувной шатёр 8х8" },
    { label: "Площадь", value: "64 м²" },
    { label: "Размер", value: "8х8 м" },
    { label: "Высота стенки", value: "около 3 м" },
    { label: "Высота в коньке", value: "около 4.5 м" },
