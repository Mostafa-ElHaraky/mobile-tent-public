...
const PAGE_CODE = "angar-sportivnyy-10h40";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 249,
        name: "Ангар спортивный 10х40 (400 м²) тип В",
        code: PAGE_CODE
      },
      seo: {
        title: "Ангар спортивный 10х40 (400 м²) – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Спортивный ангар 10х40 (400 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для спортивных залов, тренировок, складов. Цена от 520 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "ангар спортивный 10х40, спортивный ангар 10 на 40, купить ангар 10х40, тентовый ангар 10х40, быстровозводимый ангар, ангар для спорта, ангар 400 кв м, цена ангара 10х40",
        h1: "Ангар спортивный 10х40 (400 м²) – надежное решение для спорта и хранения",
        url: `/tent/angar-sportivnyy-10h40`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Ангар спортивный 10х40 (400 м²) – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Спортивный ангар 10х40 (400 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для спортивных залов, тренировок, складов. Цена от 520 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "ангар спортивный 10х40, спортивный ангар 10 на 40, купить ангар 10х40, тентовый ангар 10х40, быстровозводимый ангар";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://mobile-tent.ru/B_10x40_1.webp',
          width: 1200,
          height: 630,
          alt: 'Ангар спортивный 10х40 (400 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "MOBILE TENT",
    "image": "https://mobile-tent.ru/B_10x40_1.webp",
    ...
    "description": "Производство и продажа спортивных ангаров 10х40, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "image": [
      "https://mobile-tent.ru/B_10x40_1.webp",
    ],
    "name": pageData.page?.name || "Ангар спортивный 10х40 (400 м²) тип В",
    "description": pageData.seo?.description || "Спортивный ангар 10х40 (400 м²) от производителя MOBILE TENT. Идеален для спортивных залов, тренировочных баз, складов, временных сооружений. Каркас из алюминия или стали, ПВХ тент 650-900 г/м². Устойчив к ветру до 120 км/ч, снеговым нагрузкам до 120 кг/м². Срок службы 15+ лет.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-SPORT-10x40-400`,
    "brand": {
      "@type": "Brand",
      "name": "MOBILE TENT",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации спортивного ангара 10х40",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": pageData.page?.name || "Ангар спортивный 10х40 (400 м²)",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у спортивного ангара 10х40?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Спортивный ангар 10х40 имеет ширину 10 метров, длину 40 метров, высоту в коньке до 6.2 метров. Полезная площадь — 400 м². Это оптимальный размер для мини-футбольных полей, баскетбольных площадок, тренажерных залов, складов и выставочных павильонов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит ангар 10х40 под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 10х40 как спортивный зал круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели или утепленный тент) и установке системы отопления, ангар 10х40 можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку ангара 10х40 в Москве или области?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 400 м² (включая ангар 10х40) разрешение на строительство не требуется, если объект устанавливается на срок до 1 года. Для длительной эксплуатации (более года) или в зонах с особыми требованиями может потребоваться уведомление администрации. Наши юристы помогают с оформлением всех необходимых документов."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на спортивный ангар 10х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 10х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 10х40 стены, двери, ворота, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 10х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Доставляете ли ангары 10х40 в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "В чем отличие тентового ангара 10х40 от металлического?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается спортивный ангар 10х40 | MOBILE TENT",
    "description": "Видео-инструкция по монтажу спортивного ангара 10х40 (400 м²). Быстровозводимая конструкция для спорта и складов.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Ангар спортивный 10х40 (400 м²) – купить по цене от 520 000 ₽ с доставкой по России"}
      </h1>
