...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Купольный тент Ø20 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Купольный тент, диаметр 20 м",
      text: `Купольные тенты крупного размера идеально подходят для проведения масштабных мероприятий, выставок и фестивалей. Благодаря геодезической форме они обеспечивают высокую прочность конструкции и устойчивость к ветровым нагрузкам. Конструкция легко масштабируется и может быть оборудована утеплением и инженерными системами для круглогодичного использования.`,
    },
  ];

  // TECH SPECS — Updated for Ø20 м
  const specs: { label: string; value: string }[] = [
    { label: "Форма", value: "Купольная (геодезический купол)" },
    { label: "Диаметр", value: "20 м" },
    { label: "Площадь", value: "около 314 м²" }, // π·10² ≈ 314 м²
    { label: "Вместимость", value: "до 400 человек в зависимости от формата мероприятия" },
    { label: "Монтаж", value: "Сборка опытной бригадой; минимальное количество соединений" },
    { label: "Эксплуатация", value: "Круглогодичная при утеплении, вентиляции и отоплении" },
  ];
