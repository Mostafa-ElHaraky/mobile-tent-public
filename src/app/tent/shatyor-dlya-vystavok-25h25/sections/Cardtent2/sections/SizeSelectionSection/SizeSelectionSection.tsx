...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 25×25
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 25×25 м",
      text: `Квадратный шатёр для выставок 25×25 м прекрасно выполнит свою функцию временного помещения. Общая площадь составляет 625 м² — конструкция способна вместить большое количество гостей. Мобильную конструкцию можно установить в любом красивом месте и тем самым добавить приятных эмоций посетителям.

Купить или арендовать шатёр можно в компании, которая предлагает полный комплекс услуг:
• разработка проекта шатровой конструкции;
• изготовление;
• доставка и монтаж;
• ремонт и обслуживание шатров.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `• Общая площадь 625 м² — вместимость для крупных мероприятий.
• Надёжный каркас и тент из прочного ПВХ-покрытия выдерживают непогоду.
• Цвет тента, число оконных и дверных проёмов можно согласовать с менеджером.
• Многоразовый монтаж и разборка не сказываются на качестве тента.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Доставка и монтаж могут быть выполнены силами наших специалистов.
• После установки на ровную поверхность шатёр 25×25 м необходимо закрепить и/или утяжелить бетонными блоками.
• Для монтажа не требуется специальная техника.`,
    },
  ];

  // TECH SPECS — UPDATED for 25×25
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "9 375 кг" },
