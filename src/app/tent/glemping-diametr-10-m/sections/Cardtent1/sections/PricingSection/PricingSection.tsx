...
const tentSequences = [
  {
    basePath: "/360_walls/", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "10 м" },
    { label: "Площадь:", value: "78 м²" },
    { label: "Форма:", value: "Круг" },
    { label: "Вместимость:", value: "52 человек" },
    { label: "Ширина:", value: "10м" },
    { label: "Длина:", value: "10м" },
...
const thumbnails = [
  { id: 1, src: "/glemping2.webp", alt: "Product 1" },
  { id: 2, src: "/glemping1.webp", alt: "Product 2" },
  { id: 3, src: "/glemping3.webp", alt: "Product 3" },
        ...
        <Badge className="px-2 py-1 rounded-lg bg-[linear-gradient(180deg,rgba(255,115,115,1)_0%,rgba(255,111,111,1)_37%,rgba(236,60,60,1)_100%)]">
          ...
          <div className="absolute top-[5px] left-[750px] z-10">
            <div className="font-normal text-[#394355] text-base leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0] mb-4">
              ...
              <span className="font-semibold underline">210</span>
            </div>
