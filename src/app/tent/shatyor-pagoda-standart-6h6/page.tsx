...
const PAGE_CODE = "shatyor-pagoda-standart-6h6";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent Standard 6×6 m
    return {
      success: false,
      page: {
        id: 275,
        name: "Шатёр Пагода Стандарт 6×6 м (36 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатёр Пагода Стандарт 6×6 м (36 м²) – купить пагодный шатер в Москве | MOBILE TENT",
        description:
          "Шатёр Пагода Стандарт 6×6 метров (площадь 36 м²) с острой крышей от производителя MOBILE TENT. Классическая пагодная конструкция для банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 145 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода стандарт 6х6, пагода 6х6, шатер 6 на 6, пагодный шатер 6х6, шатер для банкета 6х6, шатер для свадьбы, шатер стандарт",
        h1: "Шатёр Пагода Стандарт 6×6 м – классическая элегантность для ваших мероприятий",
        url: `/tent/${PAGE_CODE}`,
      },
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатёр Пагода Стандарт 6×6 м (36 м²) – купить пагодный шатер в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатёр Пагода Стандарт 6×6 метров (площадь 36 м²) с острой крышей от производителя MOBILE TENT. Классическая пагодная конструкция для банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 145 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода стандарт 6х6, пагода 6х6, шатер 6 на 6, пагодный шатер 6х6";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатёр Пагода Стандарт 6×6 метров с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaStandard6x6Page() {
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [145000, 210000, 295000];
  ...
  const productSchema = {
    ...
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda6x6,3.webp",
    name: pageData.page?.name || "Шатёр Пагода Стандарт 6×6 м (36 м²)",
    description:
      pageData.seo?.description ||
      "Шатёр Пагода Стандарт 6×6 метров – классическая пагодная конструкция с острой крышей для банкетов, выставок, свадеб, ресторанов. Элегантный дизайн, площадь 36 м², высота в коньке 7.2 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-STANDARD-6x6`,
    ...
    additionalProperty: [
      ...
      { "@type": "PropertyValue", name: "Срок изготовления", value: "от 7 до 12 рабочих дней" },
      { "@type": "PropertyValue", name: "Гарантия", value: "5 лет на каркас и тент" },
    ],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Стандарт 6×6 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатёр Пагода Стандарт 6×6 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Какую площадь имеет шатёр Пагода Стандарт 6×6 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Сколько стоит шатёр Пагода Стандарт 6×6 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "145 000"} ₽ за базовую комплектацию, премиум версия – от ${prices[1]?.toLocaleString() || "210 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "295 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Стандарт 6×6 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатёр Пагода Стандарт 6×6 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Стандарт 6×6 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей лучше всего подходит шатёр Пагода Стандарт 6×6 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Идеален для: свадеб и банкетов, корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, фотостудий, лаунж-зон на фестивалях.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатёр Пагода Стандарт 6×6 м – классическая элегантность для ваших мероприятий"}</h1>
