...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Стандарт 6×6 м (36 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Стандарт 6×6 м (36 м²) — это классическая конструкция с острой крышей для банкетов, свадеб, выставок, конференций и корпоративных мероприятий. Оптимальное соотношение цены и качества.",
    },
    {
      title: "Особенности модели Стандарт 6×6",
      text: "Пагодный шатер Стандарт выполнен в форме квадрата с характерной острой крышей. Площадь 36 м² позволяет комфортно разместить до 25-30 гостей за столами или до 35-40 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 3–4 часа. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Классический дизайн и эстетика",
      text: "Классическая форма с острой крышей придаёт шатру элегантный вид. Размер 6×6 м идеально подходит для средних мероприятий. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Доступны различные цветовые решения тента.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Стандарт 6×6 м идеально подходит для: свадеб и банкетов, корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, бутиков временной торговли, лаунж-зон на фестивалях, фотостудий.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent Standard 6×6 m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота стенки", value: "3,0 м" },
    { label: "Высота в коньке", value: "до 7,2 м" },
    { label: "Вес конструкции (алюминий)", value: "~380 кг" },
    { label: "Вес конструкции (сталь)", value: "~700 кг" },
    { label: "Транспортный объём", value: "1,8 м³" },
    ...
    { label: "Монтаж", value: "3–4 часа профессиональной бригадой" },
