...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 15×40 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 15×40 м",
      text: `Шатёр для мероприятий 15×40 — отличное дополнение для любого массового события, будь то выступление музыкантов или спортивное соревнование. Конструкция мобильная и быстро-сборная: для установки не требуется спецтехника, монтаж занимает считанные часы. Поставить шатёр сможет и новичок, но лучше доверить работу профессионалам.

Наше предприятие готово выполнить ваш заказ на каркасно-тентовую продукцию любых размеров и конфигураций. Нашу продукцию вы можете купить или арендовать.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Мобильный функциональный шатёр 15×40 м прекрасно защитит большое количество людей от палящего солнца или внезапного дождя. Помимо продажи и сдачи в аренду готовых каркасно-тентовых конструкций, компания MOBILE TENT занимается проектированием, разработкой и изготовлением шатровых изделий по доступным ценам.`,
    },
    {
      title: "Особенности монтажа",
      text: `Тёплое время года — лучший период для применения шатров. Эксплуатация возможна на больших семейных торжествах, конных соревнованиях, спортивных и культурных мероприятиях. Внутри можно организовать зону отдыха и мини-бар. При установке шатра необходимо надёжно закрепить конструкцию на поверхности — так она сохранит устойчивость при ветреной погоде.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Закажите шатёр для мероприятий 15×40 у нас — быстро рассчитаем смету, организуем доставку и монтаж.`,
    },
  ];

  // TECH SPECS — UPDATED for 15×40
