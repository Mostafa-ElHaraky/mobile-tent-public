...
const tentSequences = [
  ...
  const specifications = [
    { label: "Размер:", value: "15x40 м" },
    { label: "Площадь:", value: "600 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "402 человек" },
    { label: "Ширина:", value: "15м" },
    { label: "Длина:", value: "40м" },
...
const thumbnails = [
  { id: 1, src: "/events15x40,1.webp", alt: "Product 1" },
  { id: 2, src: "/events15x40,2.webp", alt: "Product 2" },
  { id: 3, src: "/events15x40,3.webp", alt: "Product 3" },
