...
const PAGE_CODE = "karkasnyy-angar-40h100-m";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 221,
        name: "Каркасный ангар 40×100м Тип Д (4000 м²)",
        code: PAGE_CODE
      },
      seo: {
        title: "Каркасный ангар 40×100м (4000 м²) Тип Д – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Каркасный ангар 40×100м (4000 м²) Тип Д от производителя MOBILE TENT. Усиленный металлокаркас, сэндвич-панели или ПВХ тент. Для складов, производств, спорта. Цена от 1 250 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "каркасный ангар 40х100, ангар 40 на 100, купить каркасный ангар 40х100, быстровозводимый ангар, ангар тип Д, ангар 4000 кв м, цена ангара 40х100",
        h1: "Каркасный ангар 40×100м Тип Д (4000 м²)",
        url: `/tent/karkasnyy-angar-40h100-m`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Каркасный ангар 40×100м (4000 м²) Тип Д – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Каркасный ангар 40×100м (4000 м²) Тип Д от производителя MOBILE TENT. Усиленный металлокаркас, сэндвич-панели или ПВХ тент. Для складов, производств, спорта. Цена от 1 250 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "каркасный ангар 40х100, ангар 40 на 100, купить каркасный ангар 40х100, быстровозводимый ангар, ангар тип Д, ангар 4000 кв м";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Каркасный ангар 40×100м Тип Д (4000 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "description": "Производство и продажа каркасных ангаров 40×100м, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации каркасного ангара 40×100м Тип Д",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": pageData.page?.name || "Каркасный ангар 40×100м Тип Д",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у каркасного ангара 40×100м Тип Д?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Каркасный ангар 40×100м Тип Д имеет ширину 40 метров, длину 100 метров, высоту стенки до 7 метров, высоту в коньке до 9 метров. Полезная площадь — 4000 м². Это оптимальный размер для складов, производственных цехов и спортивных залов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит каркасный ангар 40×100м под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 40×100м как производственный цех круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели 100-150 мм) и установке системы отопления, ангар 40×100м можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на строительство каркасного ангара 40×100м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на каркасный ангар 40×100м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 40×100м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 40×100м ворота, двери, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 40×100м?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
          "name": "Доставляете ли ангары 40×100м в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается каркасный ангар 40×100м Тип Д | MOBILE TENT",
    "description": "Видео-инструкция по монтажу каркасного ангара 40×100м (4000 м²). Быстровозводимая конструкция для складов и производства.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Каркасный ангар 40×100м Тип Д (4000 м²)"}
      </h1>
