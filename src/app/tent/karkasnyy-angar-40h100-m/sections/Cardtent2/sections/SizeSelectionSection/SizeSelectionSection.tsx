...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасный ангар 40×100м (4 000 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасных ангаров и тентовых конструкций. Каркасный ангар 40×100м (4 000 м²) — это масштабное прямоугольное сооружение для крупных промышленных объектов, логистических центров, сельскохозяйственных комплексов, спортивных арен, авиационных ангаров и выставочных павильонов.",
    },
    {
      title: "Особенности модели",
      text: "Ангар выполнен в прямостенной форме с двускатной кровлей. Площадь 4 000 м² позволяет разместить производственные линии, высотные стеллажи, спортивные площадки, самолёты или выставочные стенды. Конструкция требует ленточного или свайного фундамента, монтируется за 30–45 дней.",
    },
    {
    ...
    {
      title: "Материалы",
      text: "Каркас из стали высокого качества с антикоррозийным покрытием (порошковая окраска или горячий цинк). Покрытие — сэндвич-панели 50–200 мм или ПВХ тент 650-900 г/м² французского производства DICKSON. Класс пожарной безопасности М2, Г1. Возможна установка окон, ворот, систем вентиляции и отопления.",
    },
    {
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 40×100м. Можно комбинировать с другими типоразмерами: 40×80м, 40×120м, 40×150м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame hangar 40×100m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Длина", value: "100 м (может быть увеличена модулями)" },
    { label: "Ширина (пролёт)", value: "40 м" },
    { label: "Высота стенки", value: "до 10 м" },
    { label: "Высота в коньке", value: "до 12 м" },
    { label: "Вес металлоконструкции", value: "~60 000 кг" },
    ...
    { label: "Тип покрытия", value: "Сэндвич-панели 50–200 мм / ПВХ тент DICKSON 650-900 г/м², М2, Г1" },
    { label: "Фундамент", value: "Ленточный или свайный (проектируется индивидуально)" },
    { label: "Монтаж", value: "30–45 дней профессиональной бригадой с автокраном" },
