...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 25×40
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 25×40 м",
      text: `Любую выставку можно превратить в незабываемое мероприятие, если провести её в интересном месте. Сделав выбор в пользу шатра для выставок 25×40 м, культурный праздник можно организовать где угодно. Конструкция имеет красивый дизайн и общую площадь 1 000 м².

Заказать каркасно-тентовую продукцию любых размеров и моделей можно в нашей компании, которая успешно занимается:
• проектированием;
• изготовлением;
• комплексным обслуживанием;
• ремонтом шатровых конструкций.

Заказанный у нас шатёр мы изготовим в сжатые сроки, а также доставим собственным транспортом и установим, если у вас будет такое пожелание.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `• Надёжная конструкция каркаса шатра.
• Огнеупорное ПВХ французского производства отличного качества.
• Цвет тента, количество дверных и оконных проёмов может быть разным.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Устанавливается шатёр для выставок 25×40 м на ровную поверхность. Устройство фундаментной основы не требуется.
• Конструкция монтируется всего за несколько часов.
• Чтобы сделать заказ, звоните нам прямо сейчас. На сайте компании можно оставить сообщение или воспользоваться услугой «обратный звонок».`,
    },
  ];

  // TECH SPECS — UPDATED for 25×40
