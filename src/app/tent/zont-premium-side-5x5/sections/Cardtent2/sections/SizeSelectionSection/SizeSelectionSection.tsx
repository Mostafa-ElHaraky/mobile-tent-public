...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Premium Side 5×5
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Premium Side 5×5 — 25 м² тени и комфорта",
      text: `Квадратный зонтовый навес с боковой стойкой — практичное решение для летних веранд, уличных кафе, лаунж-зон и площадок отдыха.
Размер 5×5 м обеспечивает около 25 м² полезной площади укрытия, а свободная центральная зона удобна для расстановки мебели.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — квадратная. Стойка расположена сбоку, что освобождает центр от опоры и повышает удобство использования пространства.
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Premium Side 5×5
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Premium Side 5×5" },
