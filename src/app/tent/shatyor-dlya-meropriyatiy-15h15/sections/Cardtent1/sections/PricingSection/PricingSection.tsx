...
const tentSequences = [
  ...
  const specifications = [
    { label: "Размер:", value: "15x15 м" },
    { label: "Площадь:", value: "225 м²" },
    { label: "Форма:", value: "Квадрат" },
    { label: "Вместимость:", value: "150 человек" },
    { label: "Ширина:", value: "15м" },
    { label: "Длина:", value: "15" },
...
const thumbnails = [
  { id: 1, src: "/events15x15,1.webp", alt: "Product 1" },
  { id: 2, src: "/events15x15,2.webp", alt: "Product 2" },
  { id: 3, src: "/events15x15,3.webp", alt: "Product 3" },
