...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Side Ø5 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Side Ø5 м — просторная тень и комфорт",
      text: `Восьмиугольный зонт с боковой стойкой — практичное решение для летних веранд, уличных кафе, лаунж-зон и открытых площадок.
Диаметр 5 м обеспечивает укрытие площадью около 19,625 м², а свободная центральная зона удобна для расстановки мебели.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Side Ø5 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Side Ø5 м" },
