...
const PAGE_CODE = "arochnyy-shatyor-6h5-30-m2";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 174,
        name: "Арочный шатёр 6х5 — 30 м²",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный шатёр 6х5 — 30 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent",
        description: "Арочный шатёр 6х5 — 30 м² – купить в Москве под заказ в компании Mobile Tent. Универсальный шатер среднего размера, идеально подходящий для проведения мероприятий, установки кафе, выставочных павильонов и складских нужд. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.",
        keywords: "арочный шатёр 6х5, купить арочный шатер 6х5, шатер 6 на 5, арочный шатер 30м2, шатер для мероприятий, шатер для кафе, шатер для свадьбы, тентовый шатер, быстровозводимый шатер, шатер среднего размера",
        h1: "Арочный шатёр 6х5 — 30 м²",
        url: `/tent/arochnyy-shatyor-6h5-30-m2`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный шатёр 6х5 — 30 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Арочный шатёр 6х5 — 30 м² – купить в Москве под заказ в компании Mobile Tent. Универсальный шатер среднего размера, идеально подходящий для проведения мероприятий, установки кафе, выставочных павильонов и складских нужд. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "арочный шатёр 6х5, купить арочный шатер 6х5, шатер 6 на 5, арочный шатер 30м2, шатер для мероприятий, шатер для кафе, шатер для свадьбы, тентовый шатер, быстровозводимый шатер, шатер среднего размера";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Арочный шатёр 6х5 - 30 м² от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const productSchema = {
    ...
    "name": pageData.page?.name || "Арочный шатёр 6х5 — 30 м²",
    "description": pageData.seo?.description || "Арочный шатёр 6х5 — 30 м² – купить в Москве под заказ в компании Mobile Tent. Универсальный шатер среднего размера, идеально подходящий для проведения мероприятий, установки кафе, выставочных павильонов и складских нужд. Вы можете выбрать любую комплектацию, размер и цвет изделия.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-ARCH-6x5-30`,
    "brand": {
      "@type": "Brand",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Назначение",
        "value": "Мероприятия, свадьбы, кафе, выставки, склад, торговые площади"
      }
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  // ----- FAQ SCHEMA (customized for арочный шатер 6х5) -----
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": `Какие размеры у арочного шатра 6х5?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Арочный шатер имеет ширину 6 метров, длину 5 метров, высоту в коньке до 4.5 метров. Полезная площадь — ${area} м². Это универсальный размер среднего формата, который подходит для большинства задач — от проведения мероприятий до складского хранения.`
        }
      },
      {
        "@type": "Question",
        "name": `Сколько стоит арочный шатер 6х5?`,
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Для каких целей подходит арочный шатер 6х5?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный шатер 6х5 идеально подходит для: свадебных мероприятий и банкетов, кафе и ресторанов (летние веранды), выставочных павильонов, торговых площадей, складских нужд, спортивных мероприятий, укрытия для техники, зон отдыха на мероприятиях."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку арочного шатра 6х5 в Москве?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить стены и двери в арочном шатре 6х5?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, возможна установка торцевых стен с дверями, окнами, воротами. Также доступны боковые стены, системы вентиляции, освещения и отопления. Площадь 30 м² позволяет организовать полноценное закрытое помещение. Возможно брендирование тента."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок изготовления арочного шатра 6х5?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стандартный срок изготовления арочного шатра 6х5 — от 3 до 7 рабочих дней. Для срочных заказов возможна ускоренная сборка за 1-2 дня."
        }
      },
      {
        "@type": "Question",
        "name": "Доставляете ли арочные шатры 6х5 в Московскую область?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Сколько человек вмещает арочный шатер 6х5?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "В арочном шатре 6х5 площадью 30 м² можно разместить: до 30 гостей с банкетными столами, до 50 человек на фуршете, до 20 посадочных мест в кафе, либо использовать как выставочную площадь для 4-6 стендов."
        }
      }
    ]
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный шатёр 6х5 — 30 м²"}
      </h1>
