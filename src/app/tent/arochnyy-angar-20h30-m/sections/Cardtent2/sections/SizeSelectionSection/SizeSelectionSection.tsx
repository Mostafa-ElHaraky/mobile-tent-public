...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Арочный ангар 20×30 (600 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Арочный ангар 20×30 м",
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "3 200 кг (алюминий)" },
    ...
    { label: "Модульность", value: "Возможна стыковка нескольких ангаров 20×N" },
