...
export const FeaturedProductsSection = (): ReactElement => {
  ...
  // Array of construction type images
  const constructionTypes = [
    { src: "/typeangar1.png", alt: "Тип конструкции 1" },
    { src: "/typeangar2.png", alt: "Тип конструкции 2" },
    { src: "/typeangar3.png", alt: "Тип конструкции 3" },
    { src: "/typeangar4.png", alt: "Тип конструкции 4" },
  ];
    ...
    <>
      ...
      <section className="hidden md:flex flex-col items-start gap-10 w-full max-w-[1343px] mx-auto my-12">
        <h2 className="w-full font-['Raleway',Helvetica] font-semibold text-3xl text-left tracking-[0] leading-normal">
          <span className="text-[#394355]">Ангары MobileTent могут быть </span>
        ...
        {/* NEW: Типы конструкций section */}
        <div className="w-full mt-8">
          <h3 className="font-['Raleway',Helvetica] font-semibold text-[#394355] text-2xl leading-normal mb-6">
            Типы конструкций
          </h3>
      ...
      <section className="block md:hidden flex-col items-start gap-6 w-full mx-auto my-8 px-4">
        ...
        {/* NEW: Типы конструкций section (mobile) */}
        <div className="w-full mt-6">
          <h3 className="font-['Raleway',Helvetica] font-semibold text-[#394355] text-xl leading-normal mb-4">
            Типы конструкций
          </h3>
          <div className="grid grid-cols-2 gap-4">
            {constructionTypes.map((type, idx) => (
              <div key={idx} className="relative w-full aspect-[4/3] rounded-lg overflow-hidden bg-gray-100 shadow-sm">
                <Image
                  src={type.src}
                  alt={type.alt}
                  fill
