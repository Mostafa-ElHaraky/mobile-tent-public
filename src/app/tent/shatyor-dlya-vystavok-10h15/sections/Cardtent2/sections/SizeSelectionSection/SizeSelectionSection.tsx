...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 10×15
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 10х15 м",
      text: `Шатёр для выставок 10х15 м — практичный мобильный тент, который надёжно защитит ваше мероприятие от природных явлений. Вес шатра — 825 кг. Площадь составляет 150 м². Высота стенки — 2,5/3/3,5/4 м.

Компания предлагает ассортимент тентов различных размеров и форм для проведения мероприятий и личного использования.

Мы выполняем спектр работ:
• проектирование мобильных конструкций;
• изготовление шатров и навесов любого размера;
• продажу и аренду тентов;
• обслуживание и ремонт на высоком уровне.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Шатёр предназначен для проведения выездных выставок на свежем воздухе. Прочный материал защищает от ветра, препятствует попаданию внутрь прямых лучей солнца и осадков.
В производстве тента использовался качественный ПВХ французского производителя DICKSON с системой LoWick. Тентовое покрытие — сертифицированное противопожарное и непромокаемое ПВХ-полотно.
Каркас выполнен из анодированного алюминия сплава 6063 DIN 573 повышенной прочности. Крепёжные элементы тента — из оцинкованной стали.`,
    },
    {
      title: "Особенности монтажа",
      text: `Конструкция устанавливается на земляную поверхность без применения специальной техники. Требует дополнительного укрепления на поверхности, практикуется утяжеление каркаса бетонными блоками.

Компания предлагает лёгкие навесы и мобильные шатры разной конструкции для проведения выездных мероприятий.`,
    },
  ];

  // TECH SPECS — UPDATED for 10×15
