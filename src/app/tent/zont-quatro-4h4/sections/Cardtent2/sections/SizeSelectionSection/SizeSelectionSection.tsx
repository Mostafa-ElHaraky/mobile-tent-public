...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Quatro 4×4
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Quatro 4×4 — 16 м² тени и комфорта",
...
Размер 4×4 м обеспечивает около 16 м² полезной площади укрытия.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Quatro 4×4
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Quatro 4×4" },
