...
const PAGE_CODE = "shatry-pagoda-s-ostroy-kryshey-london-4h4";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent London 4×4 m
    return {
      success: false,
      page: {
        id: 22,
        name: "Шатры Пагода с острой крышей Лондон 4×4 м (16 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатер Пагода Лондон 4×4 м (16 м²) – купить пагодный шатер с острой крышей в Москве | MOBILE TENT",
        description:
          "Шатер Пагода Лондон 4×4 метра (площадь 16 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция для свадеб, корпоративов, выставок, торговли. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 89 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода лондон 4х4, пагода с острой крышей 4х4, шатер лондон 4 на 4, пагодный шатер премиум, шатер для свадьбы 4х4, шатер для корпоратива, шатер лондон тип",
        h1: "Шатер Пагода Лондон 4×4 м – элегантность и статус для ваших мероприятий",
        url: `/tent/${PAGE_CODE}`,
      },
      ...
      priceConfigurations: [
        {
          ...
          discount: 19,
          description:
            "Премиальный алюминиевый каркас, ПВХ тент 650 г/м², боковые стенки, входная дверь. Для статусных мероприятий, свадеб, корпоративов.",
        },
        {
        ...
        },
        {
          ...
          discount: 22,
          description:
            "Стальной каркас с антикоррозийным покрытием, сэндвич-панели, освещение, отопление, кондиционирование, витрины, брендирование тента, люстры.",
        },
      ],
      contacts: {
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатер Пагода Лондон 4×4 м (16 м²) – купить пагодный шатер с острой крышей в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатер Пагода Лондон 4×4 метра (площадь 16 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция для свадеб, корпоративов, выставок, торговли. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 89 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода лондон 4х4, пагода с острой крышей 4х4, шатер лондон 4 на 4, пагодный шатер премиум";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://mobile-tent.ru/pagda4.webp",
          width: 1200,
          height: 630,
          alt: "Шатер Пагода Лондон 4×4 метра с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaLondonTentPage() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    name: "MOBILE TENT",
    image: "https://mobile-tent.ru/pagda4.webp",
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [89000, 129000, 179000];
  ...
  const ridgeHeight = 5.3;

  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda4.webp",
    name: pageData.page?.name || "Шатры Пагода с острой крышей Лондон 4×4 м (16 м²)",
    description:
      pageData.seo?.description ||
      "Шатер Пагода Лондон 4×4 метра – премиальная пагодная конструкция с острой крышей для свадеб, корпоративов, выставок, торговли. Элегантный дизайн, просторное внутреннее пространство, высота в коньке 5.3 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-LONDON-4x4`,
    ...
    category: "Пагодные шатры / Премиум-конструкции",
    additionalProperty: [
      ...
      { "@type": "PropertyValue", name: "Тип конструкции", value: "Пагодный шатер Лондон (острая крыша)" },
      ...
      { "@type": "PropertyValue", name: "Срок изготовления", value: "от 5 до 10 рабочих дней" },
      { "@type": "PropertyValue", name: "Гарантия", value: "5 лет на каркас и тент" },
    ],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Лондон 4×4 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатер Пагода Лондон 4×4 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Чем отличается шатер Пагода Лондон от стандартной пагоды?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Шатер Пагода Лондон имеет более острую крышу (угол наклона увеличен), усиленный каркас и премиальные материалы отделки. Дизайн выполнен в классическом британском стиле, что придаёт мероприятию особый статус и элегантность.",
        },
      },
      {
        "@type": "Question",
        name: "Какую площадь имеет шатер Пагода Лондон 4×4 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Площадь шатра составляет 16 м², высота стенки – 2,5 метра, высота в коньке – до 5,3 метров. Это позволяет комфортно разместить до 15-18 гостей за столами или до 20-25 человек на фуршет.",
        },
      },
      {
        "@type": "Question",
        name: "Сколько стоит шатер Пагода Лондон 4×4 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "89 000"} ₽ за базовую комплектацию Лондон, премиум версия – от ${prices[1]?.toLocaleString() || "129 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "179 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Лондон?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатер Пагода Лондон 4×4 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, при выборе утеплённой комплектации (двойной тент с утеплителем или сэндвич-панели) и установке системы отопления шатер пригоден для круглогодичной эксплуатации до -30°C.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Лондон 4×4 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Какие мероприятия лучше всего подходят для шатра Пагода Лондон?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Шатер идеален для: престижных свадеб, банкетов, корпоративных вечеров, VIP-зон на фестивалях, выставок премиум-класса, фотосессий, ресторанных веранд, бутиков временной торговли.",
        },
      },
    ],
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатер Пагода Лондон 4×4 м – элегантность и статус для ваших мероприятий"}</h1>
