...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатры Пагода с острой крышей Лондон 4×4 м (16 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатры Пагода с острой крышей Лондон 4×4 м (16 м²) — это премиальная коллекция шатров в классическом британском стиле. Острая крыша придаёт конструкции элегантность и статус, делая её идеальным выбором для свадеб, корпоративов и VIP-мероприятий.",
    },
    {
      title: "Особенности модели Лондон",
      text: "Пагодный шатер Лондон выполнен в форме квадрата с характерной острой крышей (увеличенный угол наклона). Площадь 16 м² позволяет комфортно разместить до 15-18 гостей за столами или до 20-25 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 2–3 часа. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Эстетика и стиль",
      text: "Классическая форма с острой крышей выделяет шатёр Лондон среди стандартных конструкций. Компактные размеры (4×4 м) удобны для мероприятий разного масштаба: от выездных свадеб до деловых встреч. Шатер легко интегрируется в любой ландшафт — парк, пляж или загородный комплекс. Премиальные материалы отделки подчёркивают статус события.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Лондон 4×4 м идеально подходит для: престижных свадеб, банкетов, корпоративных вечеров, VIP-зон на фестивалях, выставок премиум-класса, фотосессий, ресторанных веранд, бутиков временной торговли, лаунж-зон.",
    },
    {
      title: "Материалы",
    ...
    },
    {
      ...
      text: "Возможность соединения нескольких пагод Лондон в единый комплекс. Можно комбинировать с шатрами других размеров: Пагода Лондон 5×5 м, Пагода Лондон 6×6 м и более. Расширение площади любыми секциями.",
    },
  ];

  // Technical specifications for pagoda tent London 4×4 m
