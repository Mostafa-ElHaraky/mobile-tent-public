  ...
  try {
    ...
    return {
      ...
      seo: {
        ...
        url: `/tent/arochnyy-shater-10h5-50-m2`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный шатер 10х5 - 50 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Арочный шатер 10х5 - 50 м² – купить в Москве под заказ в компании Mobile Tent. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "арочный шатер 10х5, купить арочный шатер 10х5, шатер 10 на 5, арочный шатер 50м2, шатер для мероприятий, шатер для свадьбы, шатер для кафе, тентовый шатер, быстровозводимый шатер";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://mobile-tent.ru/module6m1.webp',
          width: 1200,
          height: 630,
          alt: 'Арочный шатер 10х5 - 50 м² от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "image": "https://mobile-tent.ru/module6m1.webp",
    "name": pageData.page?.name || "Арочный шатер 10х5 - 50 м²",
    "description": pageData.seo?.description || "Арочный шатер 10х5 - 50 м² – купить в Москве под заказ в компании Mobile Tent. Идеальное решение для мероприятий, свадеб, кафе и выездных торжеств. Вы можете выбрать любую комплектацию, размер и цвет изделия.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-ARCH-10x5-50`,
    "brand": {
      "@type": "Brand",
      "name": "MOBILE TENT"
    },
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Назначение",
        "value": "Мероприятия, свадьбы, кафе, выставки, склад"
      }
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  // ----- FAQ SCHEMA (customized for арочный шатер 10х5) -----
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": `Какие размеры у арочного шатра 10х5?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Арочный шатер имеет ширину 10 метров, длину 5 метров, высоту в коньке до 4.5 метров. Полезная площадь — ${area} м². Это оптимальный размер для проведения мероприятий, свадеб, установки кафе или выставочного павильона.`
        }
      },
      {
        "@type": "Question",
        "name": `Сколько стоит арочный шатер 10х5?`,
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Для каких целей подходит арочный шатер 10х5?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный шатер 10х5 идеально подходит для: свадебных мероприятий, банкетов, кафе и ресторанов (летние веранды), выставочных павильонов, складских нужд, спортивных мероприятий, укрытия для техники, торговых точек."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку арочного шатра 10х5 в Москве?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 50 м² разрешение не требуется. Для установки на длительный срок или в общественных местах может потребоваться согласование. Мы помогаем с оформлением необходимых документов."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить стены и двери в арочном шатре?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления арочного шатра 10х5?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стандартный срок изготовления арочного шатра 10х5 — от 3 до 7 рабочих дней. Для срочных заказов возможна ускоренная сборка за 1-2 дня."
        }
      },
      {
        "@type": "Question",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный шатер 10х5 - 50 м²"}
      </h1>
