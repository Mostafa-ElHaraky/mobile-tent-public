...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Арочный ангар 10×30 (300 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Арочный ангар 10×30 м",
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Длина", value: "30 м (регулируется)" },
    ...
    { label: "Вес конструкции", value: "1 650 кг (алюминий)" },
