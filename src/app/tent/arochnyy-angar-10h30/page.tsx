...
const PAGE_CODE = "arochnyy-angar-10h30";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 29,
        name: "Арочный ангар 10х30 (300 м²) тип В",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный ангар 10х30 (300 м²) – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Арочный ангар 10х30 (300 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для складов, производственных цехов, спортивных залов. Цена от 1 150 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "арочный ангар 10х30, ангар 10 на 30, купить ангар 10х30, тентовый ангар 10х30, быстровозводимый ангар, ангар для склада, ангар 300 кв м, цена ангара 10х30",
        h1: "Арочный ангар 10х30 (300 м²) – надежное решение для склада и производства",
        url: `/tent/arochnyy-angar-10h30`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный ангар 10х30 (300 м²) – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Арочный ангар 10х30 (300 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для складов, производственных цехов, спортивных залов. Цена от 1 150 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "арочный ангар 10х30, ангар 10 на 30, купить ангар 10х30, тентовый ангар 10х30, быстровозводимый ангар, ангар 300 кв м";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://mobile-tent.ru/B_10x30_1.webp',
          width: 1200,
          height: 630,
          alt: 'Арочный ангар 10х30 (300 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "MOBILE TENT",
    "image": "https://mobile-tent.ru/B_10x30_1.webp",
    ...
    "description": "Производство и продажа арочных ангаров 10х30, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации арочного ангара 10х30",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": pageData.page?.name || "Арочный ангар 10х30 (300 м²)",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у арочного ангара 10х30?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный ангар 10х30 имеет ширину 10 метров, длину 30 метров, высоту в коньке до 6.2 метров. Полезная площадь — 300 м². Это оптимальный размер для складов, производственных цехов, спортивных залов и выставочных павильонов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит арочный ангар 10х30 под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 10х30 как производственный цех круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели или утепленный тент) и установке системы отопления, ангар 10х30 можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку ангара 10х30 в Москве или области?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на арочный ангар 10х30?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 10х30?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 10х30 стены, двери, ворота, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 10х30?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Доставляете ли ангары 10х30 в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "В чем отличие арочного ангара 10х30 от каркасного?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается арочный ангар 10х30 | MOBILE TENT",
    "description": "Видео-инструкция по монтажу арочного ангара 10х30 (300 м²). Быстровозводимая конструкция для складов и производства.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный ангар 10х30 (300 м²) – купить по цене от 1 150 000 ₽ с доставкой по России"}
      </h1>
