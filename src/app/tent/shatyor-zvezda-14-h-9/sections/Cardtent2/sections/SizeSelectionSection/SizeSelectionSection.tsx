...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр Звезда 14×9
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр Звезда 14×9 — эффектное решение для мероприятий под открытым небом",
      text: `Шатёр формата «Звезда» создаёт выразительную площадку для фестивалей, презентаций, фуршетов и частных событий. Конструкция быстро монтируется, не требует фундамента и обеспечивает защищённое пространство для гостей и оборудования.`,
    },
    {
...
• Материал купола: 500 D 100% полиэстер с пропиткой ПВХ.`,
  ...
  // TECH SPECS — UPDATED for Шатёр Звезда 14×9
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шатёр Звезда 14×9" },
    { label: "Форма", value: "Круг" },
    { label: "Площадь", value: "118,07 м²" },
    { label: "Длина", value: "13,65 м" },
    { label: "Ширина", value: "8,65 м" },
