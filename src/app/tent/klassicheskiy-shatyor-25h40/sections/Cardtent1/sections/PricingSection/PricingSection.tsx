...
const tentSequences = [
  ...
  const specifications = [
    ...
    { label: "Вместимость:", value: "376 человек" },
...
const thumbnails = [
  { id: 1, src: "/25x40,1.webp", alt: "Product 1" },
  { id: 2, src: "/25x40,2.webp", alt: "Product 2" },
  { id: 3, src: "/25x40,3.webp", alt: "Product 3" },
