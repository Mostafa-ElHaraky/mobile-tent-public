...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатёр Пагода Стандарт 10×10 м (100 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатёр Пагода Стандарт 10×10 м (100 м²) — это классическая конструкция с острой крышей для масштабных банкетов, свадеб, выставок, конференций и корпоративных мероприятий. Отличное соотношение цены и качества.",
    },
    {
      title: "Особенности модели Стандарт 10×10",
      text: "Пагодный шатер Стандарт выполнен в форме квадрата с характерной острой крышей. Площадь 100 м² позволяет комфортно разместить до 70-80 гостей за столами или до 100-120 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 5–6 часов. Благодаря утеплённой версии шатер можно использовать круглый год.",
    },
    {
      title: "Классический дизайн и эстетика",
      text: "Классическая форма с острой крышей придаёт шатру элегантный вид. Размер 10×10 м идеально подходит для масштабных мероприятий. Шатер легко интегрируется в любой ландшафт — парк, пляж, городская площадь или загородный комплекс. Доступны различные цветовые решения тента.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода Стандарт 10×10 м идеально подходит для: масштабных свадеб и банкетов, крупных корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, бутиков временной торговли, лаунж-зон на фестивалях, фотостудий.",
    },
    {
      title: "Материалы",
  ...
  // Technical specifications for pagoda tent Standard 10×10 m
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Квадратная (пагода с острой крышей)" },
