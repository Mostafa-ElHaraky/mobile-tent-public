...
const PAGE_CODE = "shatyor-pagoda-standart-10h10";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent Standard 10×10 m
    return {
      success: false,
      page: {
        id: 277,
        name: "Шатёр Пагода Стандарт 10×10 м (100 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатёр Пагода Стандарт 10×10 м (100 м²) – купить пагодный шатер в Москве | MOBILE TENT",
        description:
          "Шатёр Пагода Стандарт 10×10 метров (площадь 100 м²) с острой крышей от производителя MOBILE TENT. Классическая пагодная конструкция для масштабных банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 395 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода стандарт 10х10, пагода 10х10, шатер 10 на 10, пагодный шатер 10х10, шатер для банкета 10х10, шатер для свадьбы, шатер стандарт",
        h1: "Шатёр Пагода Стандарт 10×10 м – классическая элегантность для масштабных мероприятий",
        url: `/tent/${PAGE_CODE}`,
      },
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатёр Пагода Стандарт 10×10 м (100 м²) – купить пагодный шатер в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатёр Пагода Стандарт 10×10 метров (площадь 100 м²) с острой крышей от производителя MOBILE TENT. Классическая пагодная конструкция для масштабных банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 395 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода стандарт 10х10, пагода 10х10, шатер 10 на 10, пагодный шатер 10х10";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатёр Пагода Стандарт 10×10 метров с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaStandard10x10Page() {
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [395000, 580000, 810000];
  ...
  const productSchema = {
    ...
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda1.webp",
    name: pageData.page?.name || "Шатёр Пагода Стандарт 10×10 м (100 м²)",
    description:
      pageData.seo?.description ||
      "Шатёр Пагода Стандарт 10×10 метров – классическая пагодная конструкция с острой крышей для масштабных банкетов, выставок, свадеб, ресторанов. Элегантный дизайн, площадь 100 м², высота в коньке 10 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-STANDARD-10x10`,
    ...
    additionalProperty: [
      ...
      { "@type": "PropertyValue", name: "Срок изготовления", value: "от 14 до 20 рабочих дней" },
      { "@type": "PropertyValue", name: "Гарантия", value: "5 лет на каркас и тент" },
    ],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Стандарт 10×10 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатёр Пагода Стандарт 10×10 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Какую площадь имеет шатёр Пагода Стандарт 10×10 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Сколько стоит шатёр Пагода Стандарт 10×10 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "395 000"} ₽ за базовую комплектацию, премиум версия – от ${prices[1]?.toLocaleString() || "580 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "810 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Стандарт 10×10 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатёр Пагода Стандарт 10×10 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Стандарт 10×10 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей лучше всего подходит шатёр Пагода Стандарт 10×10 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Идеален для: масштабных свадеб и банкетов, крупных корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, фотостудий, фестивальных площадок.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатёр Пагода Стандарт 10×10 м – классическая элегантность для масштабных мероприятий"}</h1>
