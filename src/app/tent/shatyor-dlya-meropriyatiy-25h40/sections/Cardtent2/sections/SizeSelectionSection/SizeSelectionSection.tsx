...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для мероприятий 25×40 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для мероприятий 25×40 м",
      text: `Шатёр 25×40 м — фактически полноценное помещение, которое легко трансформируется в зависимости от требований организатора мероприятия.

Мы предоставляем спектр услуг:
• проектирование и производство шатровых конструкций;
• продажа недорого и прокат тентов;
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление бетонными блоками.`,
    },
    {
      ...
      text: `Проведение торжеств, выставок, ярмарок и других мероприятий на свежем воздухе требует стильной организации пространства. Оптимальное решение — покупка или аренда мобильных тентов и навесов.

Шатёр 25×40 м изготовлен из ПВХ DICKSON с системой LoWick. Отличается высокой прочностью, 100% водонепроницаемостью и устойчивостью к горению и гниению. Элементы каркаса изготовлены из надёжного анодированного алюминия (сплав 6063 DIN 573). Крепёжные элементы — высокопрочная оцинкованная сталь DIN 50976.`,
    },
    {
      title: "Особенности монтажа",
      text: `Мобильная конструкция легка и удобна в установке. Монтаж проводится без использования специализированной техники. Для надёжности следует закрепить каркас к поверхности или утяжелить его плитами из бетона.`,
    },
  ];
