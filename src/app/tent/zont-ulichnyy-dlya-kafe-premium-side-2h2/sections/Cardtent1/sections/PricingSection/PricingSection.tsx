...
const tentSequences = [
  ...
  const specifications = [
    { label: "Размер:", value: "2x2 м" },
    { label: "Площадь:", value: "4 м²" },
    { label: "Форма:", value: "Квадрат" },
    { label: "Вместимость:", value: "2 человек" },
    { label: "Ширина:", value: "2м" },
    { label: "Длина:", value: "2м" },
...
const thumbnails = [
  { id: 1, src: "/zontmish.webp", alt: "Product 1" },
  { id: 2, src: "/zontmish1.webp", alt: "Product 2" },
  { id: 3, src: "/zontmish2.webp", alt: "Product 3" },
      ...
      <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
        <div className="flex flex-col w-full max-w-[658px]">
          <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
            Зонт уличный для кафе Premium Side 2х2
          </div>
        </div>
