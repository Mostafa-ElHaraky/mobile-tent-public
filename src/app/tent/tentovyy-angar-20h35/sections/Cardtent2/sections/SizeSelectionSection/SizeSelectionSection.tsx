...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 20×35
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 20×35 — быстрый и выгодный формат помещения",
      text: `Крупнейший в России производитель каркасно-тентовых конструкций предлагает приобрести готовый тентовый ангар 20×35 м, взять его в аренду или изготовить в индивидуальном исполнении.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Прямоугольный ангар имеет площадь 700 м², длина — 35 м.
Каркас повышенной прочности устойчив к ветровым нагрузкам до 30 м/сек, нагрузка подвеса на арку — до 30 кг/п.м.
Максимальная высота в коньке — 8,5 м.`,
    },
    {
      title: "Применение и преимущества",
      text: `Тентовый ангар 20×35 м можно использовать в качестве ремонтного бокса, гаража, крытой автостоянки, складского помещения, производственного цеха.
Прочное покрытие герметично и не подвержено гниению; специальные добавки делают полотно пожаробезопасным.
Каркас и крепёжные элементы устойчивы к коррозии: используются анодированный алюминий и оцинкованная сталь.`,
    },
    {
      title: "Особенности монтажа",
      text: `Заливка фундамента не требуется — установка на любую ровную поверхность.
Для монтажа/демонтажа не нужна спецтехника — работы проводятся в минимальные сроки без потери качества, любое количество раз.
Обязательное надёжное крепление каркаса к поверхности; рекомендуется утяжеление бетонными блоками.`,
    },
    {
      title: "Дополнительные опции",
      text: `Конструкция полностью укомплектована; возможен заказ дополнительных опций — монтаж напольного покрытия, установка мебели, систем водопровода и кондиционирования и др.
Компания гарантирует высокое качество и доступную цену тентового ангара 20×35 м от производителя.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 20×35
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 20×35" },
    ...
    { label: "Вес конструкции", value: "10500 кг" },
