...
const tentSequences = [
  {
    basePath: "/10x40_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "15x35 м" },
    { label: "Площадь:", value: "525 м²" },
    { label: "Форма:", value: "Прямоугольник" },
    { label: "Вместимость:", value: "201 человек" },
    { label: "Ширина:", value: "15м" },
    { label: "Длина:", value: "35м" },
...
const thumbnails = [
  { id: 1, src: "/10x30,1.webp", alt: "Product 1" },
  { id: 2, src: "/10x30,2.webp", alt: "Product 2" },
  { id: 3, src: "/10x30,4.webp", alt: "Product 3" },
  ...
  // Use price configurations from Bitrix API or defaults
  ...
  // Find the active configuration (the one with isActive: true)
  const activeConfigFromBitrix = useMemo(() => {
    return configOptions.find(option => option.isActive) || configOptions[0];
  }, [configOptions]);

  // ✅ States for config interaction - initialize with Bitrix active config
  ...
  const handleConfigClick = (configName: string) => {
    ...
    // Update prices based on selected configuration
  ...
  // Use contacts from Bitrix API or defaults
  ...
  <div className="flex items-start gap-3">
    <div className="flex items-center gap-3">
      ...
      <div className="flex items-center gap-1.5">
        ...
        {/* REMOVE THE CONDITION - ALWAYS SHOW THE BADGE */}
        <Badge className="px-2 py-1 rounded-lg bg-[linear-gradient(180deg,rgba(255,115,115,1)_0%,rgba(255,111,111,1)_37%,rgba(236,60,60,1)_100%)]">
          ...
          <div className="absolute top-[5px] left-[750px] z-10">
            <div className="font-normal text-[#394355] text-base leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0] mb-4">
              ...
              <span className="font-semibold underline">204</span>
            </div>
...
{/* In the mobile version price section */}
        ...
        <CardContent className="flex flex-col items-start gap-4 p-2">
          ...
          <div className="flex flex-col items-start gap-4 w-full pl-4">
            <div className="flex items-center gap-4">
              ...
              <a href={contacts?.whatsapp || "https://api.whatsapp.com/send/?phone=79805109568"} target="_blank" rel="noopener noreferrer" className="block">
                <Image
                  src="/group-1.webp"
                  alt="WhatsApp icon"
                  width={24}
