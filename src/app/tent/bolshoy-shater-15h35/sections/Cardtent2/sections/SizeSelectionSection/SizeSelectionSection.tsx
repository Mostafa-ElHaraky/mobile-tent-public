...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your code (35×15 — 525 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Описание",
      text: `Классический прямоугольный шатёр 35×15 м — это универсальная каркасно-тентовая конструкция площадью 525 м². Подходит для мероприятий, выставок, складских задач и временных павильонов.`,
    },
    {
      title: "Характеристики и преимущества",
      text: `• Форма — прямоугольная, площадь — 525 м² (длина 35 м, ширина 15 м).
• Высота стены (опоры) — 2,5 / 3 / 3,5 / 4 м.
• Высота в коньке — макс. 7,5 м.
...
Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
  ...
  // Default specs from your code (35×15 — 525 м²)
