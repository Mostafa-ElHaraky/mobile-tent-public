...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Купольный шатёр Ø10 м (MOBILE TENT)
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Купольный шатёр, диаметр 10 м",
      text: `Особенность шатров сферической формы – минимум операций во время монтажа. В отдельных случаях установить павильон может сам заказчик по инструкции, в которой подробно изложены все этапы работ. Отметим, что нами решен вопрос утепления тента купола, что позволяет использовать конструкцию круглый год.`,
    },
  ];

  // TECH SPECS — Updated for Ø10 м
  const specs: { label: string; value: string }[] = [
    { label: "Форма", value: "Купольная (геодезический купол)" },
    { label: "Диаметр", value: "10 м" },
    { label: "Площадь", value: "около 78,5 м²" }, // π·5² ≈ 78.54 м²
    { label: "Вместимость", value: "зависит от рассадки и формата мероприятия" },
    { label: "Монтаж", value: "Минимум операций; возможна самостоятельная установка по инструкции" },
    { label: "Эксплуатация", value: "Круглогодичная при наличии утепления и вентиляции" },
  ];
