...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 25×25
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 25×25 — надёжное и универсальное решение",
      text: `Площадь ангара — 625 м², максимальная высота в коньке — 8,5 м, вес конструкции — 9 375 кг. Рассчитан на высокую ветровую и снеговую нагрузку (до 30 м/сек). Тентовое полотно — стойкий к влаге и гниению ПВХ-материал французского бренда DICKSON. Каркас — анодированный алюминий, крепления — оцинкованная сталь.`,
    },
    {
      title: "Применение",
      text: `Тентовый ангар 25×25 м может стать промышленным цехом, крытой автостоянкой, складским помещением. Установка обогрева и утепления значительно расширит сферу его применения.
Возможно увеличить площадь ангара в будущем, присоединив дополнительную конструкцию.
Не является капитальным сооружением.`,
    },
    {
      title: "Особенности монтажа",
      text: `Под конструкцию не нужен фундамент — достаточно крепления к поверхности и утяжеления каркаса бетонными блоками.
Монтаж выполняется без привлечения спецтехники.
Легко демонтируется в случае необходимости: возможна транспортировка и быстрая установка в другом месте.`,
    },
    {
      title: "Покупка у производителя",
      text: `Покупка тентового ангара напрямую у производителя — это выгодная цена, гарантия качества и сервисное обслуживание.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 25×25
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 25×25" },
    { label: "Форма", value: "Квадратная" },
    { label: "Площадь", value: "625 м²" },
    ...
    { label: "Вес конструкции", value: "9375 кг" },
