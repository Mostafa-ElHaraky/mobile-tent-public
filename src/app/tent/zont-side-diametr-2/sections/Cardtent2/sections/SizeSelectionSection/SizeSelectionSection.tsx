...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Side Ø2 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Side Ø2 м — компактная тень и комфорт",
      text: `Восьмиугольный зонт с боковой стойкой — практичное решение для летних веранд, уличных кафе, лаунж-зон и небольших площадок.
Диаметр 2 м обеспечивает локальную зону укрытия (≈ 3,14 м²), а свободная центральная зона удобна для расстановки мебели.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — восьмиугольная. Стойка расположена сбоку, что освобождает центр от опоры и повышает удобство использования пространства.
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Side Ø2 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Side Ø2 м" },
