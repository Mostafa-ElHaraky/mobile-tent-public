...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шестигранный шатёр Лондон (Диаметр 6 м)
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шестигранный шатёр Лондон (Диаметр 6 м) — практичное решение для мероприятий",
      text: `Шестигранный шатёр «Лондон» диаметром 6 метров — это практичное решение по проведению праздничных и спортивных мероприятий на природе. Конструкция быстро монтируется, не требует фундамента и создаёт комфортное, защищённое пространство для гостей и оборудования. Компания MOBILE TENT занимается сдачей в аренду и продажей каркасно-тентовых конструкций, проектируемых и изготавливаемых нами самостоятельно и при участии европейских партнёров.`,
    },
    {
      title: "Преимущества и состав конструкции",
      text: `Конструктивно шатёр состоит из трёх групп деталей:
• основного и дополнительного рамных профилей;
• элементов крепления;
• тентового покрытия.

Устанавливается на любой ровной площадке, без устройства фундамента. Конструкция быстро возводится и демонтируется. Возможна увеличиваемость площади путём соединения нескольких конструкций.`,
    },
    {
...
• Крепёжные элементы — оцинкованная сталь DIN 50976.`,
    },
    {
      ...
      text: `При самостоятельной установке соблюдайте последовательность по инструкции. Обязательны качественное крепление каркаса к поверхности либо утяжеление бетонными блоками — для устойчивости при ветровой нагрузке. Приобретайте или арендуйте шестигранный шатёр «Лондон» диаметром 6 м с доставкой и установкой.`,
    },
  ];

  // TECH SPECS — UPDATED for Шестигранный шатёр Лондон (Диаметр 6 м)
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шестигранный шатёр Лондон (Диаметр 6 м)" },
