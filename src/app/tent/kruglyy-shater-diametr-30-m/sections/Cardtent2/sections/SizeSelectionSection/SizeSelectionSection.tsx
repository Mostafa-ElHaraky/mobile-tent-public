...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Круглый шатёр Ø30 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Круглый шатёр, диаметр 30 м",
      text: `Большой круглый шатёр диаметром 30 м — это универсальная конструкция для проведения масштабных мероприятий. Благодаря сферической форме монтаж занимает минимум времени, а установка возможна как силами нашей команды, так и заказчика по подробной инструкции.

Конструкция может быть дополнительно утеплена, что позволяет использовать шатёр круглогодично.`,
    },
  ];

  // TECH SPECS — Updated for Ø30 м
  const specs: { label: string; value: string }[] = [
    { label: "Форма", value: "Круглая / сферическая" },
    { label: "Диаметр", value: "30 м" },
    { label: "Площадь", value: "около 706 м²" }, // π·15² ≈ 706 м²
    { label: "Монтаж", value: "Минимум операций, возможен самостоятельный по инструкции" },
    { label: "Эксплуатация", value: "Круглогодичная при утеплении купола" },
  ];
