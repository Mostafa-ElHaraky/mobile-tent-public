...
const PAGE_CODE = "arochnyy-shatyor-10h3-30-m2";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 180,
        name: "Арочный шатёр 10х3 — 30 м²",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный шатёр 10х3 — 30 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent",
        description: "Арочный шатёр 10х3 — 30 м² – купить в Москве под заказ в компании Mobile Tent. Длинный и узкий шатер, идеально подходящий для создания навесов над протяженными проходами, защиты торговых рядов, организации укрытий для автомобилей, автобусов или спецтехники, а также для линейных объектов на производстве. Удлиненная конструкция позволяет эффективно использовать пространство при ограниченной ширине. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.",
        keywords: "арочный шатёр 10х3, купить арочный шатер 10х3, шатер 10 на 3, арочный шатер 30м2, длинный шатер, узкий шатер, шатер для прохода, шатер для автомобиля, шатер для автобуса, тентовый шатер, быстровозводимый шатер, навес 10х3, шатер для спецтехники, шатер для производственных объектов",
        h1: "Арочный шатёр 10х3 — 30 м²",
        url: `/tent/arochnyy-shatyor-10h3-30-m2`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный шатёр 10х3 — 30 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Арочный шатёр 10х3 — 30 м² – купить в Москве под заказ в компании Mobile Tent. Длинный и узкий шатер, идеально подходящий для создания навесов над протяженными проходами, защиты торговых рядов, организации укрытий для автомобилей, автобусов или спецтехники, а также для линейных объектов на производстве. Удлиненная конструкция позволяет эффективно использовать пространство при ограниченной ширине. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "арочный шатёр 10х3, купить арочный шатер 10х3, шатер 10 на 3, арочный шатер 30м2, длинный шатер, узкий шатер, шатер для прохода, шатер для автомобиля, шатер для автобуса, тентовый шатер, быстровозводимый шатер, навес 10х3, шатер для спецтехники, шатер для производственных объектов";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Арочный шатёр 10х3 - 30 м² от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "image": "https://mobile-tent.ru/6x3,1.webp",
    "name": pageData.page?.name || "Арочный шатёр 10х3 — 30 м²",
    "description": pageData.seo?.description || "Арочный шатёр 10х3 — 30 м² – купить в Москве под заказ в компании Mobile Tent. Длинный и узкий шатер, идеально подходящий для создания навесов над протяженными проходами, защиты торговых рядов, организации укрытий для автомобилей, автобусов или спецтехники, а также для линейных объектов на производстве. Удлиненная конструкция позволяет эффективно использовать пространство при ограниченной ширине. Вы можете выбрать любую комплектацию, размер и цвет изделия.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-ARCH-10x3-30`,
    "brand": {
      "@type": "Brand",
      "name": "MOBILE TENT"
    },
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Назначение",
        "value": "Проходы, торговые ряды, навес для автомобилей и автобусов, укрытие для спецтехники, линейные производственные объекты, складские нужды, защита оборудования"
      }
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  // ----- FAQ SCHEMA (customized for арочный шатер 10х3) -----
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": `Какие размеры у арочного шатра 10х3?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Арочный шатер имеет ширину 10 метров, длину 3 метра, высоту в коньке до 4.5 метров. Полезная площадь — ${area} м². Это длинная и узкая конструкция, идеально подходящая для создания протяженных навесов, защиты длинных объектов или организации линейных проходов.`
        }
      },
      {
        "@type": "Question",
        "name": `Сколько стоит арочный шатер 10х3?`,
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Для каких целей подходит арочный шатер 10х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный шатер 10х3 идеально подходит для: навесов над протяженными проходами и пешеходными зонами, защиты длинных торговых рядов на рынках и ярмарках, укрытия для автомобилей, автобусов и спецтехники, линейных производственных объектов, защиты конвейерных линий, складских нужд для длинномерных материалов, организации въездных групп и коридоров."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку арочного шатра 10х3 в Москве?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 30 м² разрешение не требуется. Для установки на длительный срок или в общественных местах может потребоваться согласование. Мы помогаем с оформлением необходимых документов."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Гарантия от производителя — 5 лет на каркас и тент. Срок службы при правильной эксплуатации — более 15 лет. Алюминиевый каркас устойчив к коррозии, ПВХ ткань защищена от УФ-излучения. Для длинных конструкций предусмотрено дополнительное усиление."
        }
      },
      {
        "@type": "Question",
        "name": "Можно ли установить стены и двери в арочном шатре 10х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, возможна установка торцевых стен с дверями, окнами, воротами. Длинная и узкая конструкция позволяет эффективно организовать сквозной проход или закрытое помещение с воротами с двух сторон. Также доступны боковые стены, системы вентиляции, освещения и отопления. Возможно брендирование тента."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок изготовления арочного шатра 10х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стандартный срок изготовления арочного шатра 10х3 — от 4 до 8 рабочих дней. Для срочных заказов возможна ускоренная сборка за 1-3 дня."
        }
      },
      {
        "@type": "Question",
        "name": "Доставляете ли арочные шатры 10х3 в Московскую область?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, доставляем по всей Москве и Московской области: Красногорск, Химки, Мытищи, Люберцы, Подольск, Одинцово, Балашиха, Раменское, Домодедово, Королев, Пушкино, Сергиев Посад, Коломна, Электросталь, Жуковский, Дмитров, Солнечногорск, Истра, Наро-Фоминск, Чехов, Ступино, Серпухов и другие города. Длинная конструкция требует специальной транспортировки. Стоимость доставки — от 2500 рублей."
        }
      },
      {
        "@type": "Question",
        "name": "Подходит ли шатер 10х3 для защиты автобуса или спецтехники?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, арочный шатер 10х3 отлично подходит для защиты автобусов, микроавтобусов и спецтехники. Длина 10 метров позволяет разместить даже крупный автобус или грузовик, а ширина 3 метра обеспечивает достаточно места для комфортного доступа. Это идеальное решение для временного или постоянного укрытия техники на стоянках и в автопарках."
        }
      },
      {
        "@type": "Question",
        "name": "Можно ли соединять несколько шатров 10х3 для создания длинного тоннеля?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, несколько шатров 10х3 можно соединять в единую конструкцию для создания длинных тоннелей, галерей или крытых проходов. Это позволяет организовать защищенные маршруты любой протяженности для пешеходов, транспорта или производственных нужд. Мы предоставляем специальные соединительные элементы для надежной стыковки конструкций."
        }
      }
    ]
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный шатёр 10х3 — 30 м²"}
      </h1>
