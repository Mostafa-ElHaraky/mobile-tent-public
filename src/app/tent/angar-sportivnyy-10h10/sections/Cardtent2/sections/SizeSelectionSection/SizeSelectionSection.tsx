...
export const SizeSelectionSection = ({ 
  ...
  // Default content for SPORTS HANGAR 10x10 (100 m²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых ангаров и тентовых конструкций. Спортивный ангар 10×10 м (100 м²) — это оптимальное решение для организации тренировочных баз, спортивных залов, складов и временных сооружений.",
    },
    {
      title: "Особенности модели",
      text: "Ангар спортивный 10×10 м выполнен в арочной или прямостенной форме. Площадь 100 м² позволяет разместить мини-футбольное поле, баскетбольную площадку, тренажёрный зал или складской комплекс. Конструкция не требует капитального фундамента и монтируется за 1–3 дня.",
    },
    {
      title: "Практичность и применение",
      text: "Идеален для круглогодичного использования (с утеплением) или сезонных нужд. Подходит для: спортивных залов, фитнес-центров, складских помещений, производственных цехов, выставочных павильонов, укрытия техники и сельскохозяйственных нужд.",
    },
    {
      title: "Материалы",
      text: "Каркас из анодированного алюминия (сплав 6063) или усиленной стали с порошковым покрытием. Тентовое полотно — ПВХ 650-900 г/м² французского производства (Ferrari Precontraint / Dickson). Класс пожарной безопасности М2, Г1. Возможно остекление, утепление сэндвич-панелями.",
    },
    {
      title: "Монтаж и рекомендации",
      text: "Установка производится профессиональной бригадой с использованием автовышки или без спецтехники (для лёгких алюминиевых моделей). Демонтаж и повторный монтаж возможны без потери качества. Фундамент не требуется — достаточно ровной площадки (асфальт, бетон, грунт).",
    },
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких модулей 10×10 м. Можно комбинировать с другими типоразмерами: 10×5 м, 10×15 м, 10×20 м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // TECHNICAL SPECS for 10x10 sports hangar
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Арочная / Прямостенная" },
    { label: "Площадь", value: "100 м²" },
    { label: "Длина", value: "10 м (может быть увеличена модулями)" },
    { label: "Ширина (пролёт)", value: "10 м" },
    { label: "Высота стенки", value: "2,5 / 3 / 3,5 / 4 м (на выбор)" },
    { label: "Высота в коньке", value: "до 6,2 м" },
    { label: "Вес конструкции (алюминий)", value: "~550 кг" },
    { label: "Вес конструкции (сталь)", value: "~2500 кг" },
    ...
    { label: "Материал тента", value: "ПВХ 650-900 г/м² (Ferrari, Dickson), М2, Г1" },
    { label: "Фундамент", value: "Не требуется (установка на грунт, асфальт, бетон, блоки)" },
    { label: "Монтаж", value: "1–3 дня профессиональной бригадой" },
