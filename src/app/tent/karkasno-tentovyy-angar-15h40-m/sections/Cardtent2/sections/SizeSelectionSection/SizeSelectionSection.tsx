...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасно-тентовый ангар 15×40м (600 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасно-тентовых ангаров и тентовых конструкций. Каркасно-тентовый ангар 15×40м (600 м²) — это просторное прямоугольное сооружение для складов, производственных цехов, логистических центров, спортивных залов и сельскохозяйственных нужд.",
    },
    {
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 15×40м. Можно комбинировать с другими типоразмерами: 15×20м, 15×30м, 15×50м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame-tent hangar 15×40m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Вес металлоконструкции", value: "~3 200 кг" },
