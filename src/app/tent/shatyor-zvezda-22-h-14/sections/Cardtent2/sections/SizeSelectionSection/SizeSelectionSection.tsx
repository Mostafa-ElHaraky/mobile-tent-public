...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр Звезда 22×14
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр Звезда 22×14 — просторное решение для масштабных мероприятий",
...
• Материал купола: 500 D 100% полиэстер с пропиткой ПВХ.`,
  ...
  // TECH SPECS — UPDATED for Шатёр Звезда 22×14
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шатёр Звезда 22×14" },
    { label: "Форма", value: "Круг" },
    { label: "Площадь", value: "302,62 м²" },
    { label: "Длина", value: "21,85 м" },
    { label: "Ширина", value: "13,85 м" },
