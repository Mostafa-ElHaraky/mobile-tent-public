...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Standart Ø3 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Standart Ø3 м — оптимальная тень и комфорт",
...
Диаметр 3 м обеспечивает укрытие площадью около 7,065 м², а лаконичный дизайн легко вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Standart Ø3 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Standart Ø3 м" },
    { label: "Форма в плане", value: "Восьмиугольная" },
    { label: "Расположение стойки", value: "В центре" },
    { label: "Площадь", value: "7,065 м²" },
