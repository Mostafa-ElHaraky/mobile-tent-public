...
const PAGE_CODE = "arochnyy-angar-30h40-m";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 259,
        name: "Арочный ангар 20х40 (1200 м²) тип В",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный ангар 30х40 (1200 м²) – купить в Москве с доставкой по России | MOBILE TENT",
        description: "Арочный ангар 30х40 (1200 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для складов, производственных цехов, спортивных залов. Цена от 1 150 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords: "арочный ангар 30х40, ангар 30 на 40, купить ангар 30х40, тентовый ангар 30х40, быстровозводимый ангар, ангар для склада, ангар 1200 кв м, цена ангара 30х40",
        h1: "Арочный ангар 30х40 (1200 м²) – надежное решение для склада и производства",
        url: `/tent/arochnyy-angar-30h40-m`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный ангар 30х40 (1200 м²) – купить в Москве с доставкой по России | MOBILE TENT";
  const seoDescription = data.seo?.description || "Арочный ангар 30х40 (1200 м²) от производителя MOBILE TENT. Алюминиевый каркас, ПВХ тент 900 г/м². Для складов, производственных цехов, спортивных залов. Цена от 1 150 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const seoKeywords = data.seo?.keywords || "арочный ангар 30х40, ангар 30 на 40, купить ангар 30х40, тентовый ангар 30х40, быстровозводимый ангар, ангар 1200 кв м";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://mobile-tent.ru/B_25x50_1.webp',
          width: 1200,
          height: 630,
          alt: 'Арочный ангар 30х40 (1200 м²) от MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "MOBILE TENT",
    "image": "https://mobile-tent.ru/B_25x50_1.webp",
    ...
    "description": "Производство и продажа арочных ангаров 30х40, тентовых конструкций и быстровозводимых сооружений в Москве, Московской области и всей России. Собственное производство, гарантия 5 лет.",
  ...
  const productSchema = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Комплектации арочного ангара 30х40",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": pageData.page?.name || "Арочный ангар 30х40 (1200 м²)",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры у арочного ангара 30х40?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный ангар 30х40 имеет ширину 30 метров, длину 40 метров, высоту в коньке до 10.2 метров. Полезная площадь — 1200 м². Это оптимальный размер для складов, производственных цехов, спортивных залов и выставочных павильонов."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит арочный ангар 30х40 под ключ?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар 30х40 как производственный цех круглый год?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, при выборе утепленной комплектации (сэндвич-панели или утепленный тент) и установке системы отопления, ангар 30х40 можно использовать круглогодично при температурах до -40°C. Мы предлагаем опции: газовые/электрические тепловые пушки, инфракрасные обогреватели, системы вентиляции."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку ангара 30х40 в Москве или области?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для некапитальных сооружений площадью до 1500 м² разрешение на строительство не требуется. Наш ангар 1200 м² попадает в эту категорию. Наши юристы помогают с оформлением всех необходимых документов."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок службы и гарантия на арочный ангар 30х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Требуется ли фундамент для ангара 30х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить в ангаре 30х40 стены, двери, ворота, окна?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления и доставки ангара 30х40?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Доставляете ли ангары 30х40 в регионы России?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "В чем отличие арочного ангара 30х40 от каркасного?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const videoSchema = {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "name": "Как устанавливается арочный ангар 30х40 | MOBILE TENT",
    "description": "Видео-инструкция по монтажу арочного ангара 30х40 (1200 м²). Быстровозводимая конструкция для складов и производства.",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный ангар 30х40 (1200 м²) – купить по цене от 1 150 000 ₽ с доставкой по России"}
      </h1>
