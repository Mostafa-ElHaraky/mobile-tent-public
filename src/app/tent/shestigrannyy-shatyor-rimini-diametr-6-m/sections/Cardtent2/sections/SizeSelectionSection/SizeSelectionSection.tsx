...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шестигранный шатёр Римини (Диаметр 6 м)
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title:
        "Шестигранный шатёр Римини (Диаметр 6 м) — компактное решение для мероприятий",
      text: `Шестигранный шатёр «Римини» диаметром 6 метров — это небольшой мобильный тент, который удобно использовать во время проведения спортивных соревнований, детских праздников, культурных мероприятий или семейного отдыха на даче. Шатёр практичный и многофункциональный: он защищает от жарких солнечных лучей, небольшого ветра и дождя, помогая не прерывать программу мероприятия.`,
    },
    {
      title: "Наши услуги",
      text: `• проектирование тентов;
• изготовление каркасно-тентовых конструкций;
• предоставление мобильных шатров любого размера в аренду.
Наши цены Вас приятно удивят, а качество оставит только лучшие впечатления о сотрудничестве.`,
    },
    {
      title: "Преимущества и эксплуатация",
      text: `• Рекомендовано к использованию в тёплое время года.
• Тент защищает от небольшого ветра и летнего дождя.
• При необходимости возможно увеличение площади путём соединения нескольких конструкций.`,
    },
    {
...
• Крепёжные элементы — оцинкованная сталь DIN 50976.`,
    },
    {
      ...
      text: `• Не требует специального фундамента; установка на любой земляной поверхности.
• Монтируется и демонтируется без спецтехники в минимальный срок, без потери качества, многократно.
• Обязательное крепление к основанию или утяжеление бетонными блоками.
• После установки необходимо проверить все крепления — они должны быть надёжно зафиксированы для устойчивости при порывах ветра.
• По запросу наши специалисты выполнят доставку и установку шатра на выбранной площадке.`,
    },
  ];

  // TECH SPECS — UPDATED for Шестигранный шатёр Римини (Диаметр 6 м)
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шестигранный шатёр Римини (Диаметр 6 м)" },
