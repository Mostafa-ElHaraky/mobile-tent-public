...
const PAGE_CODE = "shatyor-pagoda-london-8h8";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    // Fallback data for Pagoda tent London 8×8 m
    return {
      success: false,
      page: {
        id: 273,
        name: "Шатёр Пагода Лондон 8×8 м (64 м²)",
        code: PAGE_CODE,
      },
      seo: {
        title: "Шатёр Пагода Лондон 8×8 м (64 м²) – купить премиальный пагодный шатер в Москве | MOBILE TENT",
        description:
          "Шатёр Пагода Лондон 8×8 метров (площадь 64 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция в британском стиле для крупных банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 290 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.",
        keywords:
          "шатер пагода лондон 8х8, пагода лондон 8х8, шатер лондон 8 на 8, пагодный шатер премиум 8х8, шатер для банкета 8х8, шатер для свадьбы, шатер лондон тип",
        h1: "Шатёр Пагода Лондон 8×8 м – британская элегантность для крупных мероприятий",
        url: `/tent/${PAGE_CODE}`,
      },
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = data.seo?.title || "Шатёр Пагода Лондон 8×8 м (64 м²) – купить премиальный пагодный шатер в Москве | MOBILE TENT";
  const description =
    data.seo?.description ||
    "Шатёр Пагода Лондон 8×8 метров (площадь 64 м²) с острой крышей от производителя MOBILE TENT. Премиальная пагодная конструкция в британском стиле для крупных банкетов, выставок, свадеб, ресторанов. Алюминиевый каркас, ПВХ тент 650 г/м². Цена от 290 000 ₽. Гарантия 5 лет. Доставка по Москве, МО и всей России.";
  const keywords =
    data.seo?.keywords ||
    "шатер пагода лондон 8х8, пагода лондон 8х8, шатер лондон 8 на 8, пагодный шатер премиум 8х8";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Шатёр Пагода Лондон 8×8 метров с острой крышей",
        },
      ],
    },
    robots: {
...
export default async function PagodaLondon8x8Page() {
  ...
  const prices = pageData.priceConfigurations?.map((c) => c.currentPrice) || [290000, 420000, 590000];
  ...
  const productSchema = {
    ...
    "@type": "Product",
    image: "https://mobile-tent.ru/pagda1.webp",
    name: pageData.page?.name || "Шатёр Пагода Лондон 8×8 м (64 м²)",
    description:
      pageData.seo?.description ||
      "Шатёр Пагода Лондон 8×8 метров – премиальная пагодная конструкция в британском стиле с острой крышей для крупных банкетов, выставок, свадеб, ресторанов. Элегантный дизайн, площадь 64 м², высота в коньке 8.5 м. Алюминиевый каркас, ПВХ тент 650 г/м², ветроустойчивость до 80 км/ч.",
    sku: `MOB-${PAGE_CODE}`,
    mpn: `MOB-PAGODA-LONDON-8x8`,
    ...
    additionalProperty: [
      ...
      { "@type": "PropertyValue", name: "Срок изготовления", value: "от 14 до 21 рабочего дня" },
      { "@type": "PropertyValue", name: "Гарантия", value: "5 лет на каркас и тент" },
    ],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Комплектации пагодного шатра Лондон 8×8 м",
      itemListElement:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: pageData.page?.name || "Шатёр Пагода Лондон 8×8 м",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Чем отличается шатёр Пагода Лондон 8×8 м от стандартной пагоды?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Какую площадь имеет шатёр Пагода Лондон 8×8 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Сколько стоит шатёр Пагода Лондон 8×8 м под ключ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Цена от ${prices[0]?.toLocaleString() || "290 000"} ₽ за базовую комплектацию Лондон, премиум версия – от ${prices[1]?.toLocaleString() || "420 000"} ₽, эксклюзивная – от ${prices[2]?.toLocaleString() || "590 000"} ₽. Включает каркас, тент, боковые стенки, дверь. Доставка рассчитывается отдельно.`,
        },
      },
      {
        "@type": "Question",
        name: "Нужен ли фундамент для шатра Пагода Лондон 8×8 м?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Можно ли использовать шатёр Пагода Лондон 8×8 м зимой?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Доставляете ли шатры Пагода Лондон 8×8 м в регионы России?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Для каких целей лучше всего подходит шатёр Пагода Лондон 8×8 м?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Идеален для: крупных свадеб и банкетов, корпоративных мероприятий, выставочных павильонов, конференц-залов, ресторанных веранд, фотостудий, лаунж-зон на фестивалях, временных торговых центров.",
        },
      },
    ],
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">{pageData.seo?.h1 || "Шатёр Пагода Лондон 8×8 м – британская элегантность для крупных мероприятий"}</h1>
