...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт для кафе Tiger Ø4 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт для кафе Tiger Ø4 м — 12,56 м² тени и комфорта",
      text: `Восьмиугольный зонтовый навес с центральной стойкой — практичное решение для летних веранд, уличных кафе, зон ожидания и площадок отдыха. 
Диаметр 4 м обеспечивает около 12,56 м² полезной площади укрытия, а аккуратная геометрия органично вписывается в любой экстерьер.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт для кафе Tiger Ø4 м
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт для кафе Tiger Ø4 м" },
