...
const PAGE_CODE = "arochnyy-shatyor-8h3-24-m2";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 176,
        name: "Арочный шатёр 8х3 — 24 м²",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный шатёр 8х3 — 24 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent",
        description: "Арочный шатёр 8х3 — 24 м² – купить в Москве под заказ в компании Mobile Tent. Узкий и длинный шатер, идеально подходящий для создания навесов над проходами, защиты торговых рядов, укрытия для автомобиля или организации линейных объектов. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.",
        keywords: "арочный шатёр 8х3, купить арочный шатер 8х3, шатер 8 на 3, арочный шатер 24м2, узкий шатер, длинный шатер, шатер для прохода, шатер для автомобиля, тентовый шатер, быстровозводимый шатер, навес 8х3, шатер для торговых рядов",
        h1: "Арочный шатёр 8х3 — 24 м²",
        url: `/tent/arochnyy-shatyor-8h3-24-m2`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный шатёр 8х3 — 24 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Арочный шатёр 8х3 — 24 м² – купить в Москве под заказ в компании Mobile Tent. Узкий и длинный шатер, идеально подходящий для создания навесов над проходами, защиты торговых рядов, укрытия для автомобиля или организации линейных объектов. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "арочный шатёр 8х3, купить арочный шатер 8х3, шатер 8 на 3, арочный шатер 24м2, узкий шатер, длинный шатер, шатер для прохода, шатер для автомобиля, тентовый шатер, быстровозводимый шатер, навес 8х3, шатер для торговых рядов";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Арочный шатёр 8х3 - 24 м² от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const productSchema = {
    ...
    "name": pageData.page?.name || "Арочный шатёр 8х3 — 24 м²",
    "description": pageData.seo?.description || "Арочный шатёр 8х3 — 24 м² – купить в Москве под заказ в компании Mobile Tent. Узкий и длинный шатер, идеально подходящий для создания навесов над проходами, защиты торговых рядов, укрытия для автомобиля или организации линейных объектов. Вы можете выбрать любую комплектацию, размер и цвет изделия.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-ARCH-8x3-24`,
    "brand": {
      "@type": "Brand",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Назначение",
        "value": "Проходы, торговые ряды, навес для автомобиля, складские нужды, защита оборудования, линейные объекты"
      }
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  // ----- FAQ SCHEMA (customized for арочный шатер 8х3) -----
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": `Какие размеры у арочного шатра 8х3?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Арочный шатер имеет ширину 8 метров, длину 3 метра, высоту в коньке до 4.5 метров. Полезная площадь — ${area} м². Это узкая и длинная конструкция, идеально подходящая для создания навесов над проходами, защиты торговых рядов или укрытия для автомобиля.`
        }
      },
      {
        "@type": "Question",
        "name": `Сколько стоит арочный шатер 8х3?`,
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Для каких целей подходит арочный шатер 8х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный шатер 8х3 идеально подходит для: навесов над проходами и пешеходными зонами, защиты торговых рядов и прилавков на рынках, укрытия для автомобиля или техники, складских нужд, линейных объектов производственных предприятий, защиты оборудования на открытых площадках, временных коридоров и переходов, организации въездных групп."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку арочного шатра 8х3 в Москве?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 24 м² разрешение не требуется. Для установки на длительный срок или в общественных местах может потребоваться согласование. Мы помогаем с оформлением необходимых документов."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить стены и двери в арочном шатре 8х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, возможна установка торцевых стен с дверями, окнами, воротами. Узкая и длинная конструкция позволяет эффективно организовать сквозной проход или закрытое помещение с двумя входами. Также доступны боковые стены, системы вентиляции, освещения и отопления. Возможно брендирование тента."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок изготовления арочного шатра 8х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стандартный срок изготовления арочного шатра 8х3 — от 3 до 7 рабочих дней. Для срочных заказов возможна ускоренная сборка за 1-2 дня."
        }
      },
      {
        "@type": "Question",
        "name": "Доставляете ли арочные шатры 8х3 в Московскую область?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, доставляем по всей Москве и Московской области: Красногорск, Химки, Мытищи, Люберцы, Подольск, Одинцово, Балашиха, Раменское, Домодедово, Королев, Пушкино, Сергиев Посад, Коломна, Электросталь, Жуковский, Дмитров, Солнечногорск, Истра, Наро-Фоминск, Чехов, Ступино, Серпухов и другие города. Узкая конструкция удобна для транспортировки и установки в ограниченном пространстве. Стоимость доставки — от 2000 рублей."
        }
      },
      {
        "@type": "Question",
        "name": "Подходит ли шатер 8х3 для защиты автомобиля?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, арочный шатер 8х3 отлично подходит для защиты автомобиля. Длина 8 метров позволяет разместить даже крупный внедорожник или микроавтобус, а ширина 3 метра обеспечивает достаточно места для комфортного открывания дверей. Это идеальное решение для временного или постоянного укрытия автомобиля."
        }
      }
    ]
  };
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный шатёр 8х3 — 24 м²"}
      </h1>
