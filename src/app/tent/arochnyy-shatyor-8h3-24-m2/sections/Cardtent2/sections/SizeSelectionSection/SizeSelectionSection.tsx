...
export const SizeSelectionSection = ({ 
  ...
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      ...
      text: "Арочный шатёр площадью 24 м² имеет вид туннеля, длина стороны которого составляет 8 м.",
    },
    {
      title: "Назначение",
      text: "Модуль может служить вспомогательным элементом для арочной конструкции или выполнять функции навеса при проведении различных мероприятий.",
    },
    {
      title: "Материалы и установка",
      text: "Установка изделия не требует фундамента. Оцинкованные элементы каркаса обеспечивают шатру устойчивость и прочность. Тентовое полотно французского производства из ПВХ (Ferrari Precontraint) обладает хорошей эластичностью. Его можно использовать для нанесения любого изображения или логотипа компании.",
    },
  ];

  // Default specs from your original code
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота в коньке", value: "3,65 м" },
    ...
    },
    {
      ...
      value: "Тентовое полотно и стены изготовлены из ПВХ французского производства Ferrari Precontraint. Класс пожарной безопасности М2, Г1.",
    },
    {
      label: "Каркас",
