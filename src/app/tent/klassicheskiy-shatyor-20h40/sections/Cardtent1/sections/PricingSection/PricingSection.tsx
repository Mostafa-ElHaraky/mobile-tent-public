...
const tentSequences = [
  ...
  const specifications = [
    ...
    { label: "Вместимость:", value: "356 человек" },
...
const thumbnails = [
  { id: 1, src: "/20x40,1.webp", alt: "Product 1" },
  { id: 2, src: "/20x40,2.webp", alt: "Product 2" },
  { id: 3, src: "/20x40,3.webp", alt: "Product 3" },
