...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт уличный для кафе Premium 3×3
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт уличный для кафе Premium 3×3 — компактная тень и комфорт",
      text: `Квадратный зонт с центральной стойкой для летних веранд, уличных кафе и лаунж-зон.
Размер 3×3 м обеспечивает зону укрытия около 9 м², а лаконичный дизайн легко вписывается в любой экстерьер.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — квадратная. Стойка расположена по центру для равномерного распределения нагрузки.
Все элементы каркаса конструкции изготовлены из стали высокого качества.
Крепёжные элементы — оцинкованная сталь для защиты от коррозии.`,
    },
  ];

  // TECH SPECS — UPDATED for Зонт уличный для кафе Premium 3×3
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт уличный для кафе Premium 3×3" },
