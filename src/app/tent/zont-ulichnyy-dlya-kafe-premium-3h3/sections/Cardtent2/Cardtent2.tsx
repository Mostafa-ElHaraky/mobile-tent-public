...
// ⬇️ NEW: import products (only used to filter Арочные (Шатры))
...
export const Cardtent2 = (): ReactElement => {
  ...
  const contactInfo = [
    ...
    { icon: "/group-9.webp", text: "8 (800) 302-46-31" },
  ];
  ...
  // ⬇️ NEW: data for "Этот шатер в других размерах" (only Зонт)
  const otherSizes: Product[] = allProducts.filter((p) => p.type === 'Зонт');

  // ⬇️ NEW: desktop horizontal scroller for "other sizes"
  ...
  // ⬇️ NEW: mobile index for "other sizes"
    ...
    <>
      ...
      <div className="hidden md:block relative w-full max-w-[1440px] mx-auto bg-white">
        ...
        <div className="flex flex-col w-full">
          ...
          {/* ⬇️ NEW: "Этот шатер в других размерах" — DESKTOP */}
      ...
      <div className="block md:hidden w-full bg-white ">
        ...
        {/* ⬇️ NEW: "Этот шатер в других размерах" — MOBILE */}
        <div className="w-full mt-12 px-4">
          <h2 className="font-semibold text-[#394355] text-2xl text-center mb-6 [font-family:'Raleway',Helvetica]">
            Этот ангар в других размерах
          </h2>
