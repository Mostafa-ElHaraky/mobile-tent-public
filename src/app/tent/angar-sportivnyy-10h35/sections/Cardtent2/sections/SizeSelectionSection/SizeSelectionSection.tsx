...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Ангар спортивный 10×35 (350 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Ангар спортивный 10х35",
      text: "Тентовый ангар 10×35 м — практичное решение для малого и среднего бизнеса. Быстрые сроки возведения, бюджетная цена и длительный срок службы делают конструкцию выгодной на этапе развития. Ангар подходит для круглогодичной эксплуатации и остаётся в собственности предприятия.",
    },
    {
      title: "Преимущества и применение",
      text: "Возможно многоцелевое использование — в качестве крытого торгового комплекса, склада, производственного помещения или спортивного павильона. Преимущества: быстрый монтаж, доступная стоимость, длительный срок эксплуатации и работа круглый год. Возможны типовые проекты и изготовление по индивидуальному заказу.",
    },
    {
      title: "Практичность и монтаж",
      text: "Не требует специального фундамента — установка возможна на любую земляную или асфальтовую поверхность. Монтируется и демонтируется без применения спецтехники в минимальные сроки, многократно, без потери качества. Возможна модульная стыковка нескольких конструкций для увеличения площади. Особенности монтажа: обязательное крепление к основанию или утяжеление бетонными блоками. Поставка — в комплектации, полностью готовой к монтажу.",
    },
    {
      title: "Материалы тента",
      text: "Тентовое полотно и стены изготовлены из ПВХ материала французского производства DICKSON с системой LoWick. Класс пожарной безопасности — М2, Г1. Тентовое покрытие — сертифицированное ПВХ-полотно с добавками, препятствующими горению (DIN 4102 B1, M2), прочность 0,3 кН/м², устойчиво к гниению и не промокает.",
    },
    {
      title: "Каркас и крепёж",
      text: "Все элементы каркаса изготовлены из анодированного алюминия (сплав 6063 DIN 573), сертификат QUALANOD. Крепёжные элементы — оцинкованная сталь по DIN 50976. Конструкция рассчитана на ветровую нагрузку до 30 м/сек; допускается нагрузка подвеса на арку до 30 кг/п.м.",
    },
    {
      title: "Эксплуатация",
      text: "Скруглённая форма ангара предотвращает скопление снега. При сильном снегопаде конструкция не страдает, ПВХ не портится от осадков. После установки ангар можно быстро демонтировать и перевезти на новое место.",
    },
  ];

  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Прямоугольная / Арочная" },
    { label: "Площадь", value: "350 м²" },
    { label: "Длина", value: "35 м (регулируется)" },
    { label: "Ширина (пролёт)", value: "10 м" },
    ...
    { label: "Вес конструкции", value: "1 925 кг (алюминий)" },
    ...
    { label: "Монтаж", value: "Быстрый, без спецтехники (для алюминия), многократный" },
    ...
    { label: "Модульность", value: "Возможна стыковка нескольких ангаров 10×N" },
