...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шестигранный шатёр Римини (Диаметр 10 м)
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title:
        "Шестигранный шатёр Римини (Диаметр 10 м) — универсальное решение для мероприятий",
      text: `Компания предлагает приобрести каркасно-тентовые конструкции по ценам производителя. Купив или взяв шестигранный шатёр «Римини» диаметром 10 м в аренду, можно не переживать за выбор комфортного места проведения мероприятия.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `• Шестигранный шатёр «Римини» диаметром 10 м предназначен для организации праздничных событий или торговли.
• Белый цвет и изящная форма конструкции делают его универсальным.
• Широкий вход и световые проёмы по всему периметру гарантируют хорошее освещение внутри.
• Простой монтаж/демонтаж, конструкцию удобно складывать и перевозить.

Технические параметры:
  — длина и ширина конструкции одинаковы — по 10 м; площадь шатра составляет 78 м², этого пространства достаточно для большого количества гостей и установки мебели;
  — максимальная высота в коньке — 7,5 м, конструкция весит 431 кг;
  — тентовое покрытие из ПВХ-полотна прошло обработку; специальная пропитка противостоит горению и гниению, не пропускает атмосферные осадки.`,
    },
    {
...
• Крепёжные элементы — оцинкованная сталь DIN 50976.`,
    },
    {
      ...
      text: `• Шестигранный шатёр «Римини» диаметром 10 м устанавливается на любой ровной земляной или асфальтовой поверхности.
• Фундамент не требуется; достаточно крепления каркаса к основанию или утяжеления бетонными блоками.
• Для удобства гостей дополнительно укладывается деревянный пол или ковролин.
• Спецтехника для монтажа не требуется.`,
    },
  ];

  // TECH SPECS — UPDATED for Шестигранный шатёр Римини (Диаметр 10 м)
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шестигранный шатёр Римини (Диаметр 10 м)" },
    ...
    { label: "Вес конструкции", value: "431 кг" },
