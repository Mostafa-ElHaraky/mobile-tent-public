...
const tentSequences = [
  {
    basePath: "/quadro_walls/CLASSIK_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    { label: "Размер:", value: "16x16 м" },
    { label: "Площадь:", value: "256 м²" },
    { label: "Форма:", value: "Квадрат" },
    { label: "Вместимость:", value: "170 человек" },
    { label: "Длина:", value: "16м" },
    { label: "Ширина:", value: "16м" },
    { label: "Высота входной арки:", value: "6м" },
    { label: "Высота в коньке:", value: "16м" },
  ...
  const thumbnails = [
  { id: 1, src: "/12x12,1.webp", alt: "Product 1" },
  { id: 2, src: "/12x12,2.webp", alt: "Product 2" },
  { id: 3, src: "/shatyor20x20.webp", alt: "Product 3" },
  ...
  const performDownloadKP = async () => {
    ...
    const productImage = thumbnails[0]?.src || "/12x12,1.webp";
        ...
        <section className="flex flex-col gap-[35px] py-6 px-12 relative top-[400px]">
          <div className="flex flex-col w-full max-w-[658px]">
            <div className="font-medium text-[#394355] text-4xl [font-family:'Raleway',Helvetica] tracking-[0]">
              {pageName || "Арочный шатёр 16х16 — 256 м² (B)"}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="absolute top-[5px] left-[750px] z-10">
              <div className="font-normal text-[#394355] text-base leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0] mb-4">
                ...
                <span className="font-semibold underline">187</span>
              </div>
              ...
              <div className="w-[660px] h-[660px] rounded-[20px] overflow-hidden relative z-10">
                {selectedMode === "3d" ? (
                  ...
                  <Image
                    ...
                    alt="Арочный шатёр 16х16 — 256 м² (B)"
                    width={1280}
                    height={720}
