...
export const SizeSelectionSection = ({ 
  ...
  // Default content from your original code (16×16 — 256 м² variant with different heights)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Описание",
      text: `Привлекательный и вместительный арочный шатёр размером 16×16 м и площадью 256 м² можно недорого арендовать для проведения свадьбы или банкета, организации конференций и выставок. При необходимости постоянного использования конструкции рекомендуем купить её по вполне приемлемой цене.`,
    },
    {
      title: "Особенности шатра",
      text: `Модуль оснащён выполненным из оцинкованной стали мощным каркасом, установить который достаточно просто на любой ровной поверхности. Для стенок и крыши шатра использован пожаробезопасный ПВХ, отлично защищающий от промокания и продувания ветром.

Для создания праздничного настроения возможно декоративное оформление тента или размещение на нём рекламных изображений.`,
    },
  ];

  // Default specs from your original code (16×16 — 256 м² variant with different heights)
  const defaultSpecs: { label: string; value: string }[] = [
    { label: "Форма", value: "Квадрат" },
    { label: "Площадь", value: "256 м²" },
    { label: "Длина", value: "16 м" },
    { label: "Ширина", value: "16 м" },
    { label: "Высота входной арки", value: "6,2 м" },
    { label: "Высота в коньке", value: "6,2 м" },
    { label: "Вес конструкции", value: "3100 кг" },
    { label: "Нагрузка на опорную пятку", value: "387 кг" },
    { label: "Ветровая нагрузка", value: "24 м/сек" },
    { label: "Нагрузка подвеса на арку", value: "до 40 кг/п.м." },
    {
      label: "Основание",
