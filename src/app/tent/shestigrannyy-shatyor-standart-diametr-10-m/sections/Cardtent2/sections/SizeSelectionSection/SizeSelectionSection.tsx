...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шестигранный шатёр Стандарт (Диаметр 10 м)
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title:
        "Шестигранный шатёр Стандарт (Диаметр 10 м) — красивое и удобное решение",
      text: `Праздник на природе можно провести роскошно, так как каркасно-тентовая конструкция надёжно защитит гостей вашего мероприятия от непогоды. Шестигранный шатёр «Стандарт» диаметром 10 м подойдёт под любой формат события. Производитель позаботился не только об удобстве каркасно-тентовой конструкции, но и её долговечности. Купить или взять в аренду шатёр можно без посредников по цене завода-изготовителя.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `• По всему периметру шатра имеются оконные проёмы. 
• Конусообразная форма купола даёт эстетический эффект и препятствует скоплению осадков.
• Конструкция мобильна; возможен многоразовый монтаж и разборка.
• Шестигранный шатёр «Стандарт» 10 м удобно транспортируется в сложенном виде.`,
    },
    {
      title: "Технические параметры (кратко)",
      text: `• Площадь — 78 м²; длина и ширина — по 10 м; максимальная высота в коньке — 7,5 м.
...
• Монтаж и демонтаж выполняются без спецтехники, в минимальные сроки и без потери качества.
...
• Многократные циклы сборки/разборки практически не влияют на внешний вид; удобно перевозить в сложенном виде.`,
  ...
  // TECH SPECS — UPDATED for Шестигранный шатёр Стандарт (Диаметр 10 м)
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шестигранный шатёр Стандарт (Диаметр 10 м)" },
