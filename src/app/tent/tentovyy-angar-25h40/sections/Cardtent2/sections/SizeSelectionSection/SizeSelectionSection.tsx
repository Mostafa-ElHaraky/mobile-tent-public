...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 25×40
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 25×40 — 1 000 м² полезной площади",
      text: `Тентовый ангар 25×40 м — это целая 1 000 м² полезной площади, которую можно приспособить под:

• производственные мощности;  
• складские помещения;  
• хранилище запасных частей и техники;  
• проведение спортивно-массовых мероприятий.`,
    },
    {
      title: "Особенности монтажа",
      text: `Сначала на ровной площадке устанавливается стальной каркас, на который натягивается тент.  
Конструкция надёжно прикрепляется к основанию для защиты от сильного ветра.  
Тентовый ангар 25×40 выдерживает ветровую нагрузку до 30 м/сек.`,
    },
    {
      title: "О компании",
...
• изготовлением;  
• продажей;  
• сдачей в аренду каркасно-тентовых конструкций различной площади и объёма.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 25×40
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 25×40" },
    ...
    { label: "Вес конструкции", value: "15 000 кг" },
