...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Шатры Пагода с острой крышей Стандарт 5×5 м (25 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых пагодных шатров и тентовых конструкций. Шатры Пагода с острой крышей Стандарт 5×5 м (25 м²) — это компактное и элегантное решение для малого бизнеса, торговли, выездных мероприятий и летних кафе. Острая крыша придаёт конструкции стильный внешний вид.",
    },
    {
      title: "Особенности модели",
      text: "Пагодный шатер Стандарт 5×5 выполнен в форме квадрата с характерной острой крышей. Площадь 25 м² позволяет комфортно разместить до 8-10 гостей за столами или до 12-15 человек на фуршет. Конструкция не требует капитального фундамента, монтируется за 1–2 часа. Благодаря утеплённой версии шатер можно использовать в межсезонье.",
    },
    {
      title: "Практичность и применение",
      text: "Шатер Пагода 5×5 м идеально подходит для: торговых точек на рынках и ярмарках, летних кафе и кофеен, выездных регистраций свадеб, фотозон, выставочных стендов, лаунж-зон на фестивалях, временных складов.",
    },
    {
      title: "Материалы",
    ...
    },
    {
      ...
      text: "Возможность соединения нескольких пагод в единый комплекс. Можно комбинировать с шатрами других размеров: Пагода 3×6 м, Пагода 4×4 м, Пагода 5×5 м и более.",
    },
  ];

  // Technical specifications for pagoda tent Standard 5×5 m
