...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Quatro 10×10
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Quatro 10×10 — 100 м² тени и комфорта",
...
Размер 10×10 м обеспечивает около 100 м² полезной площади укрытия.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Quatro 10×10
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Quatro 10×10" },
