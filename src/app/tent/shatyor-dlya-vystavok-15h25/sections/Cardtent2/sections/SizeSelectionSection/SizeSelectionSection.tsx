...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 15×25
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 15×25 м",
      text: `Шатёр для выставок 15×25 м — быстровозводимая тентовая система, установка которой актуальна при проведении выездных мероприятий. Выставка успешно пройдёт даже при неблагоприятных погодных условиях: закрытый навес защитит от дождя, порывов ветра и прямых солнечных лучей.

В компании вы можете приобрести или взять в аренду высококачественные мобильные конструкции для проведения любых мероприятий.

Мы предлагаем:
• проектирование и изготовление шатров и навесов;
• продажу и прокат шатровой продукции;
• техническое обслуживание и ремонт тентовых конструкций.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности или утяжеление конструкции бетонными блоками.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Все наши мобильные конструкции произведены из качественных материалов и отличаются презентабельным внешним видом. Каркас шатра размером 15×25 м из анодированного алюминия и элементы крепежа из оцинкованной стали придают особенную прочность конструкции.
Безопасность шатра обеспечивает использование сертифицированного материала ПВХ от производителя DICKSON: полотно не промокает, является огнестойким и пожароустойчивым.
Площадь шатра — 375 м². Высота опоры — 2,5 / 3 / 3,5 / 4 м. Ветровая нагрузка — до 30 м/сек. Вес конструкции — 2 062 кг.`,
    },
    {
      title: "Особенности монтажа",
      text: `Шатёр для выставок 15×25 м представляет собой прочное сооружение. Процесс монтажа не требует много времени: конструкция устанавливается на ровной поверхности и затем прочно укрепляется.
Компания предлагает мобильные конструкции разных цветов, форм и размеров для проведения выставок и мероприятий на открытом воздухе.`,
    },
  ];
  ...
  const specs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "2 062 кг" },
