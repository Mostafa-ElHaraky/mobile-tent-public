...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Классический шатёр 10х10
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Классический шатёр 10х10",
      text: `Данный вид шатра идеально подойдет для проведения мероприятий средней величины на открытом воздухе. Это оптимальный вариант для летних свадеб, различный презентаций, лекций или выставок — шатер вмещает в себя около 60-80 человек и позволяет не беспокоиться о любых погодных условиях.`,
    },
    {
      title: "Преимущества конструкции",
      text: `• Универсальность
• Возможность демонтировать и устанавливать в любых новых местах множество раз
• Простота перевозки (каркас изготовлен из прочного, но легкого алюминия)
• Высокий уровень комфорта
• Эстетичность
• Устойчивость (конструкция утяжеляется специальными бетонными блоками)`,
    },
    {
...
Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
  ...
  // TECH SPECS — UPDATED with new data for 10x10m tent
