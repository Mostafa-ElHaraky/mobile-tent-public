...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Куполообразный шатер Ø16 м
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Куполообразный шатер, диаметр 16 м",
      text: `Куполообразные шатры среднего размера подходят для проведения корпоративных мероприятий, свадеб, презентаций и культурных событий. Благодаря геодезической конструкции они обладают высокой прочностью и устойчивостью к погодным условиям. При необходимости шатер можно оснастить утеплением и инженерными системами для использования в любое время года.`,
    },
  ];

  // TECH SPECS — Updated for Ø16 м
  const specs: { label: string; value: string }[] = [
    { label: "Форма", value: "Куполообразная (геодезический купол)" },
    { label: "Диаметр", value: "16 м" },
    { label: "Площадь", value: "около 201 м²" }, // π·8² ≈ 201 м²
    { label: "Вместимость", value: "до 250 человек в зависимости от формата мероприятия" },
    { label: "Монтаж", value: "Быстрая сборка опытной бригадой; минимальное количество соединений" },
