...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр Звезда 16×10
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр Звезда 16×10 — просторное и эффектное решение для мероприятий",
      text: `Шатёр формата «Звезда» создаёт выразительное пространство для фестивалей, презентаций, фуршетов и частных событий. Конструкция быстро монтируется, не требует фундамента и обеспечивает защищённое пространство для гостей и оборудования.`,
    },
    {
...
• Все элементы каркаса конструкции изготовлены из анодированного алюминия.
• Крепёжные элементы: оцинкованная сталь DIN 50976.
• Материал купола: 500 D 100% полиэстер с пропиткой ПВХ.`,
    },
    {
      title: "Особенности монтажа",
      text: `• Обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
  ];

  // TECH SPECS — UPDATED for Шатёр Звезда 16×10
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Шатёр Звезда 16×10" },
    { label: "Форма", value: "Круг" },
    { label: "Площадь", value: "170,56 м²" },
    { label: "Длина", value: "16,40 м" },
    { label: "Ширина", value: "10,40 м" },
    { label: "Высота в коньке", value: "6 м" },
    { label: "Материал купола", value: "500 D 100% полиэстер с пропиткой ПВХ" },
  ];
