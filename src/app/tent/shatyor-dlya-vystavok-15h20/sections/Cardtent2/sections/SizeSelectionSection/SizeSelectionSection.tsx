...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Шатёр для выставок 15×20
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Шатёр для выставок 15×20 м",
      text: `Шатёр для выставок 15×20 м — мобильная многофункциональная конструкция. Она эффективно защищает гостей и выставочные экспонаты от ветра, дождя и солнца.

Специализированная компания представляет в ассортименте шатры и навесы для организации мероприятий разного направления.

Мы оказываем спектр профессиональных услуг:
• проектирование и изготовление;
• продажа и прокат мобильных тентов и шатров;
• ремонт и обслуживание быстровозводимых тентовых конструкций.`,
    },
    {
...
• Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
    },
    {
      ...
      text: `Каркас шатра для выставок 15×20 м изготовлен из высокопрочного анодированного алюминия. Огнестойкий тент выполнен из ПВХ-ткани повышенной плотности и непродуваемости. Материал не протекает, все швы надёжно проклеены.
Каркасное основание отличается прочностью и стойкостью к ветровым нагрузкам до 30 м/сек.
Площадь шатра — 300 м². Высота опоры — 2,5 / 3 / 3,5 / 4 м. Вес конструкции — 1 650 кг.`,
    },
    {
      title: "Особенности монтажа",
      text: `Конструкция отличается лёгкостью в монтаже — устанавливается на ровную поверхность и не требует задействования техники. Необходимо утяжеление конструкции плитами и надёжное крепление каркаса к поверхности.

Компания предлагает большой ассортимент быстровозводимых мобильных шатров и навесов в различных цветовых решениях, разных форм и размеров.`,
    },
  ];

  // TECH SPECS — UPDATED for 15×20
