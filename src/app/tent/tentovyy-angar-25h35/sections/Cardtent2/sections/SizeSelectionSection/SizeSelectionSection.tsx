...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 25×35
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 25×35 — функциональное пространство 875 м²",
      text: `Российская компания предлагает купить тентовый ангар 25×35 м с полезной площадью 875 м² по приемлемой стоимости. В таком помещении можно развернуть мобильную производственную линию, а также приспособить пространство под хранение техники, оборудования или товаров. Используют его и для проведения общественных, корпоративных и праздничных мероприятий большого масштаба.`,
    },
    {
      title: "Производство и индивидуальные решения",
      text: `Вы можете приобрести тентовый ангар 25×35 м от производителя или заказать другую мобильную конструкцию под любые нужды. Компания специализируется на изготовлении легких и прочных каркасных укрытий, разработанных в собственном конструкторском бюро, а также принимает заказы на изготовление оригинальных тентовых конструкций по чертежам и эскизам клиентов.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Тентовый ангар 25×35 м состоит из:
• рамных профилей — основного и дополнительного;
• тентового покрытия;
• узлов крепления.`,
    },
    {
      title: "Особенности монтажа",
      text: `Надёжное крепление конструкции к основанию обеспечивает защиту от порывов ветра до 30 м/сек.
Не требует специального фундамента — устанавливается на любой земляной поверхности. Монтируется и демонтируется без применения специальной техники в минимальный срок, без потери качества, любое количество раз.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 25×35
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 25×35" },
    ...
    { label: "Вес конструкции", value: "13 125 кг" },
