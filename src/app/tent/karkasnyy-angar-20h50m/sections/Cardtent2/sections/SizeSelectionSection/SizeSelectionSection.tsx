...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасный ангар 20×50м (1 000 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасных ангаров и тентовых конструкций. Каркасный ангар 20×50м (1 000 м²) — это просторное прямоугольное сооружение для крупных складов, производственных цехов, логистических центров и сельскохозяйственных комплексов.",
    },
    {
      title: "Особенности модели",
      text: "Ангар выполнен в прямостенной форме с двускатной кровлей. Площадь 1 000 м² позволяет разместить производственные линии, высотные стеллажи, спортивные площадки или выставочные стенды. Конструкция требует ленточного или свайного фундамента, монтируется за 14–20 дней.",
    },
    {
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 20×50м. Можно комбинировать с другими типоразмерами: 20×30м, 20×40м, 20×60м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame hangar 20×50m
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Вес металлоконструкции", value: "~18 000 кг" },
    ...
    { label: "Монтаж", value: "14–20 дней профессиональной бригадой с автокраном" },
