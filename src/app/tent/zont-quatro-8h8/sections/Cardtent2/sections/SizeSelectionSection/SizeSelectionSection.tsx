...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Quatro 8×8
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Quatro 8×8 — 64 м² тени и комфорта",
...
Размер 8×8 м обеспечивает около 64 м² полезной площади укрытия.`,
    },
    {
...
Крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
  ...
  // TECH SPECS — UPDATED for Зонт Quatro 8×8
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Quatro 8×8" },
