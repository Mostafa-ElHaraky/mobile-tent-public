...
const PAGE_CODE = "arochnyy-shatyor-6h3-18-m2";
...
async function getPageData(): Promise<PageData> {
  try {
    ...
    return {
      ...
      page: {
        id: 173,
        name: "Арочный шатёр 6х3 — 18 м²",
        code: PAGE_CODE
      },
      seo: {
        title: "Арочный шатёр 6х3 — 18 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent",
        description: "Арочный шатёр 6х3 — 18 м² – купить в Москве под заказ в компании Mobile Tent. Узкий и вытянутый шатер, идеально подходящий для установки над линейными объектами, проходами, торговыми рядами или в качестве навеса для автомобиля. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.",
        keywords: "арочный шатёр 6х3, купить арочный шатер 6х3, шатер 6 на 3, арочный шатер 18м2, узкий шатер, вытянутый шатер, шатер для прохода, шатер для автомобиля, тентовый шатер, быстровозводимый шатер, навес 6х3",
        h1: "Арочный шатёр 6х3 — 18 м²",
        url: `/tent/arochnyy-shatyor-6h3-18-m2`
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoTitle = data.seo?.title || "Арочный шатёр 6х3 — 18 м² – купить в Москве с доставкой: цена в интернет-магазине Mobile Tent";
  const seoDescription = data.seo?.description || "Арочный шатёр 6х3 — 18 м² – купить в Москве под заказ в компании Mobile Tent. Узкий и вытянутый шатер, идеально подходящий для установки над линейными объектами, проходами, торговыми рядами или в качестве навеса для автомобиля. Вы можете выбрать любую комплектацию, размер и цвет изделия, а также заказать его брендирование. Мы используем только качественные и долговечные материалы, а также предлагаем адекватные цены, которые будут дешевле долгосрочный аренды! Гарантия от производителя — 5 лет.";
  const seoKeywords = data.seo?.keywords || "арочный шатёр 6х3, купить арочный шатер 6х3, шатер 6 на 3, арочный шатер 18м2, узкий шатер, вытянутый шатер, шатер для прохода, шатер для автомобиля, тентовый шатер, быстровозводимый шатер, навес 6х3";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Арочный шатёр 6х3 - 18 м² от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function Arochny_Shatyor_Page() {
  ...
  const productSchema = {
    ...
    "name": pageData.page?.name || "Арочный шатёр 6х3 — 18 м²",
    "description": pageData.seo?.description || "Арочный шатёр 6х3 — 18 м² – купить в Москве под заказ в компании Mobile Tent. Узкий и вытянутый шатер, идеально подходящий для установки над линейными объектами, проходами, торговыми рядами или в качестве навеса для автомобиля. Вы можете выбрать любую комплектацию, размер и цвет изделия.",
    "sku": `MOB-${PAGE_CODE}`,
    "mpn": `MOB-ARCH-6x3-18`,
    "brand": {
      "@type": "Brand",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Назначение",
        "value": "Линейные объекты, проходы, торговые ряды, навес для автомобиля, складские нужды, защита оборудования"
      }
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
  ...
  // ----- FAQ SCHEMA (customized for арочный шатер 6х3) -----
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      {
        "@type": "Question",
        "name": `Какие размеры у арочного шатра 6х3?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Арочный шатер имеет ширину 6 метров, длину 3 метра, высоту в коньке до 4.5 метров. Полезная площадь — ${area} м². Это узкая и вытянутая конструкция, идеально подходящая для установки над проходами, линейными объектами, торговыми рядами или в качестве навеса для автомобиля.`
        }
      },
      {
        "@type": "Question",
        "name": `Сколько стоит арочный шатер 6х3?`,
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Для каких целей подходит арочный шатер 6х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Арочный шатер 6х3 идеально подходит для: навесов над проходами и пешеходными зонами, защиты торговых рядов и прилавков, укрытия для автомобиля или техники, складских нужд, линейных объектов производственных предприятий, защиты оборудования на открытых площадках, временных коридоров и переходов."
        }
      },
      {
        "@type": "Question",
        "name": "Нужно ли разрешение на установку арочного шатра 6х3 в Москве?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Для временных сооружений площадью до 18 м² разрешение не требуется. Для установки на длительный срок или в общественных местах может потребоваться согласование. Мы помогаем с оформлением необходимых документов."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Можно ли установить стены и двери в арочном шатре 6х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, возможна установка торцевых стен с дверями, окнами, воротами. Узкая конструкция позволяет эффективно организовать сквозной проход или закрытое помещение. Также доступны боковые стены, системы вентиляции, освещения и отопления. Возможно брендирование тента."
        }
      },
      {
        "@type": "Question",
        "name": "Какой срок изготовления арочного шатра 6х3?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стандартный срок изготовления арочного шатра 6х3 — от 3 до 7 рабочих дней. Для срочных заказов возможна ускоренная сборка за 1-2 дня."
        }
      },
      {
        "@type": "Question",
        "name": "Доставляете ли арочные шатры 6х3 в Московскую область?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden">
      ...
      <h1 className="sr-only">
        {pageData.seo?.h1 || "Арочный шатёр 6х3 — 18 м²"}
      </h1>
