...
export const SizeSelectionSection = ({ 
  ...
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      ...
      text:
        "Арочный шатёр прямоугольной формы площадью 18 м² представляет собой полукруглый навес, защищающий от внешних погодных воздействий.",
    },
    {
      title: "Назначение",
      text:
        "Шатёр данной модели может использоваться в качестве навеса при проведении концертных мероприятий, места размещения оборудования, для организации летнего кафе на открытом воздухе. Есть возможность недорого арендовать конструкцию.",
    },
    {
      title: "Установка и транспортировка",
      text:
        "Для установки шатра необходима ровная поверхность. Конструкция легко монтируется и транспортируется.",
    },
    {
      title: "Каркас и материалы",
      text:
        "Выполненный из оцинкованной стали каркас прочно удерживает тентовое полотно французского производства.",
    },
  ];
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Высота входной арки", value: "3 м" },
    { label: "Высота в коньке", value: "2,65 м" },
    { label: "Вес конструкции", value: "260 кг" },
    { label: "Нагрузка на опорную пятку", value: "65 кг" },
    ...
    },
    {
      label: "Модульность",
      value:
        'Возможность увеличения площади путём соединения нескольких конструкций со стороной 6 м: "VIP 6Х6 м", "VIP Дюна 6Х6 м", "VIP 12Х12 м".',
    },
    {
    ...
    { label: "Каркас", value: "Все элементы каркаса конструкции изготовлены из оцинкованной стали." },
