...
const tentSequences = [
  {
    basePath: "/25x40_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    ...
    { label: "Вместимость:", value: "416 человек" },
...
const thumbnails = [
  { id: 1, src: "/25x25,1.webp", alt: "Product 1" },
  { id: 2, src: "/25x25,2.webp", alt: "Product 2" },
