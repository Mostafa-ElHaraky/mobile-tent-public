...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Классический шатёр 25х25
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Классический шатёр 25х25",
      text: `Классический шатёр 25х25 м — просто находка для организаторов торжественных мероприятий любого уровня. Гости даже не заметят, что находятся во временном сооружении.

При необходимости вы всегда можете обратиться к нам для качественного ремонта и периодического технического обслуживания тентовых изделий — у нас есть всё необходимое оборудование и материалы.

Вы также можете предложить собственный проект конструкции шатра для изготовления. Разумеется, ваши расчёты проверят специалисты компании.`,
    },
    {
      title: "Преимущества и характеристики",
      text: `Достоинства эксплуатации мобильных тентовых конструкций неоспоримы:
— быстрый монтаж и демонтаж;
— установка на любой площадке;
— относительно низкие затраты.

Классический шатёр 25х25 рекомендуется использовать в период весна–осень, когда температура окружающего воздуха не опускается ниже +15°C.`,
    },
    {
...
Особенности монтажа: обязательное крепление конструкции к поверхности, на которую ставится, или утяжеление конструкции бетонными блоками.`,
  ...
  // TECH SPECS — UPDATED with data for 25x25m tent
