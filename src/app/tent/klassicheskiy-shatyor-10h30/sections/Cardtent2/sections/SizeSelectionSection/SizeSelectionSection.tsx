...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING CONTENT — UPDATED for Классический шатёр 10х30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Классический шатёр 10х30",
      text: `В поисках просторной навесной конструкции для монтажа под открытым небом стоит обратить внимание на классический шатер 10х30 м. Презентабельный дизайн и оптимальные пропорции сделают его идеальным местом проведения торжества.

В сравнении со стационарными помещениями шатры не ограничены по площади, их легко транспортировать. В результате размещение любого количества гостей будет стоить дешевле.`,
    },
    {
      title: "Технические характеристики и особенности конструкции",
      text: `• Устойчивый каркас из анодированного алюминия, крепежные элементы из оцинкованной стали. Шатёр рассчитан на ветровую нагрузку до 30 м/сек.
• Тентовое покрытие сертифицировано, специальная пропитка обеспечивает пожаростойкость и защиту от гниения.
• Высокое качество материалов гарантирует длительный срок службы конструкции. При многократной сборке и демонтаже классический шатёр 10х30 м сохраняет свой презентабельный вид.`,
    },
    {
      title: "Монтаж",
      text: `• Для стойкости конструкции необходимо утяжеление бетонными блоками.
• Чтобы смонтировать шатёр, не нужно задействовать спецтехнику.
• Вес конструкции — 1650 кг, разборный каркас обеспечивает лёгкость транспортировки и монтажа.`,
    },
    {
  ...
  // TECH SPECS — UPDATED with new data for 10x30m tent
