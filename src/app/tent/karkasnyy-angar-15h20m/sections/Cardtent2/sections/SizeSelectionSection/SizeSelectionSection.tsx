...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Каркасный ангар 15×20м Тип Д (300 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Компания MOBILE TENT",
      text: "Компания MOBILE TENT специализируется на производстве быстровозводимых каркасных ангаров и тентовых конструкций. Каркасный ангар 15×20м Тип Д (300 м²) — это усиленное прямоугольное сооружение для складов, производственных цехов, спортивных залов и сельскохозяйственных объектов.",
    },
    {
      title: "Особенности модели Тип Д",
      text: "Ангар выполнен в прямостенной форме с двускатной кровлей. Площадь 300 м² позволяет разместить производственную линию, складские стеллажи, спортивную площадку или выставочный стенд. Тип Д — усиленная версия с увеличенным сечением профиля для повышенных снеговых и ветровых нагрузок. Конструкция требует ленточного или свайного фундамента, монтируется за 10–14 дней.",
    },
    {
      title: "Практичность и применение",
      text: "Идеален для круглогодичного использования (с утеплением сэндвич-панелями). Подходит для: складских помещений, производственных цехов, спортивных залов, выставочных павильонов, укрытия техники, сельскохозяйственных нужд, автосервисов.",
    },
    {
      title: "Материалы",
    ...
    {
      title: "Модульность",
      text: "Возможность увеличения площади путём соединения нескольких ангаров 15×20м. Можно комбинировать с другими типоразмерами: 15×30м, 15×40м и т.д. Расширение длины любыми секциями.",
    },
  ];

  // Technical specifications for frame hangar 15×20 Type D
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Длина", value: "20 м (может быть увеличена модулями)" },
    { label: "Ширина (пролёт)", value: "15 м" },
    { label: "Высота стенки", value: "до 6 м" },
    { label: "Высота в коньке", value: "до 8 м" },
    { label: "Вес металлоконструкции", value: "~8 500 кг" },
    ...
    { label: "Монтаж", value: "10–14 дней профессиональной бригадой с автокраном" },
