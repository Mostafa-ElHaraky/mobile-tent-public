...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Зонт Desert 3×3
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Зонт Desert 3×3 — 9 м² защиты от солнца и осадков",
      text: `Квадратный зонтовый навес с центральной стойкой — компактное и аккуратное решение для летних веранд, уличных кафе, зон ожидания и небольших мероприятий. Размер 3×3 м обеспечивает 9 м² полезной площади при лёгком и быстром монтаже.`,
    },
    {
      title: "Конструкция и материалы",
      text: `Форма — квадрат. Стойка расположена по центру для равномерного распределения нагрузки.
Все элементы каркаса конструкции изготовлены из стали высокого качества; крепёжные элементы — из оцинкованной стали для защиты от коррозии.`,
    },
  ];

  // TECH SPECS — UPDATED for Зонт Desert 3×3
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Зонт Desert 3×3" },
