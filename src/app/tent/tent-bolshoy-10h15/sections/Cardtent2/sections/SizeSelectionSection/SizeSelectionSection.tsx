...
export const SizeSelectionSection = ({ 
  ...
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тент большой 10×15 — классическое решение для мероприятий",
      text: `Мечту провести мероприятие на свежем воздухе можно легко осуществить, если приобрести или арендовать классический шатёр 10×15 м. С такой конструкцией не страшны никакие капризы погоды.
      
Выездные праздники на природе — это красиво, нестандартный подход сделает мероприятие особенным. Классический шатёр 10×15 станет надёжным укрытием для торжественной церемонии, обеда или танцев, а ваши гости останутся довольны уровнем комфорта.`,
    },
    {
      title: "Особенности и технические характеристики",
      text: `• ПВХ французского производства (DICKSON) пропитано составами, препятствующими горению и гниению.
• Каркас изготовлен из анодированного алюминия, а крепёжные элементы — из оцинкованной стали.
• Конструкция устойчива к ветровой нагрузке (до 30 м/сек), её вес — 825 кг.
• Простая установка и перевозка на место проведения мероприятия.`,
    },
    {
      title: "Монтаж",
      text: `• Для установки подходит любая ровная поверхность — заливка фундамента не требуется.
• Для монтажа не нужно задействовать спецтехнику.
• Возможно многоразовое использование конструкции; срок службы — до 10 лет.
• Особенности монтажа: обязательное крепление конструкции к основанию или утяжеление бетонными блоками.`,
    },
    {
      title: "О компании",
      text: `Компания MOBILE TENT производит навесные конструкции разных размеров. Поможем приобрести или арендовать любую из них по хорошей цене, гарантируем качество и предоставляем весь спектр сопутствующих услуг.`,
    },
  ];

  // TECH SPECS — UPDATED for Тент большой 10×15
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тент большой 10×15" },
    ...
    { label: "Вес конструкции", value: "825 кг" },
