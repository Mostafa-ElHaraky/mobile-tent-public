...
export const SizeSelectionSection = ({ 
  ...
  // Default content for Арочный ангар 20×50 (1 000 м²)
  const defaultDescriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Арочный ангар 20×50 м",
      text: "Прямоугольный ангар площадью 1 000 м² предназначен для хранения, производства, выставочных мероприятий и других задач. Конструкция отличается надёжностью, долговечностью и функциональностью благодаря современным материалам.",
    },
    {
  ...
  const defaultSpecs: { label: string; value: string }[] = [
    ...
    { label: "Вес конструкции", value: "4 500 кг (алюминий)" },
