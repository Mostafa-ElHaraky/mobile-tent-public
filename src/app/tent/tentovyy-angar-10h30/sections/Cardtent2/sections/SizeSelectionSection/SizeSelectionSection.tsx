...
export const SizeSelectionSection = (): ReactElement => {
  // MARKETING / DESCRIPTION — UPDATED for Тентовый ангар 10×30
  const descriptionBlocks: { title?: string; text: string }[] = [
    {
      title: "Тентовый ангар 10×30 — надёжное и универсальное решение",
      text: `Когда быстро нужно найти помещение под склад, автостоянку или производственный цех, стоит присмотреться к покупке ангара 10×30 м. Эксплуатационные характеристики помещения сопоставимы с капитальными сооружениями, при этом ангар имеет быстрые сроки возведения и привлекательную цену.`,
    },
    {
      title: "Характеристики",
      text: `Длина конструкции — 30 м, площадь укрытия — 300 м², вес — 1,65 т, высота стен — 2,5/3/3,5/4 м, максимальная высота в коньке — 7,5 м.
Рамный профиль выполнен из анодированного алюминия, крепёжные элементы — из оцинкованной стали.
Покрытие — сертифицированное полотно ПВХ (Франция, DICKSON), стойкое к атмосферным осадкам и не подвержено возгоранию.`,
    },
    {
      title: "Преимущества",
      text: `• Многоцелевое использование — склад любой продукции, крытая стоянка для транспорта и техники, производственный цех, помещение для занятий спортом.
• Эксплуатация круглый год; возможно дополнительно установить отопление и кондиционирование.
• При необходимости ангар можно демонтировать, перевезти и установить в другом месте.`,
    },
    {
      title: "Особенности монтажа",
      text: `Не требуется заливка фундамента. Не нужна спецтехника для установки.
Заводская комплектация полностью готова для монтажа. Компания MOBILE TENT доставит и установит тентовый ангар, а также предоставит консультации по дальнейшей эксплуатации.`,
    },
  ];

  // TECH SPECS — UPDATED for Тентовый ангар 10×30
  const specs: { label: string; value: string }[] = [
    { label: "Модель", value: "Тентовый ангар 10×30" },
