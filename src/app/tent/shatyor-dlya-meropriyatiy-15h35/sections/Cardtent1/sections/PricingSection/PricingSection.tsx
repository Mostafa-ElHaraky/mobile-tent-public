...
const tentSequences = [
  {
    basePath: "/15x25_walls/1_Interactive LightMix", // No trailing slash
    totalFrames: 180,
    frameRate: 24
  },
];
  ...
  const specifications = [
    ...
    { label: "Вместимость:", value: "350 человек" },
...
const thumbnails = [
  { id: 1, src: "/events15x30,1.webp", alt: "Product 1" },
  { id: 2, src: "/events15x30,2.webp", alt: "Product 2" },
  { id: 3, src: "/events15x30,3.webp", alt: "Product 3" },
