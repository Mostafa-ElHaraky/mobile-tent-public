...
export const OverlapWrapperProizvodstvoshatrov = (): ReactElement => {
  ...
  return (
    <>
      {/* Desktop Version */}
      <section className="hidden md:block relative w-[1440px] h-[726px] top-[90px] rounded-[30px] overflow-hidden shadow-[var(--)] backdrop-blur-[79px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(79px)_brightness(100%)] mx-auto flex justify-center items-center">
        <div className="relative h-[718px] top-[5px]">
