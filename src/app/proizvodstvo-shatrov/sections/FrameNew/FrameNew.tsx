...
// Props interface
interface FrameNewProps {
  contacts?: ContactsData;
}

export const FrameNew = ({ contacts = defaultContacts }: FrameNewProps): ReactElement => {
  ...
  // Contact information data - NOW DYNAMIC FROM BITRIX
  const contactInfo = [
    {
      icon: "/element8-7.webp",
      text: contactsData.office.address,
      linkText: "Построить маршрут на Яндекс картах",
      linkUrl: contactsData.office.map_url,
      hasLink: true,
    },
    {
      icon: "/element8-8.webp",
      text: contactsData.office.hours,
      subText: contactsData.office.appointment,
      hasLink: false,
    },
    {
      icon: "/element8-11.webp",
      text: contactsData.phone1,
      phoneLink: `tel:${formatPhoneForLink(contactsData.phone1)}`,
      hasLink: false,
    },
    {
      icon: "/element8-12.webp",
      text: contactsData.phone2,
      phoneLink: `tel:${formatPhoneForLink(contactsData.phone2)}`,
      hasLink: false,
    },
    {
      icon: "/element8-13.webp",
      text: contactsData.email,
      mailLink: `mailto:${contactsData.email}`,
      hasClipboard: true,
    },
  ];
                        ...
                        <div className="flex flex-col">
                          <div className="font-normal text-[#394355] text-sm leading-normal font-['Raleway',Helvetica] tracking-[0]">
                            {info.hasLink ? (
                              ...
                              <a
                                href={info.phoneLink}
                                className="inline-block text-[#394355] text-sm no-underline hover:underline"
                              >
                                {info.text}
                              </a>
                            ) : info.mailLink ? (
                              <div className="inline-flex items-center gap-1">
                                <a
                                  href={info.mailLink}
                                  className="text-[#394355] text-sm no-underline hover:underline"
                                >
                                  {info.text}
                                </a>
                                <button
                              ...
                              <>
                                ...
                                {info.hasClipboard && (
                                  <button
                                    onClick={handleCopyEmail}
                                    className="inline-block ml-2 p-1 hover:bg-gray-100 rounded"
                                    title="Скопировать email"
                                  >
                                    <Image
                                      className="w-4 h-4"
                      ...
                      <div className="flex flex-col">
                        <div className="font-normal text-[#394355] text-xs leading-normal font-['Raleway',Helvetica] tracking-[0]">
                          {info.hasLink ? (
                            ...
                            <a
                              href={info.phoneLink}
                              className="inline-block text-[#394355] text-xs no-underline hover:underline"
                            >
                              {info.text}
                            </a>
                          ) : info.mailLink ? (
                            <div className="inline-flex items-center gap-1">
                              <a
                                href={info.mailLink}
                                className="text-[#394355] text-xs no-underline hover:underline"
                              >
                                {info.text}
                              </a>
                              <button
                            ...
                            <>
                              ...
                              {info.hasClipboard && (
                                <button
                                  onClick={handleCopyEmail}
                                  className="inline-block ml-1 p-1 hover:bg-gray-100 rounded"
                                  title="Скопировать email"
                                >
                                  <Image
                                    className="w-3 h-3"
