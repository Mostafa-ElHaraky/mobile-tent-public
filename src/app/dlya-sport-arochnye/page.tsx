...
export const metadata: Metadata = {
  title: "Купить арочные шатры для спорта по оптимальной цене",
  description: "Заказать арочные шатры для спортивных мероприятий недорого от производителя. Быстрая доставка по России, гарантия качества, выгодные скидки!",
