...
export const metadata: Metadata = {
  title: "Купить мобильные шатры для загородного дома – доступный цены, заказ в MOBILE TENT",
  description: "Мобильные шатры для загородного дома – быстрый монтаж, надежный каркас, доставка по России. Удобные мобильные шатры для дачи и отдыха на природе. Выберите модель по лучшей цене в Mobile Tent!",
