  ...
  return (
    <>
      ...
      <section
        ...
        className="hidden desktop:block w-full py-16 relative top-[25px] rounded-[30px] bg-gradient-to-br from-[#243057] to-[#435575]"
      >
        ...
        <div className="flex flex-col md:flex-row gap-12 ml-8">
          ...
          <div className="flex flex-col gap-[60px]">
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-3">
                  <p className="font-medium text-white text-lg leading-6">
                    Более 60% клиентов становятся постоянными
                  </p>
                </div>

                <h2 className="w-[528px] text-4xl leading-normal">
              ...
              <p className="w-[496px] font-semibold text-white text-base leading-6">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-bold text-white text-base leading-6">
                {aboutCompany.title}
              </h3>
              <div className="flex flex-col gap-3 text-white text-sm leading-6">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-white text-sm leading-5">
                ...
                <div className="flex flex-col gap-4">
                  {accomplishments.map((text, index) => (
                    <div key={index} className="flex items-start gap-6">
                      ...
                      <p className="w-[358px] font-normal text-white text-sm leading-5">
                        {text}
                      </p>
                    </div>
                  ))}
            ...
            <div className="flex items-center gap-[33px] mt-12">
              ...
              >
                <Image
                  ...
                  loading="lazy"
                />
                <span className="w-[180px] font-semibold text-white text-base leading-5 underline-offset-2 group-hover:underline">
            ...
            <div className="flex flex-col gap-3 mt-6">
              <p className="w-[412px] font-normal text-white text-xs text-center">
                Свяжитесь с любым из наших клиентов, чтобы спросить всё, что захотите
              </p>
              <Button
                className="w-[412px] h-[68px] rounded-2xl bg-gradient-to-b from-[#73a8ff] via-[#6fa7ff] to-[#3c6cec]"
...
{previewImages.map((image, index) => {
  ...
  return (
    ...
    >
        ...
        />
            ...
            <div className="relative w-full">
              ...
              >
                ...
                <Button
                  className="h-[60px] absolute top-[633px] left-[548px] inline-flex items-center gap-2.5 pl-6 pr-3 py-3 bg-white rounded-[50px] border-0 shadow backdrop-blur-[79px]"
                  onClick={(e) => handleNavigation('/gallery', e)}
                >
                  <span className="font-bold text-black text-base">
                    Показать ещё
              ...
              {serviceCards.map((card, index) => (
                ...
                >
                  <CardContent className="flex flex-col items-center justify-center h-[85px] gap-1.5 p-5">
                    <div className="font-semibold text-white text-base text-center leading-5">
                      {card.title}
                    </div>
                    <div className="font-normal text-white text-base text-center leading-5">
                      {card.content}
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="block desktop:hidden w-full py-8 px-4 relative rounded-[20px] bg-gradient-to-br from-[#243057] to-[#435575] max-w-4xl mx-auto">
        {/* Thank You Letter Modal */}
        {showThankYouModal && (
          <div
            className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4"
        ...
        <div className="flex flex-col gap-8 md:items-center md:text-center">
          {/* Header */}
          <div className="flex flex-col gap-4">
            <p className="font-medium text-white text-lg leading-6">
              Более 60% клиентов становятся постоянными
            ...
            <p className="font-semibold text-white text-base leading-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 text-white text-sm leading-6">
              {aboutCompany.paragraphs.map((t, i) => (
                <p key={i}>{t}</p>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-6 w-full">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-white text-sm leading-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {accomplishments.map((text, index) => (
                  <div key={index} className="flex items-start gap-4">
                    ...
                    <p className="font-normal text-white text-sm leading-5 text-left">
                      {text}
                    </p>
                  </div>
                ))}
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            >
              <Image
                ...
                loading="lazy"
              />
              <span className="w-[150px] font-semibold text-white text-sm leading-5 underline-offset-2 group-hover:underline text-left">
                Благодарственное письмо
              </span>
            </button>
          </div>
          ...
          <div className="relative w-full max-w-2xl mx-auto">
            <div
              className="relative w-full h-[300px] md:h-[400px] rounded-[20px] overflow-hidden"
              role="region"
              aria-live="polite"
              aria-label={`Главное фото ${currentImageIndex + 1} из ${previewImages.length}`}
            >
            ...
            <div
              ref={thumbRowRef}
              className="flex gap-2 mt-4 overflow-x-auto pb-2 justify-start md:justify-center"
              role="listbox"
              aria-label="Превью фотографий"
            >
{previewImages.map((image, index) => {
    ...
    >
      ...
      />
            ...
            {serviceCards.map((card, index) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center h-[70px] gap-1 p-3">
                  <div className="font-semibold text-white text-sm text-center leading-5">
                    {card.title}
                  </div>
                  <div className="font-normal text-white text-sm text-center leading-5">
                    {card.content}
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="flex flex-col md:flex-row gap-3 mt-4 w-full justify-center">
            <Button
              variant="outline"
              className="h-[50px] w-full md:w-fit md:px-8 border-0 inline-flex items-center justify-between px-4 py-3 bg-white rounded-[50px] shadow backdrop-blur-[79px]"
              onClick={(e) => handleNavigation('/gallery', e)}
            >
              <span className="font-bold text-black text-sm">
                Смотреть кейс полностью
            ...
            <Button
              className="h-[50px] w-full md:w-fit md:px-8 inline-flex items-center justify-between px-4 py-3 bg-white rounded-[50px] border-0 shadow backdrop-blur-[79px]"
              onClick={(e) => handleNavigation('/gallery', e)}
            >
              <span className="font-bold text-black text-sm">
                Показать ещё
          ...
          <div className="flex flex-col gap-3 mt-6 w-full max-w-md mx-auto">
            <p className="font-normal text-white text-xs text-center">
              Свяжитесь с любым из наших клиентов, чтобы спросить всё, что захотите
            </p>
            <Button
              className="w-full h-[50px] rounded-2xl bg-gradient-to-b from-[#73a8ff] via-[#6fa7ff] to-[#3c6cec]"
              onClick={() => setShowAskContact(true)}
              aria-label="Запросить контакты"
            >
