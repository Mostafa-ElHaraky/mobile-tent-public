...
export const FeaturesSection = (): ReactElement => {
  ...
  return (
    <>
      ...
      <section className="hidden lg:flex flex-col lg:flex-row items-center relative top-[85px] gap-10 w-full py-12 px-4 lg:px-12">
        <div className="flex flex-col items-start justify-center gap-10 w-full lg:w-1/2">
      ...
      <section className="block desktop:hidden flex flex-col items-center relative top-[10px] gap-8 w-full py-8 px-4 max-w-4xl mx-auto">
        {/* Text Content */}
        <div className="flex flex-col md:items-center md:text-center gap-6 w-full">
          <div className="flex flex-col md:items-center gap-6">
            <div className="flex flex-col w-full md:items-center gap-3">
              <div className="flex items-start md:justify-center gap-3">
                <p className="font-normal text-[#4f5d80] text-sm md:text-base leading-6 [font-family:'Raleway',Helvetica] tracking-[0]">
                  <span className="font-medium">
                    {featureData.subtitle.split("шатер")[0]}шатер
                  </span>
                  <span className="font-bold">
              ...
              <h2 className="text-2xl md:text-4xl leading-[normal] [font-family:'Raleway',Helvetica] tracking-[0] md:text-center">
                <span className="font-medium text-[#232c42]">
                  {featureData.title.regular}
                </span>
                <span className="font-bold text-[#527dc5]">
            ...
            <Card className="bg-[#e8edf7] border-none rounded-[10px] w-full max-w-2xl">
              <CardContent className="px-4 py-3 md:py-6">
                <p className="font-semibold text-[#394355] text-lg md:text-2xl leading-6 [font-family:'Raleway',Helvetica] tracking-[0] md:text-center">
                  {featureData.callout}
                </p>
              </CardContent>
            </Card>

            <p className="text-[#394355] text-base md:text-lg leading-6 [font-family:'Raleway',Helvetica] tracking-[0] w-full max-w-2xl md:text-center">
              <span className="font-normal">
                {featureData.description.regular}
              </span>
              <span className="font-semibold">
        ...
        <div className="relative w-full max-w-2xl mx-auto">
          <Card className="w-full h-[300px] md:h-[400px] bg-white rounded-[20px] border-0 shadow-[0_4px_20px_rgba(0,0,0,0.1)] backdrop-blur-[10px] backdrop-brightness-[100%] flex items-center justify-center overflow-hidden">
            <CardContent className="p-0 flex items-center justify-center w-full h-full">
              {isPlaying ? (
                <div className="w-full h-full relative">
                  <iframe
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="flex gap-2">
              {videoIds.map((_, index) => (
                <button 
                  key={index}
                  className={`w-3 h-3 md:w-4 md:h-4 rounded-full ${index === currentIndex ? 'bg-[#527dc5]' : 'bg-[#c1d0e8]'}`}
                  onClick={() => setCurrentIndex(index)}
                />
              ))}
            </div>
