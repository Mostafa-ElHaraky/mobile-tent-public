...
export const CallToActionSection = (): ReactElement => {
  return (
    <>
      {/* Desktop Version */}
      <section className="relative w-full h-[562px] rounded-[30px] overflow-hidden hidden md:block">
        <div className="relative h-[562px]">
          ...
          <div className="flex flex-col items-start gap-[55px] absolute top-[120px] left-[65px]">
            {/* Text content */}
      ...
      {/* Mobile Version */}
      <section className="relative w-full min-h-screen rounded-[20px] overflow-hidden block md:hidden p-4">
        <div className="relative w-full min-h-[800px] max-w-[500px] mx-auto">
          ...
          {/* Tent image - enlarged */}
          <Image
            className="absolute w-[450px] h-[320px] top-[450px] left-[58%] transform -translate-x-1/2"
            alt="Event tent"
            src="/Event-Tent-i02.webp"
            width={400}
            height={500}
          ...
          <div className="absolute w-[90%] max-w-[400px] h-[40vh] min-h-[300px] max-h-[400px] top-[70%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden">
