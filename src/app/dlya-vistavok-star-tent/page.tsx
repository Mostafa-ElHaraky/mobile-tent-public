...
export const metadata: Metadata = {
  title: "Купить шатер звезда для выставки по лучшей цене от производителя MOBILE TENT",
  description: "Шатры Звезда для выставок от производителя MOBILE TENT. Эффектный дизайн и устойчивость. Узнайте цены на шатры Звезда и закажите для вашего мероприятия.",
