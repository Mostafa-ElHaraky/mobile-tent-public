...
export const metadata: Metadata = {
  title: "Заказать спортивные шатры и навесы по выгодной цене с доставкой по России",
  description: "Купить быстровозводимые спортивные шатры и навесы по доступной стоимости в компании MOBILE TENT. Продажа от производителя, доставка по России, гарантии.",
