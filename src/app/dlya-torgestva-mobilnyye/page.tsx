...
export const metadata: Metadata = {
  title: "Купить мобильные шатры для праздников и торжеств по цене производителя от MOBILE TENT",
  description: "Купите мобильные шатры для праздников по доступным ценам на Mobile Tent. Большой выбор мобильных шатров для торжеств различных размеров и дизайнов. Удобные и надежные решения для вашего мероприятия. Быстрая доставка и отличные цены на сайте Mobile-Tent.",
