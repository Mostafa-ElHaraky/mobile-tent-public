...
export const metadata: Metadata = {
  title: "Купить арочные шатры для торжеств и праздников недорого по цене производителя с доставкой",
  description: "Заказать арочные шатры для торжеств и праздников по сниженной стоимости с доставкой от производителя. Скидки, гарантии.",
