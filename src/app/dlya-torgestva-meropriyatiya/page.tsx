...
export const metadata: Metadata = {
  title: "Купить шатры для мероприятий по ценам производителя MOBILE TENT",
  description: "Закажите шатры для проведения мероприятий недорого в компании MOBILE TENT с доставкой по России. Шатры для банкетов, мероприятий и праздников различных конструкций от производителя.",
