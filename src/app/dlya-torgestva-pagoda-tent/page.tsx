...
export const metadata: Metadata = {
  title: "Купить шатры пагода для праздников и торжеств по цене производителя от MOBILE TENT",
  description: "Хотите купить шатры пагода для праздников? У нас широкий выбор шатров пагода для торжеств. Элегантные и практичные решения для любых мероприятий. Быстрая доставка и отличные цены на сайте Mobile-Tent.",
