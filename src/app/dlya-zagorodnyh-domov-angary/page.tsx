...
export const metadata: Metadata = {
  title: "Купить ангары для загородного дома недорого по ценам от производителя",
  description: "Купить ангары для загородного дома по выгодной цене с доставкой от производителя. Быстрая доставка по России и привлекательные скидки.",
