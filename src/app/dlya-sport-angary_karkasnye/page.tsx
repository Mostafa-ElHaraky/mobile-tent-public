...
export const metadata: Metadata = {
  title: "Купить каркасные ангары для спорта недорого по ценам от MOBILE TENT с доставкой",
  description: "Купить спортивные каркасные ангары в MOBILE TENT по сниженной цене. Гарантия производителя, быстрая доставка по РФ.",
