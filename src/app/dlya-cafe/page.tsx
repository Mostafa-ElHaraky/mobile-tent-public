...
export const metadata: Metadata = {
  title: "Купить шатры для кафе и ресторанов по доступной цене от MOBILE TENT",
  description: "Заказать шатры для кафе и ресторанов по стоимости от производителя MOBILE TENT с доставкой по России. Продажа больших шатров для кафе. Гарантии качества, постоянные скидки.",
