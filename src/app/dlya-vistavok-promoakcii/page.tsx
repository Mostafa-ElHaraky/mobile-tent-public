...
export const metadata: Metadata = {
  title: "Купить шатры для выставок и промоакций по доступным ценам от MOBILE TENT",
  description: "Шатры для промоакций от MOBILE TENT. Прочные и удобные конструкции для успешных мероприятий. Узнайте цены на шатры для промоакций и сделайте заказ.",
