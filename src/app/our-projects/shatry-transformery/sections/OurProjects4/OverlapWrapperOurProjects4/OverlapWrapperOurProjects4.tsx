...
export const OverlapWrapperOurProjects4 = (): ReactElement => {
  ...
  return (
    <section className="relative w-full h-[726px] top-[20px] rounded-[30px] overflow-hidden shadow-[var(--)] backdrop-blur-[79px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(79px)_brightness(100%)]">
