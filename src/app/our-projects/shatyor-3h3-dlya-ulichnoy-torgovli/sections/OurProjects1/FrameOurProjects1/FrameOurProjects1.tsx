...
const hotelImages = [
  { id: 1, src: "/new3x3.jpg",   alt: "Шатёр для мероприятия Mercedes-Benz — общий вид" },
  { id: 2, src: "/new3x3,2.jpg", alt: "Г-образная конфигурация из 6 модулей" },
  { id: 3, src: "/new3x3,3.jpg", alt: "Интерьер: столы и диваны, зона для гостей" },
  { id: 4, src: "/new3x3,4.jpg", alt: "Напольное покрытие с имитацией газона" },
  { id: 5, src: "/new3x3,5.jpg", alt: "Электроснабжение: плазменные телевизоры и оборудование" },
  { id: 6, src: "/new3x3,6.jpg", alt: "Декор: напольные вазоны с растениями" },
];
