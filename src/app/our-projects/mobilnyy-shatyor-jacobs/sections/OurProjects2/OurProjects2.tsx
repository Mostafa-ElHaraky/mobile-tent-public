...
export const OurProjects2 = (): ReactElement => {
  ...
  const sectionPhotos: Record<typeof photoSections[number]['id'], string[]> = useMemo(() => ({
    "in-progress": [
      "/16-mobilnyy-shater-jacobs_5.webp",
      "/16-mobilnyy-shater-jacobs_6.webp",
      "/16-mobilnyy-shater-jacobs.webp",
      "/16-mobilnyy-shater-jacobs_0.webp",
      "/16-mobilnyy-shater-jacobs_1.webp",
      "/16-mobilnyy-shater-jacobs_2.webp",
      "/16-mobilnyy-shater-jacobs_3.webp",
    ],
    "final": [
      "/16-mobilnyy-shater-jacobs_5.webp",
      "/16-mobilnyy-shater-jacobs_6.webp",
