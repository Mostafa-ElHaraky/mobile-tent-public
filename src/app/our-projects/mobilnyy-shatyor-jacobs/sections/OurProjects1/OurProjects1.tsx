...
export const OurProjects1 = (): ReactElement => {
  ...
  const hotelSpecs = [
    ...
    { label: "Дата:", value: "чт, 05/05/2016" },
  ...
  const additionalInfo = [
    { label: "Бренд:", value: "JACOBS" },
    { label: "Тип конструкции:", value: "Открытый шатёр с козырьком" },
  ];
  ...
  return (
    <>
      ...
      {/* ===== Mobile (updated - H1 removed, uses desktop H1) ===== */}
