...
const hotelImages = [
  { id: 1, src: "/16-mobilnyy-shater-jacobs.webp",   alt: "Мобильный шатёр JACOBS — общий вид" },
  { id: 2, src: "/16-mobilnyy-shater-jacobs_0.webp", alt: "Брендированный тент с логотипом JACOBS" },
  { id: 3, src: "/16-mobilnyy-shater-jacobs_1.webp", alt: "Открытое пространство под шатром для торговли" },
  { id: 4, src: "/16-mobilnyy-shater-jacobs_2.webp", alt: "Козырёк, защищающий от солнца" },
  { id: 5, src: "/16-mobilnyy-shater-jacobs_3.webp", alt: "Каркас из алюминиевых стоек и крепления" },
  { id: 6, src: "/16-mobilnyy-shater-jacobs_4.webp", alt: "Шатёр JACOBS на выставочной площадке" },
];
