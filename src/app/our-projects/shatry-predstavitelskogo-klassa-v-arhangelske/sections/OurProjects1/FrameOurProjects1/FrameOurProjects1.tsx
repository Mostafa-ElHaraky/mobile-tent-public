...
const hotelImages = [
  { id: 1, src: "/18-shatry-predstavitelskogo-klassa-v-arhangelske.webp",   alt: "Шатры представительского класса в Архангельске — общий вид" },
  { id: 2, src: "/18-shatry-predstavitelskogo-klassa-v-arhangelske_0.webp", alt: "Внешний фасад шатра с окнами" },
  { id: 3, src: "/18-shatry-predstavitelskogo-klassa-v-arhangelske_1.webp", alt: "Интерьер шатра представительского класса" },
  { id: 4, src: "/18-shatry-predstavitelskogo-klassa-v-arhangelske_2.webp", alt: "Деревянный подиум с покрытием из искусственного газона" },
  { id: 5, src: "/18-shatry-predstavitelskogo-klassa-v-arhangelske_3.webp", alt: "Двустворчатая пластиковая дверь со стеклопакетами" },
  { id: 6, src: "/18-shatry-predstavitelskogo-klassa-v-arhangelske_4.webp", alt: "Общий вид шатров на площадке в Архангельске" },
];
