...
export const OurProjects2 = (): ReactElement => {
  ...
  const sectionPhotos: Record<typeof photoSections[number]['id'], string[]> = useMemo(() => ({
    "in-progress": [
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_5.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_4.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_3.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_2.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_1.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_0.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske.webp",
    ],
    "final": [
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_5.webp",
      "/18-shatry-predstavitelskogo-klassa-v-arhangelske_4.webp",
