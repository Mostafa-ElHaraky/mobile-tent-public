...
export const metadata: Metadata = {
  title: "Шатры представительского класса в Архангельске - Москва, Mobile Tent",
  description: "Шатры представительского класса в Архангельске - Москва, Mobile Tent",
...
export default function CardOurProjectsPage() {
  return (
<div className="flex flex-col w-full overflow-x-hidden overflow-y-visible">
      <OurProjects1 />
      <OurProjects2 />
      <OurProjects3 />
        <OurProjects4 />
