...
const hotelImages = [
  { id: 1, src: "/20-shater-dlya-otelya-baykalskaya-rezidenciya.webp",   alt: "Байкальская резиденция — общий вид шатра" },
  { id: 2, src: "/20-shater-dlya-otelya-baykalskaya-rezidenciya_0.webp", alt: "ПВХ-кровля с логотипом" },
  { id: 3, src: "/20-shater-dlya-otelya-baykalskaya-rezidenciya_1.webp", alt: "Алюминиевый каркас, узлы крепления" },
  { id: 4, src: "/20-shater-dlya-otelya-baykalskaya-rezidenciya_2.webp", alt: "Монтаж на площадке отеля" },
  { id: 5, src: "/20-shater-dlya-otelya-baykalskaya-rezidenciya_3.webp", alt: "Вид со стороны входа" },
];
