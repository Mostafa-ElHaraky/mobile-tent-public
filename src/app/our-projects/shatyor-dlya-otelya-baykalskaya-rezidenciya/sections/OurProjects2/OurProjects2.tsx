...
export const OurProjects2 = (): ReactElement => {
  ...
  const sectionPhotos: Record<typeof photoSections[number]['id'], string[]> = useMemo(() => ({
    "in-progress": [
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya.webp",
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya_0.webp",
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya_1.webp",
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya_2.webp",
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya_3.webp",
    ],
    "final": [
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya.webp",
      "/20-shater-dlya-otelya-baykalskaya-rezidenciya_0.webp",
