  ...
  "Привлекательный дизайн и цветовое решение",
            ...
            <div>
              ...
              <p className="text-sm text-[#394355] [font-family:'Raleway',Helvetica]">
                Нашей компанией был реализован проект по изготовлению и установке шатра 10х15 для ресторана в Абинске. Данная модель позволяет организовать кафе на открытом воздухе, провести конференцию, свадебное или юбилейное торжество. Не в сезон шатёр можно использовать в качестве складской площадки.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#394355] [font-family:'Raleway',Helvetica]">
                <li>Выполненный из анодированного алюминиевого профиля каркас выдерживает большую нагрузку.</li>
                <li>Двускатная крыша не задерживает возможные осадки.</li>
                <li>Тент из белой специализированной ткани ПВХ надёжно защитит от солнца и неблагоприятных погодных условий.</li>
                <li>В тканевых стенах предусмотрены декоративные арочные оконные проемы, через которые внутрь проникает достаточное количество света.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-[#394355] [font-family:'Raleway',Helvetica]">
                Тент можно использовать для размещения логотипов компании, рекламы услуг и товаров. Украшение его декоративными элементами праздничного мероприятия создаст соответствующее настроение отдыхающим.
              </p>
            </div>
          </section>
