...
export const OurProjects1 = (): ReactElement => {
  ...
  const hotelSpecs = [
    ...
    { label: "Тип проекта:", value: "Пагода шатры" },
  ];

  // 3) Right column info (keep template, just swap data to match the description)
  const additionalInfo = [
    { label: "Стены:", value: "Открытые" },
    { label: "Крепление:", value: "Бетонные утяжелители" },
  ];
      ...
      <div className="relative w-full min-h-[1539px] bg-[linear-gradient(180deg,#E8EEF8_0%,rgba(222,228,240,0)_100%)] hidden md:block">
        <div className="relative w-full max-w-[1440px] mx-auto">
          <section className="relative bottom-[135px] h-[1539px] rounded-[0px_0px_30px_30px]">
            ...
            <div className="relative bottom-[265px]">
              <Header />
            </div>
          </section>
        </div>
