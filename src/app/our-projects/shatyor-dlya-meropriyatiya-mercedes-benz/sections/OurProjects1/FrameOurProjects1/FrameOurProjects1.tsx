...
const hotelImages = [
  { id: 1, src: "/17-shater-dlya-meropriyatiya-mercedes-benz.webp",   alt: "Шатёр для мероприятия Mercedes-Benz — общий вид" },
  { id: 2, src: "/17-shater-dlya-meropriyatiya-mercedes-benz_0.webp", alt: "Г-образная конфигурация из 6 модулей" },
  { id: 3, src: "/17-shater-dlya-meropriyatiya-mercedes-benz_1.webp", alt: "Интерьер: столы и диваны, зона для гостей" },
  { id: 4, src: "/17-shater-dlya-meropriyatiya-mercedes-benz_2.webp", alt: "Напольное покрытие с имитацией газона" },
  { id: 5, src: "/17-shater-dlya-meropriyatiya-mercedes-benz_3.webp", alt: "Электроснабжение: плазменные телевизоры и оборудование" },
  { id: 6, src: "/17-shater-dlya-meropriyatiya-mercedes-benz_4.webp", alt: "Декор: напольные вазоны с растениями" },
];
