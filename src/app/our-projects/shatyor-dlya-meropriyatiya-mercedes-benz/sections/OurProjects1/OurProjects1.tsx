...
const hotelSpecs = [
  ...
  { label: "Тип проекта:", value: "Шатры для мероприятий" },
];

// 3) Right column (additionalInfo)
const additionalInfo = [
  { label: "Бренд:", value: "Mercedes-Benz" },
...
<section className="relative bottom-[135px] min-h-[1539px] overflow-visible rounded-[0px_0px_30px_30px]">
                        ...
                        <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                          <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                            <h1 className="w-[966px] font-medium text-4xl relative mt-[-1.00px] font-['Raleway',Helvetica] text-[#394355] tracking-[0] leading-[normal]">
                              Шатёр для мероприятия Mercedes-Benz
                            </h1>
                          </div>
                        </div>
                      </div>
            ...
            <div className="relative bottom-[325px]">
              <Header />
            </div>
          </section>
        </div>
        ...
        <div className="max-w-[440px] mx-auto w-full px-4 py-6">
          ...
          <section className="space-y-6 mb-6">
            ...
            <ul className="grid grid-cols-1 gap-2">
              {[
  "Регулируемая высота входной арки и стен",
  "ПВХ Ferrari Precontraint (французский материал)",
  "Прочный каркас из оцинкованной стали",
  "Ветровая нагрузка до 24 м/сек",
  "Высокий класс пожарной безопасности",
  "Напольное покрытие под газон",
  "Столы и диваны внутри; стойки и кресла-мешки снаружи",
  "Подведено электричество (TV и оборудование)",
  "Декор — напольные вазоны с растениями",
].map((t) => (
