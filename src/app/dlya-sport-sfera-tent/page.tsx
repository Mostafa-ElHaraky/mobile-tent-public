...
export const metadata: Metadata = {
  title: "Купить сферические спортивные шатры - выгодная цена, быстрая доставка от MOBILE TENT",
  description: "Сферические спортивные шатры для ваших мероприятий в MOBILE TENT. Надежные и качественные шатры для спорта по доступным ценам. Узнайте подробности и цены на нашем сайте!",
