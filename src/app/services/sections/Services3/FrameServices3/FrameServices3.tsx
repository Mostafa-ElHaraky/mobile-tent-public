...
export const FrameServices3 = (): ReactElement => {
  ...
  return (
    <>
      ...
      <section className="md:hidden flex flex-col items-center gap-6 w-full py-8 px-4">
        <div className="flex flex-col items-center gap-6 w-full">
          <div className="flex flex-col items-center gap-4 w-full text-left">
            <h2 className="text-2xl font-normal [font-family:'Raleway',Helvetica] tracking-[0]">
              <span className="font-medium text-[#232c42]">
                Делаем все, чтобы{" "}
              </span>
              <span className="font-bold text-[#527dc5]">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="relative w-5 h-5 flex-shrink-0">
                <CheckIcon className="absolute w-[18px] h-[14px] top-[3px] left-0.5 text-[#527dc5]" />
              </div>
              <p className="font-medium text-[#4f5d80]  text-base [font-family:'Raleway',Helvetica] tracking-[0] text-left">
                Выгодные условия сотрудничества
              </p>
            </div>
          </div>

          <Card className="w-full max-w-[320px] h-[100px] rounded-[20px] shadow-2 bg-[#527dc5] border-none">
            <CardContent className="p-0">
              <div className="flex flex-col items-center justify-center gap-2 h-full">
                <h3 className="font-bold text-white text-3xl [font-family:'Raleway',Helvetica] tracking-[0]">
                  800+ клиентов
                </h3>
                <p className="font-medium text-white text-sm text-center [font-family:'Raleway',Helvetica] tracking-[0]">
                  с 2012 года по России и странам СНГ
                </p>
              </div>
            </CardContent>
        ...
        <div className="grid grid-cols-1 gap-4 w-full">
          {businessCategories.map((category) => (
            <Card
              key={category.id}
              className="w-full h-[280px] bg-white rounded-[20px] border border-solid border-[#dddddd] shadow-[] backdrop-blur-[79px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(79px)_brightness(100%)] relative overflow-hidden"
            >
              <CardContent className="p-0 h-full">
                <div className="absolute w-full h-[160px] top-0 left-0 rounded-t-[20px] [background:linear-gradient(180deg,rgba(232,238,248,1)_0%,rgba(232,238,248,0)_100%)]" />
                ...
                <div className="relative w-full h-full flex flex-col items-center">
                  <div className="relative w-full h-[160px] flex justify-center items-center">
                    <Image
                      ...
                      alt={category.imageAlt}
                      src={category.imageSrc}
                      width={parseInt(category.imageWidth, 10) * 0.7}
                      height={parseInt(category.imageHeight, 10) * 0.7}
                      loading="lazy"
                    />
                  </div>

                  <div className="w-full px-4 pt-4 font-normal text-[#394355] text-sm text-center [font-family:'Raleway',Helvetica] tracking-[0]">
                    <span className="font-semibold">{category.title}</span>
