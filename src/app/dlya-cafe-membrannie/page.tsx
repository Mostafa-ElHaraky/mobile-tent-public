...
export const metadata: Metadata = {
  title: "Заказать мембранные шатры для кафе, ресторанов и торговых точек купить по доступной цене в MOBILE TENT",
  description: "Мембранные шатры для кафе, ресторанов, торговых точек купить с доставкой по РФ в компании MOBILE TENT. Недорого, с гарантией качества и эксклюзивными скидками. Закажите сейчас!",
