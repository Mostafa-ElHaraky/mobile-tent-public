...
export const metadata: Metadata = {
  title: "Классические шатры для спорта купить недорого по цене от производителя",
  description: "Купить классические спортивные шатры по оптимальной цене в компании MOBILE TENT. Доставим по всей России!",
