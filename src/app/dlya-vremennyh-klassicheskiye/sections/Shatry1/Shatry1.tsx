  ...
  return (
    <main className="relative w-full max-w-[1440px] bg-white mx-auto">
      ...
      <h1 className="absolute w-px h-px p-0 -m-px overflow-hidden whitespace-nowrap border-0">
        Для временных ангаров, гаражей, складов - классические шатры напрямую от производителя - MobilTent
      </h1>
                  ...
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    ...
                    <div className="w-[966px] font-medium text-[50px] leading-[normal] relative [font-family:'Raleway',Helvetica] tracking-[0]">
                      <span className="text-[#335dc2]">
                        ДЛЯ ВРЕМЕННЫХ АНГАРОВ, ГАРАЖЕЙ, СКЛАДОВ — КЛАССИЧЕСКИЕ ШАТРЫ
                      </span>
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <div className="flex flex-col items-start gap-3 w-full">
                  ...
                  <div className="w-full font-medium text-2xl sm:text-2xl text-left [font-family:'Raleway',Helvetica] leading-tight">
                    <span className="text-[#335dc2]">ДЛЯ ВРЕМЕННЫХ АНГАРОВ, ГАРАЖЕЙ, СКЛАДОВ — КЛАССИЧЕСКИЕ ШАТРЫ</span>
