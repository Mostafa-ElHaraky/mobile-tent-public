...
export const metadata: Metadata = {
  title: "Купить уличные зонты для выставок по оптимальной цене с доставкой от производителя",
  description: "Купить зонты уличные для выставок по цене производителя в каталоге MOBILE TENT. Быстрая доставка по стране и гарантии качества.",
