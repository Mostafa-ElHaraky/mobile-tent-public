...
export const metadata: Metadata = {
  title: "Купить сферические шатры для праздников по цене производителя от MOBILE TENT",
  description: "Организуете праздник или торжество? MOBILE TENT предлагает сферические шатры для незабываемой атмосферы. Купите шатры для торжеств по выгодным ценам. Узнайте цены и оформите заказ на сайте!",
