...
export const metadata: Metadata = {
  title: "Купить ангары для праздников и торжеств по выгодной цене",
  description: "Купить ангары для торжеств и праздников недорого с доставкой по РФ. Гарантия от производителя.",
