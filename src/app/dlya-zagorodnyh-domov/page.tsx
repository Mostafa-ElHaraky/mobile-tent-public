...
export const metadata: Metadata = {
  title: "Купить сферические шатры для загородного дома по выгодной цене от MOBILE TENT",
  description: "Сферические шатры – прочные, устойчивые, дизайнерские конструкции для загородного участка. Прочные и стильные сферические шатры для дачи и частного дома. Устойчивые конструкции, защита от непогоды, монтаж под ключ. Узнайте стоимость и закажите в Mobile Tent!",
