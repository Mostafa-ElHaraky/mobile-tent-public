...
export const metadata: Metadata = {
  title: "Заказать перголы для спортивных мероприятий недорого по ценам производителя",
  description: "Купить перголы для спортивно-массовых мероприятий по цене производителя. Широкий ассортимент, быстрая доставка.",
