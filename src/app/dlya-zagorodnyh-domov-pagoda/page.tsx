...
export const metadata: Metadata = {
  title: "Купить шатры пагода для загородного дома по доступной цене с доставкой в Mobile Tent",
  description: "Шатры-пагоды для загородного дома и мероприятий на даче. Надежная конструкция, разнообразие моделей, выгодные цены. Оформите заказ в Mobile Tent!",
