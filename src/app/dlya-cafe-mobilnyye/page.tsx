...
export const metadata: Metadata = {
  title: "Купить мобильные шатры для кафе, ресторанов, торговых точек недорого",
  description: "Заказать мобильные шатры для кафе, ресторанов и торговых точек недорого в MOBILE TENT. Быстрая доставка по России! Гарантированное качество, выгодные скидки и акции.",
