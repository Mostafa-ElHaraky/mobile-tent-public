...
export const metadata: Metadata = {
  title: "Купить шатры пагода для спорта по ценам производителя",
  description: "Ищете шатры Пагода для спорта? Купите спортивные шатры пагода по доступным ценам в MOBILE TENT. Качественные решения для ваших спортивных мероприятий. Узнайте цены и оформите заказ на сайте!",
