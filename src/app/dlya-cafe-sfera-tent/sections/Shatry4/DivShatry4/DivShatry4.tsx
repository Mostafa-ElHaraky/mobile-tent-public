...
export const DivShatry4 = (): ReactElement => {
  ...
  // Data for the service cards (adapted for spherical tents)
  const serviceCards = [
    { title: "Компания", content: "MOBILE TENT" },
    { title: "Тип шатра", content: "Сферический" },
    { title: "Срок изготовления", content: "от 14 дней" },
    { title: "Площадь", content: "до 250 м²" },
  ];

  // “Сделали” section items – adapted for spherical tents
  const accomplishments = [
    "Разработали дизайн и конфигурацию сферического шатра под требования площадки.",
    "Изготовили купольную конструкцию, подготовили к отгрузке, согласовали логистику.",
    "Выполнили доставку и монтаж сферического шатра, оформили пространство и провели инструктаж.",
  ];

  // About company (specialization in spherical tents)
  const aboutCompany = {
    title: "Наша специализация – сферические шатры",
    paragraphs: [
      "Основная специализация компании «MOBILE TENT» — изготовление сферических (купольных) шатров на заказ. Мы помогаем организовывать мероприятия на свежем воздухе любого масштаба — от уютных встреч в кафе до крупных свадеб — и надёжно защищаем их от ветра и непогоды.",
      "В столице достаточно компаний, но немногие берут на себя высокий уровень сервиса и комплексный подход именно к сферическим конструкциям. У нас можно не только выгодно купить сферический шатёр, но и получить полный цикл сопутствующих услуг, чтобы упростить организацию мероприятия.",
      "Изготовление и продажа купольных шатров — наша основа, но мы предлагаем куда больше."
    ]
  };

  // Preview images (keep as is – they show spherical tents)
  const previewImages = [
    "/spher26,3.webp",
    "/spher26,2.webp",
    "/spher5.webp",
  ...
  return (
    <>
      {/* Desktop Version */}
      <section
        aria-label="Кейсы и услуги MOBILE TENT – сферические шатры"
        ...
        <div className="flex flex-col md:flex-row gap-12 ml-8">
          ...
          <div className="flex flex-col gap-[60px]">
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-6">
                ...
                <h2 className="w-[528px] [font-family:'Raleway',Helvetica] text-4xl leading-normal">
                  ...
                  <span className="font-bold text-[#527dc5]">сферическими шатрами</span>
                </h2>
              </div>

              <p className="w-[496px] font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
                «До этого был обычный шатёр из китайской ткани — через год испортился внешний вид. Ваш сферический шатёр заметно лучше выглядит и привлекает посетителей».
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                  Организовать быстромонтируемое сферическое покрытие на открытой площадке с учётом брендинга,
            ...
            <div className="flex items-center gap-[33px] mt-12">
              ...
              >
                <Image
                  className="relative w-[86px] h-[62px] mt-[-54px] mb-[-62px] ml-[-18px] backdrop-blur-[79px] object-contain group-hover:scale-105 transition-transform"
          ...
          <div className="flex flex-col">
            ...
            <div
              ...
              role="listbox"
              aria-label="Превью фотографий сферических шатров"
            >
              {previewImages.map((image, index) => {
                ...
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото сферического шатра ${index + 1}`}
                  ...
                  >
                    <div className="relative w-full h-full">
                      <Image
                        src={image}
                        alt={`Превью сферического шатра ${index + 1}`}
            ...
            <div className="relative w-full">
              <div
                ...
                role="region"
                aria-live="polite"
                aria-label={`Главное фото сферического шатра ${currentImageIndex + 1} из ${previewImages.length}`}
              >
                <Image
                  src={previewImages[currentImageIndex]}
                  alt="Главное фото сферического шатра"
                  className="object-contain"
                  fill
                  priority
                />
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
              «До этого был обычный шатёр из китайской ткани — через год внешний вид ухудшился. Ваш сферический шатёр выглядит лучше и привлекает гостей».
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                Подготовить сферическую шатровую инфраструктуру под площадку и бренд с быстрым монтажом и понятной эксплуатацией.
              </p>
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Image
                className="relative w-[60px] h-[45px] backdrop-blur-[79px] object-contain group-hover:scale-105 transition-transform"
