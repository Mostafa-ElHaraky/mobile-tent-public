...
export const Shatry1 = ({ seoH1 }: Shatry1Props): ReactElement => {
  ...
  const guaranteeItems = [
    ...
    const defaultH1 = "СФЕРИЧЕСКИЕ ШАТРЫ ДЛЯ КАФЕ, РЕСТОРАНОВ, ТОРГОВЫХ ТОЧЕК В МОСКВЕ";
                  ...
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    ...
                    <div className="w-[966px] font-medium text-[50px] leading-[normal] relative [font-family:'Raleway',Helvetica] tracking-[0]" role="heading" aria-level={2}>
                      <span className="text-[#335dc2]">
                        СФЕРИЧЕСКИЕ ШАТРЫ ДЛЯ КАФЕ, РЕСТОРАНОВ, ТОРГОВЫХ ТОЧЕК В МОСКВЕ
                      </span>
...
<div className="relative top-[733px] left-[500px] z-30">
  <Button
    variant="outline"
    onClick={openPopup}
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <div className="flex flex-col items-start gap-3 w-full">
                  ...
                  <div className="w-full font-medium text-2xl sm:text-2xl text-left [font-family:'Raleway',Helvetica] leading-tight" role="heading" aria-level={2}>
                    <span className="text-[#335dc2]">СФЕРИЧЕСКИЕ ШАТРЫ ДЛЯ КАФЕ, РЕСТОРАНОВ, ТОРГОВЫХ ТОЧЕК В МОСКВЕ</span>
