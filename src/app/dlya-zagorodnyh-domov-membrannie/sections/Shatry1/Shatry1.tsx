...
export const Shatry1 = (): ReactElement => {
  ...
  return (
    <main className="relative w-full max-w-[1440px] bg-white mx-auto">
      {/* Single SEO-optimized H1 tag - positioned for accessibility but visually hidden */}
      <h1 className="sr-only">
        Договечные тентовые конструкции для загородного дома, дачи, отдыха - мембранные шатры напрямую от производителя с гарантией сохранения внешнего вида в течении 15 лет при любой погоде
      </h1>
              ...
              <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto]">
                <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    ...
                    {/* Desktop visual heading - now as h2 for proper hierarchy */}
                    <h2 className="w-[966px] font-medium text-[50px] leading-[normal] relative [font-family:'Raleway',Helvetica] tracking-[0]">
                      <span className="text-[#335dc2]">
                        ДЛЯ ЗАГОРОДНОГО ДОМА, ДАЧИ, ОТДЫХА — МЕМБРАННЫЕ ШАТРЫ
                      </span>
...
<div className="relative top-[675px] left-[500px] z-30">
  <Button
    variant="outline"
    onClick={openPopup}
            ...
            <div className="flex flex-col items-start gap-6">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <div className="flex flex-col items-start gap-3 w-full">
                  ...
                  {/* Mobile visual heading - now as h2 for proper hierarchy */}
                  <h2 className="w-full font-medium text-2xl sm:text-2xl text-left [font-family:'Raleway',Helvetica] leading-tight">
                    <span className="text-[#335dc2]">ДЛЯ ЗАГОРОДНОГО ДОМА, ДАЧИ, ОТДЫХА — МЕМБРАННЫЕ ШАТРЫ</span>
