...
export const metadata: Metadata = {
  title: "Купить мембранный шатер для частного дома с гарантией и доставкой в Mobile Tent",
  description: "Мембранные шатры – легкие, прочные и стильные конструкции для загородного дома. Долговечные материалы, защита от солнца и дождя. Узнайте цены и оформите заказ в Mobile Tent!",
