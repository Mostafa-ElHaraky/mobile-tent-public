...
export const metadata: Metadata = {
  title: "Купить шестигранные гексагональные шатры для загородного частного дома по лучшей цене с доставкой",
  description: "Заказать гексагональные шатры для загородного дома недорого от производителя MOBILE TENT. Доставка по РФ. Скидки. Акции.",
