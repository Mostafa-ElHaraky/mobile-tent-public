...
export const metadata: Metadata = {
  title: "Зонты для кафе и ресторанов уличные купить по цене производителя MOBILE TENT",
  description: "Заказать летние уличные зонты для кафе и ресторанов недорого от производителя MOBILE TENT. Большие зонты для летних площадок кафе с доставкой по России.",
