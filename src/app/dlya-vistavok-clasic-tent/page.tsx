...
export const metadata: Metadata = {
  title: "Купить классические шатры для выставок по выгодной цене в MOBILE TENT",
  description: "Купить классические шатры для выставок по доступным ценам. Широкий ассортимент классических шатров для выставок различных размеров и дизайнов. Узнайте подробности и получите консультацию на Mobile Tent.",
