...
export const metadata: Metadata = {
  title: "Купить перголы для загородного дома с доставкой  и установкой в MOBILE TENT",
  description: "Перголы для загородного участка и дачи – стильный навес от солнца и осадков. Деревянные и металлические модели, монтаж. Оформите заказ с доставкой в Mobile Tent!",
