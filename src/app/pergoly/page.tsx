...
export const metadata: Metadata = {
  title: "Перголы в Москве и России - купить шатры перголы по оптимальной цене на сайте Mobile-Tent.Ru",
  description: "Купить перголы в Москве разных конструкций для любых мероприятий. Заказать перголы по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
