...
export const metadata: Metadata = {
  title: "Купить перголу для выставки - выгодные цены от MOBILE TENT",
  description: "Перголы для выставок от MOBILE TENT. Стильные и прочные конструкции для различных мероприятий. Узнайте цены и купите перголу для вашей выставки.",
