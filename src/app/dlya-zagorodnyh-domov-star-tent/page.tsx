...
export const metadata: Metadata = {
  title: "Купить шатры «Звезда» для загородного дома по доступной цене у производителя MOBILE TENT",
  description: "Заказать шатры звезда для загородного дома по цене производителя MOBILE TENT с доставкой по РФ.  Шатры «Звезда» – прочные конструкции для отдыха на открытом воздухе. Варианты для частных домов и мероприятий. Закажите шатер по выгодной цене в Mobile Tent!",
