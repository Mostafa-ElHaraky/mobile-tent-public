...
export const metadata: Metadata = {
  title: "Купить шатры звезда для торжеств по цене производителя от MOBILE TENT",
  description: "Купить шатры Звезда для праздников по лучшим ценам на Mobile Tent. Различные размеры и дизайны шатров Звезда для любых мероприятий. Закажите шатер Звезда на Mobile Tent и получите консультацию.",
