...
export const metadata: Metadata = {
  title: "Купить мобильные шатры для спорта недорого по цене производителя",
  description: "Купить мобильные шатры для спортивно-массовых мероприятий по ценам производителя. Гарантии, скидки. Доставляем по всей территории РФ.",
