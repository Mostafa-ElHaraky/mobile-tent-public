...
export const DivWrapperShatry5 = (): ReactElement => {
  ...
  const handleWhatsAppClick = () => {
    window.open('https://api.whatsapp.com/send/?phone=79805109568', '_blank');
  };
...
<div className="mt-4 relative h-[250px]"> {/* زيادة الارتفاع لاستيعاب الحركة */}
  <Image
    ...
    style={{
      maxWidth: 'none',
      right: '48px',   // حركة لليمين (قيمة سالبة تدفعها خارج الحاوية)
      bottom: '48px',  // حركة للأسفل (قيمة سالبة تدفعها خارج الحاوية)
      transform: 'scale(1.25) translateX(10px) translateY(15px)' // تكبير + تحريك إضافي
    }}
    loading="lazy"
  />
</div>
