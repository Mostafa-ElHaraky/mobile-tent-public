...
export const metadata: Metadata = {
  title: "Купить шатры Звезда для спорта по оптимальной стоимости в MOBILE TENT",
  description: "Купить шатры Звезда для спортивно-массовых мероприятий по доступной стоимости в компании MOBILE TENT. Доставка по России от 2х дней.",
