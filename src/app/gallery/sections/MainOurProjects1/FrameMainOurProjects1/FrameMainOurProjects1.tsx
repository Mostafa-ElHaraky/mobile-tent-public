    ...
    <div className="relative w-full min-h-screen py-8 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="hidden md:block mt-[250px] relative bottom-[250px]">
          ...
          <h5 className="text-3xl md:text-4xl font-bold text-[#232c42] mb-8">Наши проекты</h5>
        ...
        <div className="block md:hidden">
          <h5 className="text-2xl font-bold text-[#232c42] mb-6">Наши проекты</h5>
