...
export const metadata: Metadata = {
  title: "Сферические шатры для выставок – купить по выгодной цене от MOBILE TENT",
  description: "MOBILE TENT предлагает купить сферический шатер для выставки. Идеальное решение для презентаций и выставочных мероприятий. Качественные шатры по доступным ценам. Подробности и цены на нашем сайте!",
