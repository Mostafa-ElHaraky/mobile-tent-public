...
export const metadata: Metadata = {
  title: "Купить натяжной шатер для выставки по цене от MOBILE TENT",
  description: "Натяжные шатры для выставок от MOBILE TENT. Высококачественные материалы и современный дизайн. Узнайте цены и купите натяжной шатер для вашего мероприятия.",
