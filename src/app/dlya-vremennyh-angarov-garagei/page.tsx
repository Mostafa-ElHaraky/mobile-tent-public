...
export const metadata: Metadata = {
  title: "Купить быстровозводимый тентовый склад и тенты для навеса в Москве: цены на мобильные ангары",
  description: "Быстровозводимый склад в Москве от производителя Mobile-Tent. Вы можете купить тент для навеса, тентовый склад или мобильный ангар под заказ по вашему индивидуальному проекту с брендированием и логотипом компании.  Оптовым покупателям – скидки!",
