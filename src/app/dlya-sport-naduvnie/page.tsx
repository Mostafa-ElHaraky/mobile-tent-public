...
export const metadata: Metadata = {
  title: "Надувные шатры для спортивных мероприятий купить по оптимальной цене",
  description: "Заказать надувные шатры для спорта недорого у производителя MOBILE TENT.Доставка, гарантия, скидки!",
