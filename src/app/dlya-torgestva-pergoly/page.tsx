...
export const metadata: Metadata = {
  title: "Купить перголы для праздников и торжеств по цене производителя  от MOBILE TENT",
  description: "Ищете перголы для праздников? У нас можно купить перголы для торжеств различных стилей и размеров. Создайте идеальное пространство для вашего мероприятия. Быстрая доставка и отличные цены на сайте Mobile-Tent.",
