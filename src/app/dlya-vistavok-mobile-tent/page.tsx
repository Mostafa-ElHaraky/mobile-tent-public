...
export const metadata: Metadata = {
  title: "Купить мобильный шатер для выставки по выгодным ценам в MOBILE TENT",
  description: "Мобильные шатры для выставок от MOBILE TENT. Быстрая установка, удобство и надежность. Ознакомьтесь с ценами и выберите мобильный шатер для вашего мероприятия.",
