...
export const metadata: Metadata = {
  title: "Купить шестигранные шатры для праздников и торжеств по цене производителя от MOBILE TENT",
  description: "Купите шестигранные шатры для праздников по лучшим ценам на Mobile Tent. Большой выбор шатров для торжеств различных размеров и дизайнов. Получите консультацию и узнайте подробности.",
