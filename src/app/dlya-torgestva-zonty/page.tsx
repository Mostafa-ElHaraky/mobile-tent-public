...
export const metadata: Metadata = {
  title: "Зонты уличные для праздников и торжеств купить по цене производителя от MOBILE TENT",
  description: "Ищете идеальные зонты уличные для праздников? У нас можно купить зонты уличные для торжеств любых размеров и дизайнов. Надежная защита от солнца и дождя для ваших мероприятий. Быстрая доставка и отличные цены на сайте Mobile-Tent.",
