...
export const metadata: Metadata = {
  title: "Купить натяжные шатры для загородных домов по цене производителя с доставкой в Mobile Tent",
  description: "Современные натяжные шатры для загородных домов  и мероприятий на природе. Надежные материалы, стильный дизайн, доступные цены. Быстрая доставка, установка, большой выбор моделей.",
