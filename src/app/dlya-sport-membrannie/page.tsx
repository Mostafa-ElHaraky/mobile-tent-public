...
export const metadata: Metadata = {
  title: "Купить мембранные шатры для спорта по выгодной цене с доставкой",
  description: "Купить мембранные шатры для спортивно-массовых мероприятий недорого в MOBILE TENT. Доставляем по России. Гарантируем лучшее качество!",
