...
export const metadata: Metadata = {
  title: "Купить  классические шатры для праздников и торжеств по цене производителя от MOBILE TENT",
  description: "Купите классические шатры для праздников по лучшим ценам на Mobile Tent. Широкий ассортимент классических шатров для торжеств различных размеров и дизайнов. Получите консультацию и узнайте подробности.",
