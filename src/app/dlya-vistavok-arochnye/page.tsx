...
export const metadata: Metadata = {
  title: "Купить арочные шатры для выставок на Mobile Tent. Выгодные цены",
  description: "Купить арочные шатры для выставок по выгодным ценам. Большой выбор арочных шатров для выставок различных размеров и дизайнов. Узнайте цены и получите консультацию на Mobile Tent.",
