...
export const metadata: Metadata = {
  title: "Купить классические шатры для загородного дома по ценам производителя с доставкой в Mobile Tent",
  description: "Надежные классические шатры для загородного дома и дачи. Прочные материалы, стильный дизайн, защита от солнца и дождя. Цены от производителя, доставка по России!",
