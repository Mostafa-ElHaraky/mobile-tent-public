...
export const metadata: Metadata = {
  title: "Гексагональные тенты-шатры для кафе, ресторанов, торговых точек заказать по выгодной цене в России",
  description: "Купить гексагональные тенты шатры для кафе, ресторанов, торговых точек по лучшим ценам в MOBILE TENT. Недорого, с доставкой по России. Специальные скидки, гарантии качества.",
