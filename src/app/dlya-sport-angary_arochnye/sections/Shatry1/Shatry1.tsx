  ...
  return (
    <>
      ...
      <h1 className="sr-only">
        Арочные ангары для спортивно-массовых мероприятий в Москве напрямую от производителя MobilTent с гарантией сохранения внешнего вида в течении 15 лет
      </h1>
      ...
      <main className="relative w-full max-w-[1440px] h-[1081px] bg-white mx-auto hidden md:block">
        <section className="relative isolate h-[1081px] rounded-[0px_0px_30px_30px]">
                ...
                <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    ...
                    <div className="w-[966px] font-medium text-[50px] leading-[normal] relative [font-family:'Raleway',Helvetica] tracking-[0]" role="heading" aria-level={2}>
                      <span className="text-[#335dc2] mr-2">АРОЧНЫЕ АНГАРЫ ДЛЯ СПОРТИВНО-МАССОВЫХ МЕРОПРИЯТИЙ В МОСКВЕ</span>
          ...
          <div className="relative top-[735px] left-[500px]">
            <Button
              variant="outline"
              onClick={openPopup}
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <div className="flex flex-col items-start gap-3 w-full">
                  ...
                  <div className="w-full font-medium text-xl sm:text-2xl text-left [font-family:'Raleway',Helvetica] leading-tight" role="heading" aria-level={2}>
                    <span className="text-[#335dc2]">АРОЧНЫЕ АНГАРЫ ДЛЯ СПОРТИВНО-МАССОВЫХ МЕРОПРИЯТИЙ В МОСКВЕ</span>
