...
export const metadata: Metadata = {
  title: "Купить арочные ангары для спорта по выгодной стоимости",
  description: "Заказ спортивных арочных ангаров недорого у производителя MOBILE TENT. Доставка по России, выгодные скидки и акции. Гарантии качества.",
  // Optional: Add Open Graph tags
  openGraph: {
  title: "Ангары для спорта купить недорого с доставкой по России",
  description: "Заказать спортивные ангары в компании в MOBILE TENT. Оптимальные цены, доставка по всей России. Гарантии качества, скидки и акции ждут вас.",
  },
};
