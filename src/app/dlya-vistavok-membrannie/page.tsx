...
export const metadata: Metadata = {
  title: "Купить мембранный шатер для выставки по доступным ценам от MOBILE TENT",
  description: "Мембранные шатры для выставок от MOBILE TENT. Устойчивые к погодным условиям и стильные шатры. Узнайте цены и закажите мембранный шатер для вашего мероприятия.",
