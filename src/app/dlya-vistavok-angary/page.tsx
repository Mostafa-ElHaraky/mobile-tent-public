...
export const metadata: Metadata = {
  title: "Купить ангары для выставки по выгодным ценам на Mobile Tent",
  description: "Купите ангары для выставок по на Mobile Tent. Большой выбор ангаров различных размеров и конфигураций для любых выставок. Получите консультацию и узнайте подробности.",
