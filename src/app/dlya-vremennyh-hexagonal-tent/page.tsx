...
export const metadata: Metadata = {
  title: "Купить гексагональные тенты для временных ангаров по лучшей цене с доставкой от производителя",
  description: "Заказать гексагональные тенты для временных ангаров недорого в компании MOBILE TENT. Доставим быстро по всей стране!",
