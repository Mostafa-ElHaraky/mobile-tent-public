...
export const metadata: Metadata = {
  title: "Шатры для свадьбы купить по доступной цене в MOBILE TENT - шатер большой для свадьбы недорого",
  description: "Купить шатры для свадьбы в Москве разных конструкций для любых мероприятий. Заказать шатры для свадьбы по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
