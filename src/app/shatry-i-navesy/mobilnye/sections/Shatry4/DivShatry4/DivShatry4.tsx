...
export const DivShatry4 = (): ReactElement => {
  ...
  // Data for the service cards – adapted for mobile tents
  const serviceCards = [
    { title: "Компания", content: "MOBILE TENT" },
    { title: "Тип шатра", content: "Мобильный" },
    { title: "Срок изготовления", content: "от 7 дней" },
    { title: "Площадь", content: "до 250 м²" },
  ];

  // “Сделали” section items – adapted for mobile tents
  const accomplishments = [
    "Разработали дизайн и конфигурацию мобильного шатра под требования площадки и быструю сборку.",
    "Изготовили портативную конструкцию, подготовили к отгрузке, согласовали логистику.",
    "Выполнили доставку и монтаж мобильного шатра, оформили пространство и провели инструктаж.",
  ];

  // About company – specialization in mobile tents
  const aboutCompany = {
    title: "Наша специализация – мобильные шатры",
    paragraphs: [
      "Основная специализация компании «MOBILE TENT» — изготовление мобильных быстросборных шатров на заказ. Мы помогаем организовывать мероприятия на свежем воздухе любого масштаба — от деловых встреч до свадеб — и надёжно защищаем их от ветра и непогоды.",
      "В столице достаточно компаний, но немногие берут на себя высокий уровень сервиса и комплексный подход именно к мобильным конструкциям. У нас можно не только выгодно купить мобильный шатёр, но и получить полный цикл сопутствующих услуг, чтобы упростить организацию мероприятия.",
      "Изготовление и продажа портативных шатров — наша основа, но мы предлагаем куда больше."
    ]
  };

  // Preview images for mobile tents
  const previewImages = [
    "/mobilny1.webp",
    "/mobilny4.webp",
    "/mobilny5.webp",
  ...
  return (
    <>
      {/* Desktop Version */}
      <section
        aria-label="Кейсы и услуги MOBILE TENT – мобильные шатры"
        ...
        <div className="flex flex-col md:flex-row gap-12 ml-8">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-6">
                ...
                <h2 className="w-[528px] [font-family:'Raleway',Helvetica] text-4xl leading-normal">
                  ...
                  <span className="font-bold text-[#527dc5]">мобильными шатрами</span>
                </h2>
              </div>

              <p className="w-[496px] font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
                «До этого был обычный шатёр из китайской ткани — через год испортился внешний вид. Ваш мобильный шатёр заметно лучше выглядит и легко собирается».
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                  Организовать быстромонтируемое мобильное покрытие на открытой площадке с учётом брендинга,
          ...
          <div className="flex flex-col">
            ...
            <div
              ...
              role="listbox"
              aria-label="Превью фотографий мобильных шатров"
            >
              {previewImages.map((image, index) => {
                ...
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото мобильного шатра ${index + 1}`}
                  ...
                  >
                    <div className="relative w-full h-full">
                      <Image
                        src={image}
                        alt={`Превью мобильного шатра ${index + 1}`}
            ...
            <div className="relative w-full">
              <div
                ...
                role="region"
                aria-live="polite"
                aria-label={`Главное фото мобильного шатра ${currentImageIndex + 1} из ${previewImages.length}`}
              >
                <Image
                  src={previewImages[currentImageIndex]}
                  alt="Главное фото мобильного шатра"
                  className="object-contain"
                  fill
                  priority
                />
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
              «До этого был обычный шатёр из китайской ткани — через год внешний вид ухудшился. Ваш мобильный шатёр выглядит лучше и быстро собирается».
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                Подготовить мобильную шатровую инфраструктуру под площадку и бренд с быстрым монтажом и понятной эксплуатацией.
              </p>
            </div>
