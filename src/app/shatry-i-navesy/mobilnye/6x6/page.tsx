...
export const metadata: Metadata = {
  title: "Мобильные шатры 6х6 м в Москве:  заказать навесы и тенты 6х6 метров по лучшим ценам",
  description: "Мобильные шатры 6х6 метров в Москве. Компания Mobile Tent предлагает вашему вниманию подробный каталог тентов 6х6 с ценами, ассортиментом расцветок, дизайнов и размеров. Доставка по всей России!",
