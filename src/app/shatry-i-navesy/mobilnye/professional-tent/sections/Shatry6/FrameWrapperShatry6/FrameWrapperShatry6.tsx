...
export const FrameWrapperShatry6 = (): ReactElement => {
    ...
    <>
      ...
      <section className="md:hidden flex flex-col items-start gap-6 w-full py-8 px-4">
        <div className="flex flex-col items-start gap-6 w-full">
          ...
          <Card className="w-full h-[100px] rounded-[20px] shadow-2 bg-[#527dc5] border-none">
            <CardContent className="p-0">
          ...
          {businessCategories.map((category) => (
            ...
            >
              <CardContent className="p-0 h-full flex flex-col items-center pb-6">
                {/* منطقة تكبير الصورة - يمكنك تعديل الأرقام هنا */}
                <div className="w-full h-[250px] relative flex justify-center items-center rounded-t-[20px] [background:linear-gradient(180deg,rgba(232,238,248,1)_0%,rgba(232,238,248,0)_100%)]">
                  <div className="relative w-full h-full flex justify-center">
                    <Image
                      ...
                      alt={category.imageAlt}
                      src={category.imageSrc}
                      // هنا يمكنك تغيير نسبة التكبير (1 = الحجم الأصلي)
                      width={parseInt(category.imageWidth, 10) * 1} // تم التغيير من 0.7 إلى 1
                      height={parseInt(category.imageHeight, 10) * 1} // تم التغيير من 0.7 إلى 1
                      style={{
                        maxWidth: '95%', // تم التغيير من 70% إلى 95%
                        height: 'auto',
                        // لإزالة الحد الأقصى للإرتفاع أضف:
                        // maxHeight: 'none'
                      }}
                    />
                  </div>
                ...
                {/* منطقة النص - تتعدل تلقائياً مع حجم الصورة */}
