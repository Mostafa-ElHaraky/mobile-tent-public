...
export const metadata: Metadata = {
  title: "Мобильные шатры Professional | Mobile Tent",
  description: "Купить мобильные шатры Professional в Москве разных конструкций для любых мероприятий. Заказать мобильные шатры Professional по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
