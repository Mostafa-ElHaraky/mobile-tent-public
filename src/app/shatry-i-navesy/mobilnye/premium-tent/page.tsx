...
export const metadata: Metadata = {
  title: "Мобильные шатры Slim Prof | Mobile Tent",
  description: "Купить мобильные шатры Slim Prof в Москве разных конструкций для любых мероприятий. Заказать мобильные шатры Slim Prof по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
