...
export const metadata: Metadata = {
  title: "Мобильные шатры Hard professional | Mobile Tent",
  description: "Купить мобильные шатры Hard professional в Москве разных конструкций для любых мероприятий. Заказать мобильные шатры Hard professional по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
