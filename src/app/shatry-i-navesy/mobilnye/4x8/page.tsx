...
export const metadata: Metadata = {
  title: "Мобильные шатры 4х8 м - заказать недорого с доставкой по России в MOBILE TENT",
  description: "Предлагаем купить мобильные шатры размером 4х8 метров для мероприятий. Продажа тентовых конструкций высокого качества. Доставка по России.",
