...
export const metadata: Metadata = {
  title: "Готовые торговые павильоны | Mobile Tent",
  description: "Пристенные павильоны из сэндвич панелей от производителя Мобайл Тент. Доступные цены. Гарантия качества. Доставка по всей территории России",
