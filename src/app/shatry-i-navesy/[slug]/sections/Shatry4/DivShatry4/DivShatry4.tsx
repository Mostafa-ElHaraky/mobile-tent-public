...
interface DivShatry4Props {
  previewImages?: string[];
}

export const DivShatry4 = ({ previewImages = [] }: DivShatry4Props): ReactElement => {
  const router = useRouter();
  
  // Default preview images (fallback)
  ...
  const images = previewImages.length > 0 ? previewImages : defaultPreviewImages;
          ...
          <div className="flex flex-col">
            ...
            <div className="relative w-full">
              <div
                ...
                role="region"
                aria-live="polite"
                aria-label={`Главное фото ${currentImageIndex + 1} из ${images.length}`}
              >
                <Image
