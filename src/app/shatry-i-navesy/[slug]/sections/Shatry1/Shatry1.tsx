...
interface Shatry1Props {
  seoH1?: string;
  heroText?: string;
  breadcrumbTitle?: string;  // Add breadcrumb title prop
  breadcrumbSlug?: string;   // Add breadcrumb slug prop
}

export const Shatry1 = ({ 
  seoH1, 
  heroText,
  breadcrumbTitle,
  breadcrumbSlug
}: Shatry1Props): ReactElement => {
  ...
  const defaultH1 = "Арочные шатры в Москве напрямую от производителя";
  const h1Text = seoH1 || defaultH1;
  
  // Use heroText prop or fallback to default
  const defaultHeroText = "АРОЧНЫЕ ШАТРЫ В МОСКВЕ";
  const displayHeroText = heroText || defaultHeroText;

  // Breadcrumb display title
  const displayBreadcrumbTitle = breadcrumbTitle || "Арочные шатры";
  const breadcrumbPath = breadcrumbSlug || "arochnye";
  ...
  return (
    <main className="relative w-full max-w-[1440px] bg-white mx-auto">
      ...
      <div className="hidden desktop:block absolute top-[20px] left-12 z-20">
      ...
      {/* Breadcrumbs - Mobile */}
      <div className="block desktop:hidden absolute top-[80px] left-4 right-4 z-20">
        <nav className="flex items-center gap-1 text-xs text-gray-600 [font-family:'Raleway',Helvetica] overflow-x-auto whitespace-nowrap pb-1">
          <Link href="/" className="hover:text-[#335dc2] transition-colors">
            Главная
          </Link>
          <span className="text-gray-400">/</span>
          <Link href="/shatry-i-navesy" className="hover:text-[#335dc2] transition-colors">
            Шатры и навесы
          </Link>
          <span className="text-gray-400">/</span>
          <span className="text-[#335dc2] font-medium">
      ...
      <div className="hidden desktop:block">
        <section className="relative h-[1081px] rounded-[0px_0px_30px_30px]">
              ...
              <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto]">
                <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    ...
                    {/* Desktop visual heading - now dynamic with heroText prop */}
          ...
          <div className="relative top-[610px] left-[500px] z-30">
            <Button
              variant="outline"
              onClick={openPopup}
            ...
            <div className="flex flex-col items-start gap-6">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                <div className="flex flex-col items-start gap-3 w-full">
                  ...
                  {/* Mobile visual heading - now dynamic with heroText prop */}
                  <div className="w-full font-medium text-2xl sm:text-2xl text-left [font-family:'Raleway',Helvetica] leading-tight" role="heading" aria-level={2}>
                    <span className="text-[#335dc2]">{displayHeroText}</span>
