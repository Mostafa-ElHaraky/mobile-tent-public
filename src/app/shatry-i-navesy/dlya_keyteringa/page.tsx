...
export const metadata: Metadata = {
  title: "Желаете купить шатры для кейтеринга? | Mobile Tent",
  description: "Компания Мобайл Тент предлагает купить качественные шатры и тенты для кейтеринга.  Доступные цены. Доставка по всей территории России. Обращайтесь!",
