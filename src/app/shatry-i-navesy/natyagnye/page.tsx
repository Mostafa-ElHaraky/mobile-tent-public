...
export const metadata: Metadata = {
  title: "Купить натяжные шатры в Москве и России по лучшей стоимости на Mobile-Tent.ru",
  description: "Купить натяжные шатры в Москве и России. Заказать натяжные шатры по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 499 325 87 05.",
