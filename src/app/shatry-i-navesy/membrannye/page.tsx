...
export const metadata: Metadata = {
  title: "Купить мембранные шатры и навесы по лучшей цене от производителя",
  description: "Купить мембранные шатры в Москве и России. Заказать мембранные шатры по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 499 325 87 05.",
