...
async function getArochnyeData() {
  try {
    const response = await fetch('page.php?code=karkasno-tentovye-angary-tip-v', {
    ...
    // Return default values if API fails – ENHANCED FOR КАРКАСНЫЙ ТЕНТОВЫЙ АНГАР ТИП В
    return {
      success: false,
      seo: {
        title: "Каркасные тентовые ангары тип В купить в Москве | Производство Mobile Tent",
        description: "Купить каркасный тентовый ангар тип В от производителя Mobile Tent. Цены, размеры от 6 до 40 метров. Доставка по Москве, МО и всей России. Звоните: +7 (495) 760-42-20.",
        h1: "Каркасные тентовые ангары тип В – напрямую от производителя в Москве и Московской области",
        keywords: "каркасный тентовый ангар тип в, купить ангар тип в, тентовый ангар тип в цена, каркасный ангар тип в москва, производство ангаров тип в, ангар тентовый каркасный, тентовые ангары тип в от производителя",
        url: "https://mobile-tent.ru/shatry-i-navesy/karkasno-tentovye-angary-tip-v"
      },
      content: {
        desktop: '',
        mobile: ''
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonicalUrl = 'https://mobile-tent.ru/shatry-i-navesy/karkasno-tentovye-angary-tip-v';
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Каркасный тентовый ангар тип В от производителя MOBILE TENT'
        }
      ],
    },
    robots: {
...
export default async function ArochnyePage() {
  ...
  const localBusinessSchema = {
    ...
    "priceRange": "₽₽",
    "description": pageData.seo?.description || "Купить каркасный тентовый ангар тип В от производителя Mobile Tent. Цены, размеры от 6 до 40 метров. Доставка по Москве, МО и всей России. Звоните: +7 (495) 760-42-20.",
    "address": [
      {
        "@type": "PostalAddress",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Какие размеры каркасного тентового ангара тип В вы производите?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Мы изготавливаем ангары тип В шириной от 6 до 40 метров, длиной — любой кратно 2 метрам. Высота конька зависит от ширины и рассчитывается индивидуально."
        }
      },
      {
        "@type": "Question",
        "name": "Сколько стоит каркасный тентовый ангар тип В?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Доставляете ли ангары тип В в Московскую область и другие регионы?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Какой срок изготовления ангара тип В?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Можно ли использовать ангар тип В как склад или производственный цех?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, ангары тип В идеально подходят для склада, производственного помещения, сельскохозяйственного хранения, автомастерской или спортивного сооружения."
        }
      }
    ]
  };
