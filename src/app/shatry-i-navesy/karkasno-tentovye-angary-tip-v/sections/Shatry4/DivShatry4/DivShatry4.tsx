...
export const DivShatry4 = (): ReactElement => {
  ...
  const serviceCards = [
    { title: "Тип ангара", content: "Тип В (арочный)" },
  ...
  const accomplishments = [
    "Спроектировали каркасный тентовый ангар тип В 18×36 м под складское хранение.",
  ...
  // About company — UPDATED FOR ТИП В
  const aboutCompany = {
    title: "Наша специализация",
    paragraphs: [
      "Основная специализация компании «MOBILE TENT» — производство быстровозводимых каркасных тентовых ангаров тип В под ключ. Мы строим складские, производственные, сельскохозяйственные и спортивные объекты для бизнеса и промышленности.",
      ...
      "Каркасные тентовые ангары тип В — наша основа, но мы также проектируем ангары других типов, тентовые укрытия и шатры."
    ]
  };
  ...
  return (
    <>
      {/* Desktop Version */}
      <section
        aria-label="Кейсы и услуги MOBILE TENT — каркасные тентовые ангары тип В"
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-6">
                ...
                <h2 className="w-[528px] [font-family:'Raleway',Helvetica] text-4xl leading-normal">
                  ...
                  <span className="font-bold text-[#527dc5]">каркасный тентовый ангар тип В</span>
                </h2>
              </div>

              <p className="w-[496px] font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
                «Раньше арендовали складские площади, но рост объёмов потребовал собственного ангара. Выбрали MOBILE TENT за скорость и прозрачную смету. Ангар тип В отлично вписался в наш логистический центр».
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                  Построить каркасный тентовый ангар тип В 18×36 м для хранения готовой продукции. 
          ...
          <div className="flex flex-col">
              ...
              {previewImages.map((image, index) => {
                ...
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото каркасного тентового ангара тип В ${index + 1}`}
                  ...
                  >
                    <div className="relative w-full h-full">
                      <Image
                        src={image}
                        alt={`Каркасный тентовый ангар тип В ${index + 1}`}
            ...
            <div className="relative w-full">
              <div
                ...
                role="region"
                aria-live="polite"
                aria-label={`Главное фото ангара тип В ${currentImageIndex + 1} из ${previewImages.length}`}
              >
                <Image
                  src={previewImages[currentImageIndex]}
                  alt="Каркасный тентовый ангар тип В"
                  className="object-cover"
                  fill
                  priority
                />
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
              «Раньше арендовали склады, теперь построили собственный ангар тип В. MOBILE TENT справились за 2 недели».
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                Построить каркасный тентовый ангар тип В 18×36 м под склад. Сжатые сроки, монтаж в зимний период, снеговая нагрузка до 180 кг/м².
              </p>
            </div>
          ...
          <div className="relative w-full">
            <div
              ...
              role="region"
              aria-live="polite"
              aria-label={`Каркасный тентовый ангар тип В ${currentImageIndex + 1} из ${previewImages.length}`}
            >
              <Image
                src={previewImages[currentImageIndex]}
                alt="Каркасный тентовый ангар тип В"
              ...
              {previewImages.map((image, index) => {
                ...
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото ангара тип В ${index + 1}`}
                    aria-selected={selected}
                    role="option"
                    tabIndex={0}
                    onClick={() => selectImage(index)}
                  ...
                  >
                    <Image
                      src={image}
                      alt={`Превью ангара тип В ${index + 1}`}
                      className="object-cover"
                      fill
                      loading="lazy"
                    />
