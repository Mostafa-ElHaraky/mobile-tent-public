...
export const DivShatry4 = (): ReactElement => {
  ...
  // Data for the service cards — UPDATED FOR ТИП В
  const serviceCards = [
    { title: "Тип ангара", content: "Тип Д (Каркасные)" },
    { title: "Ширина пролёта", content: "от 6 до 40 м" },
    { title: "Срок монтажа", content: "от 3 дней" },
    { title: "Площадь", content: "любая (модульная)" },
  ];

  // “Сделали” section items — UPDATED FOR ТИП В
  const accomplishments = [
    "Спроектировали каркасный тентовый ангар тип Д 18×36 м под складское хранение.",
    "Изготовили алюминиевый каркас и ПВХ‑тент плотностью 750 г/м² на собственном производстве.",
    "Выполнили доставку, монтаж без фундамента и сдачу объекта за 10 рабочих дней.",
  ];

  // About company — UPDATED FOR ТИП Д
  const aboutCompany = {
    title: "Наша специализация",
    paragraphs: [
      "Основная специализация компании «MOBILE TENT» — производство быстровозводимых каркасных тентовых ангаров тип Д под ключ. Мы строим складские, производственные, сельскохозяйственные и спортивные объекты для бизнеса и промышленности.",
      "В Москве немало компаний, но только единицы предлагают полный цикл: от проектирования и расчёта нагрузок до изготовления каркаса, раскроя ПВХ‑ткани, монтажа и сервисного обслуживания. У нас собственное производство в Калуге и офис в Красногорске.",
      "Каркасные тентовые ангары тип Д — наша основа, но мы также проектируем ангары других типов, тентовые укрытия и шатры."
    ]
  };

  // Preview images — сохранены как есть (предположительно соответствуют типу В)
  const previewImages = [
    "/D_25x45_1.webp",
    "/D_15x40_1.webp",
    "/D_20x30_1.webp",
  ...
  return (
    <>
      {/* Desktop Version */}
      <section
        aria-label="Кейсы и услуги MOBILE TENT — каркасные тентовые ангары тип Д"
        ...
        <div className="flex flex-col md:flex-row gap-12 ml-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                <h2 className="w-[528px] [font-family:'Raleway',Helvetica] text-4xl leading-normal">
                  <span className="font-medium text-[#ffffff]">
                    Посмотрите, кто уже заказал у нас{" "}
                  </span>
                  <span className="font-bold text-[#527dc5]">каркасный тентовый ангар тип Д</span>
                </h2>
              </div>

              <p className="w-[496px] font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
                «Раньше арендовали складские площади, но рост объёмов потребовал собственного ангара. Выбрали MOBILE TENT за скорость и прозрачную смету. Ангар тип Д отлично вписался в наш логистический центр».
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                  Построить каркасный тентовый ангар тип Д 18×36 м для хранения готовой продукции. 
                  Объект должен быть готов к эксплуатации через 3 недели, бюджет — фиксированный.
                  Требования: снеговая нагрузка до 180 кг/м², монтаж без фундамента на бетонные блоки.
                </p>
              </div>
          ...
          <div className="flex flex-col">
            ...
            <div
              ...
              role="listbox"
              aria-label="Превью фотографий ангаров тип В"
            >
              {previewImages.map((image, index) => {
                ...
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото каркасного тентового ангара тип Д ${index + 1}`}
                  ...
                  >
                    <div className="relative w-full h-full">
                      <Image
                        src={image}
                        alt={`Каркасный тентовый ангар тип Д ${index + 1}`}
            ...
            <div className="relative w-full">
              <div
                ...
                role="region"
                aria-live="polite"
                aria-label={`Главное фото ангара тип Д ${currentImageIndex + 1} из ${previewImages.length}`}
              >
                <Image
                  src={previewImages[currentImageIndex]}
                  alt="Каркасный тентовый ангар тип Д"
                  className="object-cover"
                  fill
                  priority
                />
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
              «Раньше арендовали склады, теперь построили собственный ангар тип Д. MOBILE TENT справились за 2 недели».
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                Построить каркасный тентовый ангар тип Д 18×36 м под склад. Сжатые сроки, монтаж в зимний период, снеговая нагрузка до 180 кг/м².
              </p>
            </div>
          ...
          <div className="relative w-full">
            <div
              ...
              role="region"
              aria-live="polite"
              aria-label={`Каркасный тентовый ангар тип Д ${currentImageIndex + 1} из ${previewImages.length}`}
            >
              <Image
                src={previewImages[currentImageIndex]}
                alt="Каркасный тентовый ангар тип Д"
            ...
            <div
              ...
              role="listbox"
              aria-label="Превью фотографий ангаров тип Д"
            >
              {previewImages.map((image, index) => {
                const selected = currentImageIndex === index;
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото ангара тип Д ${index + 1}`}
                    aria-selected={selected}
                    role="option"
                    tabIndex={0}
                    onClick={() => selectImage(index)}
                  ...
                  >
                    <Image
                      src={image}
                      alt={`Превью ангара тип Д ${index + 1}`}
                      className="object-cover"
                      fill
                      loading="lazy"
                    />
