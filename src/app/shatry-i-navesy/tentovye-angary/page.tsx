...
export const metadata: Metadata = {
  title: "Быстровозводимые тентовые ангары под ключ купить по доступной цене за м2 от производителя MOBILE TENT",
  description: "Купить тентовые ангары в Москве разных конструкций для любых мероприятий. Заказать тентовые ангары по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
