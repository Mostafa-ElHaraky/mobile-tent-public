...
export const metadata: Metadata = {
  title: "Заказать тентовые ангары 15x20 м2 недорого по цене производителя с доставкой",
  description: "Купить тентовые ангары размером 15x20 метров по сниженной цене с доставкой в компании MOBILE TENT. Гарантия производителя, специальные скидки для покупателей!",
