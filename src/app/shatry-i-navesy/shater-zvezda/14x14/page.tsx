...
export const metadata: Metadata = {
  title: "Шатры звезда 14х14 м2 купить по оптимальной цене в компании MOBILE TENT от производителя",
  description: "Купить шатры звезда 14х14 метров по цене производителя с доставкой по всей России. Отзывы и характеристики шатров Звезда 14х14. Выгодные акции, быстрая доставка, гарантии.",
