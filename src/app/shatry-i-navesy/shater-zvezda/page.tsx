...
export const metadata: Metadata = {
  title: "Купить шатры звезда по цене производителя",
  description: "Купить шатры звезда по доступной цене в MOBILE TENT. Отзывы на шатры звезда для пикников и семейных мероприятий, быстрая доставка, гарантии от производителя.",
