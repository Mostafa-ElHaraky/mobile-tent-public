...
export const metadata: Metadata = {
  title: "Флаги | Mobile Tent",
  description: "Изготовление рекламных флагов парус в Краснодаре от производителя МобайлТент. Доступные цены, доставка по всей территории России",
