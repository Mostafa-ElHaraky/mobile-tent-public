...
export const metadata: Metadata = {
  title: "Купить арочные ангары под ключ по цене от производителя MOBILE TENT",
  description: "Купить арочные ангары в Москве разных конструкций для любых мероприятий. Заказать арочные ангары по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
