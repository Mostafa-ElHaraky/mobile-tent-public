...
export const metadata: Metadata = {
  title: "Садовые навесы и шатры для отдыха | Mobile Tent",
  description: "Вы хотите купить дешево садовые шатры, тенты и навесы: цены от интернет-магазина МобайлТент? Мы поставляем нашу продукцию по всей территории России.",
