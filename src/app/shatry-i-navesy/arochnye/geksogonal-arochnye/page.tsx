...
export const metadata: Metadata = {
  title: "Арочные шатры Гексагональ | Mobile Tent",
  description: "Купить арочные шатры Гексагональ в Москве разных конструкций для любых мероприятий. Заказать арочные шатры Гексагональ по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
