...
export const metadata: Metadata = {
  title: "Купить арочные шатры 10х3 м по выгодным ценам в MOBILE TENT",
  description: "Заказать арочные шатры размером 10х3 метра недорого у компании-производителя MOBILE TENT. Доставляем по всей России. Скидки, акции, гарантия качества.",
