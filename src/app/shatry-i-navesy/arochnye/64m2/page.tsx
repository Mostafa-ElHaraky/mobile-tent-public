...
export const metadata: Metadata = {
  title: "Купить арочные шатры 64 m2 недорого в компании MOBILE TENT",
  description: "Заказать арочные шатры 64 кв м по доступной стоимости. Широкий ассортимент, быстрая доставка.",
