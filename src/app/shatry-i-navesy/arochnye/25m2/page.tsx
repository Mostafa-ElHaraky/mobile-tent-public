...
export const metadata: Metadata = {
  title: "Купить арочные шатры 25 m2 по доступной цене в MOBILE TENT",
  description: "Купить арочные шатры 25 кв м по сниженной цене в каталоге производителя MOBILE TENT. Скидки и акции. Доставка от 2-х дней по России.",
