...
export const metadata: Metadata = {
  title: "Арочные шатры 36 м2 купить по лучшей цене у производителя",
  description: "Купить арочные шатры 36 кв м по оптимальной цене от производителя. MOBILE TENT - быстрая доставка, скидки!",
