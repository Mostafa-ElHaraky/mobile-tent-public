...
export const metadata: Metadata = {
  title: "Купить арочные шатры 10х10 м2 недорого от производителя",
  description: "Заказать арочные шатры 10х10 метров по доступной стоимости в компании MOBILE TENT с доставкой по России. Изготовление и продажа арочных шатров 10х10 м2 от производителя.",
