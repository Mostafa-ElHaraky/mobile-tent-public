...
export const metadata: Metadata = {
  title: "Купить арочные шатры 3.5х3.5 м по выгодной цене в MOBILE TENT с доставкой",
  description: "Купить компактные арочные шатры 3.5х3.5 метров недорого от компании MOBILE TENT. Доставляем по России от 2х дней. Гарантии!",
