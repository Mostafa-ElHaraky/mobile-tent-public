...
export const metadata: Metadata = {
  title: "Арочные шатры Октагональ | Mobile Tent",
  description: "Купить арочные шатры Октагональ в Москве разных конструкций для любых мероприятий. Заказать арочные шатры Октагональ по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
