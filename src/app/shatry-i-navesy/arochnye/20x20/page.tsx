...
export const metadata: Metadata = {
  title: "Заказать арочные шатры 20х20 м2 по цене производителя MOBILE TENT",
  description: "Купить арочные шатры 20х20 метров по доступной стоимости в компании MOBILE TENT с доставкой по России. Изготовление  и продажа арочных шатров 20х20 м2 для мероприятий от производителя с гарантией.",
