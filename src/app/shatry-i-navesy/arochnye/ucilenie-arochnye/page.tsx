...
export const metadata: Metadata = {
  title: "Арочные шатры усиленные | Mobile Tent",
  description: "Купить арочные шатры усиленные в Москве разных конструкций для любых мероприятий. Заказать арочные шатры усиленные по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
