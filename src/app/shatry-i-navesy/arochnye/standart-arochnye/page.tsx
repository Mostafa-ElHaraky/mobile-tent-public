...
export const metadata: Metadata = {
  title: "Арочные шатры Стандарт | Mobile Tent",
  description: "Купить арочные шатры Стандарт в Москве разных конструкций для любых мероприятий. Заказать арочные шатры Стандарт по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
