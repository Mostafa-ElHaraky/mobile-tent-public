...
export const metadata: Metadata = {
  title: "Арочные шатры 8х8 м купить по доступной цене производителя",
  description: "Купить устойчивые арочные шатры и навесы 8х8 метров недорого в MOBILE TENT. Доставим по всей России. Гарантируем качество!",
