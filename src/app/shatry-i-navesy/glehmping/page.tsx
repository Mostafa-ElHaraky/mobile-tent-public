...
export const metadata: Metadata = {
  title: "Купить шатры-геокуполы для глэмпинга по лучшей цене в MOBILE TENT с доставкой",
  description: "Купить глэмпинг в Москве и России. Заказать глэмпинг по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 499 325 87 05.",
