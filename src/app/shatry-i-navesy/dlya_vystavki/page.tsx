...
export const metadata: Metadata = {
  title: "Шатры для выставок купить недорого в MOBILE TENT",
  description: "Купить выставочные шатры в Москве разных конструкций для любых мероприятий. Заказать выставочные шатры по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
