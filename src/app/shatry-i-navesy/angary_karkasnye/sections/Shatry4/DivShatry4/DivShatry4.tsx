...
export const DivShatry4 = (): ReactElement => {
  ...
  // Data for the service cards — UPDATED FOR АНГАРЫ
  const serviceCards = [
    { title: "Компания", content: "MOBILE TENT" },
    { title: "Объект", content: "г. Красногорск" },
    { title: "Срок монтажа", content: "12 дней" },
    { title: "Площадь", content: "648 м²" },
  ];

  // “Сделали” section items — UPDATED FOR АНГАРЫ
  const accomplishments = [
    "Спроектировали каркасный ангар 18×36 м под складское хранение.",
    "Изготовили металлокаркас и утеплённые сэндвич-панели на собственном производстве.",
    "Выполнили доставку, монтаж фундамента и сборку ангара за 12 рабочих дней.",
  ];

  // About company — UPDATED FOR АНГАРЫ
  const aboutCompany = {
    title: "Наша специализация",
    paragraphs: [
      "Основная специализация компании «MOBILE TENT» — производство быстровозводимых каркасных ангаров под ключ. Мы строим складские, производственные, сельскохозяйственные и спортивные объекты для бизнеса и промышленности.",
      "В Москве немало компаний, но только единицы предлагают полный цикл: от проектирования и расчёта нагрузок до изготовления металлокаркаса, монтажа и сервисного обслуживания. У нас собственное производство в Калуге и офис в Красногорске.",
      "Каркасные ангары — наша основа, но мы также проектируем тентовые укрытия, шатры и бескаркасные конструкции."
    ]
  };

  // Preview images — сохранены как есть
  const previewImages = [
    "/angar1.webp",
    "/angar2.webp",
    "/angar1.webp",
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-6">
                ...
                <h2 className="w-[528px] [font-family:'Raleway',Helvetica] text-4xl leading-normal">
                  ...
                  <span className="font-bold text-[#527dc5]">каркасный ангар</span>
                </h2>
              </div>

              <p className="w-[496px] font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
                «Раньше арендовали складские площади, но рост объёмов потребовал собственного ангара. Выбрали MOBILE TENT за скорость и прозрачную смету. Не пожалели».
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                  Построить утеплённый каркасный ангар 18×36 м для хранения готовой продукции. 
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
              «Раньше арендовали склады, теперь построили собственный ангар. MOBILE TENT справились за 2 недели».
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                Построить утеплённый каркасный ангар 18×36 м под склад. Сжатые сроки, монтаж в зимний период.
              </p>
            </div>
          ...
          <div className="relative w-full">
            <div
              ...
              role="region"
              aria-live="polite"
              aria-label={`Каркасные Ангары ${currentImageIndex + 1} из ${previewImages.length}`}
            >
              <Image
                src={previewImages[currentImageIndex]}
                alt="Каркасные Ангары"
