...
interface FrameShatry8Props {
  contacts?: ContactInfo;
}

export const FrameShatry8 = ({ contacts }: FrameShatry8Props): ReactElement => {
  ...
  // Use dynamic contact information from props, fallback to defaults
  const contactInfo = [
    {
    ...
    },
    {
      ...
      phoneLink: `tel:${contacts?.phone1?.replace(/\D/g, '') || '+74991133660'}`,
      hasLink: false,
    },
    {
      icon: "/element8-12.webp",
      text: contacts?.phone2 || "8 (800) 302-46-31",
      phoneLink: `tel:${contacts?.phone2?.replace(/\D/g, '') || '88003024631'}`,
      hasLink: false,
    },
    {
  ...
  return (
    <>
      {/* Desktop Version */}
      <section className="hidden md:block w-full py-16 px-12 relative top-[70px]">
