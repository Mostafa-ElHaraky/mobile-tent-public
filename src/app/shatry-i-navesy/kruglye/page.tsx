...
export const metadata: Metadata = {
  title: "Купить купольные шатры по выгодной стоимости от производителя MOBILE TENT с доставкой по России",
  description: "Купить купольные шатры в Москве и России. Заказать купольные шатры по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 499 325 87 05.",
