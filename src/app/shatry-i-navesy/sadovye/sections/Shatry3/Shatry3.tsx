    ...
    <>
      ...
      <main className="hidden md:flex flex-col w-full max-w-[1440px] mx-auto min-h-0 bg-white pb-[5px]">
        <section className="flex flex-col w-full max-w-[1440px] gap-[40px] mx-auto px-12 min-h-0">
          ...
          <section className="w-full max-w-[1440px] min-h-[334px] rounded-[30px] relative">
            <FrameShatry3 />
          </section>

          <section className="flex flex-col w-full max-w-[1440px] gap-[45px] mt-80 mx-auto">
            <GroupWrapperShatry3 />
          </section>
        </section>
      </main>
      ...
      <main className="flex md:hidden flex-col w-full mx-auto min-h-0 bg-white pb-[5px]">
        <section className="flex flex-col w-full gap-[20px] mx-auto px-4 min-h-0">
          ...
          <section className="w-full min-h-[200px] rounded-[20px] relative overflow-hidden mt-[-180]">
            <FrameShatry3 />
          </section>

          <section className="flex flex-col w-full gap-[25px] mt-40 mx-auto">
            <GroupWrapperShatry3 />
          </section>
        </section>
      </main>
