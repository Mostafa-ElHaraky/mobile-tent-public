...
export const FrameShatry7 = (): ReactElement => {
  ...
  const serviceFeatures = [
    { icon: "/element7-10.png", title: "Произведет замеры участка", description: "и соберет данные для создания бесплатного 3D проекта" },
    { icon: "/element7-11.png", title: "Покажет разные ткани", description: "для сравнения качества" },
    { icon: "/element7-12.png", title: "Расскажет о циклах", description: "и методах производства" },
    { icon: "/element7-13.png", title: "Отвезет на реальные объекты", description: "смонтированные у клиентов" },
  ];
  ...
  const cisCountries = [
    { name: "Казахстан", flagSrc: "/ellipse-14.png" },
    { name: "Узбекистан", flagSrc: "/ellipse-14-1.png" },
    { name: "Азербайджан", flagSrc: "/ellipse-14-2.png" },
    { name: "Республика Беларусь", flagSrc: "/ellipse-14-3.png" },
  ];
  ...
  // ✅ Move testimonials BEFORE using it anywhere
  const testimonials: Testimonial[] = useMemo(
    () => [
      ...
      },
      {
        ...
        images: ["/rectangle-58.png", "/rectangle-57.png"],
      },
      {
        text:
            ...
            >
              <CardContent className="p-0 w-full flex flex-col items-center">
                ...
                {!card.hasSpecialImages ? (
                  <Image
                    src={card.imageSrc || '/fallback.jpg'}
                ...
                <div className="w-[1344px] h-[81px] flex items-center gap-[62px] mb-17">
                ...
                <Card className="w-[1343px] h-[326px] bg-white relative bottom-[85px] rounded-[20px] shadow-[0px_24px_38px_#161D2414] backdrop-blur-[158px] relative border-0">
                  <CardContent className="p-0">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-start gap-3">
            ...
            <div className="flex items-center gap-2">
              <Image alt="Review icon" src="/group-14.png" width={24} height={24} />
          ...
          <div className="flex justify-center gap-4">
            {testimonial.images.map((image, index) => (
              <div key={index} className="relative w-[150px] h-[150px] rounded-lg overflow-hidden">
                <Image src={image} alt={`Testimonial ${index + 1}`} fill className="object-cover" />
              </div>
            ))}
          </div>

          {/* Text Card - Matching desktop style */}
          <Card className="w-full bg-white rounded-[20px] shadow-[0px_24px_38px_#161D2414] border-0 p-6">
            <CardContent className="p-0">
              <div className="flex items-start gap-4">
                <div className="relative w-[50px] h-[0px] -rotate-180 -mt-2 -ml-1">
                  <Image className="rotate-180" alt="Quote" src="/group-15.png" width={40} height={30} />
                </div>
          ...
          {/* Navigation Buttons - Outside card and centered */}
          <div className="flex justify-center gap-6 mt-4">
            <Button
              ...
              aria-label="Previous testimonial"
            >
              <Image alt="Previous" src="/group-16.png" width={20} height={20} />
            </Button>
            ...
            <Button
              ...
              aria-label="Next testimonial"
            >
              <Image alt="Next" src="/group-17.png" width={20} height={20} />
            </Button>
          </div>
        </div>
      </section>
