...
export const FrameShatry8 = (): ReactElement => {
  // 👉 Images for the carousel (ensure these paths exist in /public)
  const carouselImages = [
    '/rectangle-65.png',
    '/rectangle-66.png',
    '/collect4.png', // add your 3rd image here (e.g. "Металлическая конструкция")
  ];
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="relative flex mb-8">
                ...
                <div
                  className="relative w-[328px] h-[310px] bg-[url(/rectangle-66.png)] bg-cover bg-[50%_50%]"
                  style={{
