...
export const GroupShatry5 = (): ReactElement => {
  ...
  const videoData: VideoData[] = [
    { id: '77871ba30cfd4c611b1ef1c1582e9912', bgImage: '/rutube-thumbnail.png' },
    { id: '10bc97b3df79d9ac37967a39b1037a5f', bgImage: '/bg-rutube3.png' },
    { id: 'ac34a17e3572ac3925c698e52ad2b429', bgImage: '/bg-rutube4.png' },
  ];
