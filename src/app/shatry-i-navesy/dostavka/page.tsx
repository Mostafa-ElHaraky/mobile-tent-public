...
export const metadata: Metadata = {
  title: "Доставка шатров, тентов и навесов по России",
  description: "Осуществляем доставку шатров и тентовых конструкций по России от двух рабочих дней. Звоните!",
