...
export const metadata: Metadata = {
  title: "Надувные шатры купить по лучшей цене от производителя MOBILE TENT",
  description: "Купить надувные шатры в Москве и России. Заказать надувные шатры по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 499 325 87 05.",
