...
export const metadata: Metadata = {
  title: "Зонты уличные 3м2 для ресторанов заказать недорого у производителя MOBILE TENT",
  description: "Заказать зонты уличные 3м2 для кафе и ресторанов по выгодной стоимости в компании MOBILE TENT. Доставка по РФ, гарантии, скидки.",
