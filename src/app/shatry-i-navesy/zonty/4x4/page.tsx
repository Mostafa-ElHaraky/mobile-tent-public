...
export const metadata: Metadata = {
  title: "Зонты для кафе уличные 4х4 м2 купить по оптимальной цене в компании MOBILE TENT с доставкой",
  description: "Заказ уличных зонтов 4х4 метра для кафе и ресторанов по цене от производителя MOBILE TENT. Доставка по всей России. Гарантии качества, постоянные скидки, акции.",
