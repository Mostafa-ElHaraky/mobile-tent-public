...
export const metadata: Metadata = {
  title: "Купить зонты для кафе уличные 2х2 м2 по доступной цене от MOBILE TENT",
  description: "Заказать уличные зонты для летних кафе 2х2 метра по сниженной стоимости в MOBILE TENT. Доставка по всей России. Гарантированное качество, дополнительные скидки.",
