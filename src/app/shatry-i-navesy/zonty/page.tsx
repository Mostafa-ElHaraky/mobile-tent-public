...
export const metadata: Metadata = {
  title: "Купить уличные зонты от солнца для ресторанов и кафе по доступным ценам в MOBILE TENT",
  description: "Купить зонты в Москве разных конструкций для любых мероприятий. Заказать зонты по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
