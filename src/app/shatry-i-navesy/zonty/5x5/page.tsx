...
export const metadata: Metadata = {
  title: "Купить уличные зонты 5х5 м2 для кафе и ресторанов недорого от производителя",
  description: "Заказать уличные зонты размером 5х5 метров для кафе и ресторанов по доступной цене в MOBILE TENT. Надежная доставка по всей России. Гарантированные скидки и акции.",
