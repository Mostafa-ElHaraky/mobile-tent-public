...
export const DivShatry4 = (): ReactElement => {
  ...
  const serviceCards = [
    ...
    { title: "Тип шатра", content: "Пагода" },
    { title: "Срок изготовления", content: "от 14 дней" },
    { title: "Площадь", content: "до 250 м²" },
  ];

  const accomplishments = [
    "Разработали дизайн и конфигурацию пагода шатра под требования площадки и восточную стилистику.",
    "Изготовили многоярусную конструкцию, подготовили к отгрузке, согласовали логистику.",
    "Выполнили доставку и монтаж пагода шатра, оформили пространство в восточном стиле и провели инструктаж.",
  ];

  const aboutCompany = {
    title: "Наша специализация – пагода шатры",
    paragraphs: [
      "Основная специализация компании «MOBILE TENT» — изготовление пагода шатров на заказ. Мы помогаем организовывать мероприятия на свежем воздухе любого масштаба — от изысканных свадеб до премиальных корпоративов — и надёжно защищаем их от ветра и непогоды.",
      "В столице достаточно компаний, но немногие берут на себя высокий уровень сервиса и комплексный подход именно к пагода‑конструкциям. У нас можно не только выгодно купить пагода шатёр, но и получить полный цикл сопутствующих услуг, чтобы упростить организацию мероприятия.",
      "Изготовление и продажа пагода шатров — наша основа, но мы предлагаем куда больше."
    ]
  };
  ...
  return (
    <>
      {/* Desktop Version */}
      <section
        aria-label="Кейсы и услуги MOBILE TENT – пагода шатры"
        ...
        <div className="flex flex-col md:flex-row gap-12 ml-8">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-6">
                ...
                <h2 className="w-[528px] [font-family:'Raleway',Helvetica] text-4xl leading-normal">
                  ...
                  <span className="font-bold text-[#527dc5]">пагода шатрами</span>
                </h2>
              </div>

              <p className="w-[496px] font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
                «До этого был обычный шатёр — через год испортился внешний вид. Ваш пагода шатёр заметно лучше выглядит и привлекает гостей своим восточным шармом».
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="w-[418px] font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                  Организовать быстромонтируемое пагода‑покрытие на открытой площадке с учётом брендинга,
                  восточного стиля, потоков гостей и ограничений по логистике/времени монтажа.
                </p>
              </div>
          ...
          <div className="flex flex-col">
            <div
              ...
              role="listbox"
              aria-label="Превью фотографий пагода шатров"
            >
              {previewImages.map((image, index) => {
                ...
                return (
                  <button
                    key={index}
                    type="button"
                    aria-label={`Показать фото пагода шатра ${index + 1}`}
                  ...
                  >
                    <div className="relative w-full h-full">
                      <Image
                        src={image}
                        alt={`Превью пагода шатра ${index + 1}`}
            ...
            <div className="relative w-full">
              <div
                ...
                role="region"
                aria-live="polite"
                aria-label={`Главное фото пагода шатра ${currentImageIndex + 1} из ${previewImages.length}`}
              >
                <Image
                  src={previewImages[currentImageIndex]}
                  alt="Главное фото пагода шатра"
                  className="object-contain"
                  fill
                  priority
                />
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="font-semibold text-[#ffffff] text-base leading-6 [font-family:'Raleway',Helvetica]">
              «До этого был обычный шатёр — через год внешний вид ухудшился. Ваш пагода шатёр выглядит лучше и создаёт уникальную атмосферу».
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="font-normal text-[#ffffff] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                Подготовить пагода‑шатровую инфраструктуру под площадку и бренд с быстрым монтажом и понятной эксплуатацией.
              </p>
            </div>
