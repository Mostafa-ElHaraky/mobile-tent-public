...
export const metadata: Metadata = {
  title: "Купить шатер Пагода 4х4 м  недорого с доставкой от производителя MOBILE TENT",
  description: "Предлагаем шатер Пагода 4х4 м с доставкой по России. Прочные конструкции, быстрая установка. Идеально для мероприятий, выставок и торговли. Гарантия качества от Mobile Tent.",
