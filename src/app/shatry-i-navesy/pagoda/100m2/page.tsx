...
export const metadata: Metadata = {
  title: "Купить шатер Пагода 100 м² недорого с доставкой по России",
  description: "Предлагаем шатры Пагода площадью 100 м² для мероприятий. Продажа с доставкой по всей России. Высокое качество и надежность.​ Предлагаем широкий ассортимент в каталоге.",
