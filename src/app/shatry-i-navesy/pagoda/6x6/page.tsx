...
export const metadata: Metadata = {
  title: "Купить шатер Пагода 6х6 м по цене производителя Mobile Tent с доставкой по России",
  description: "Предлагаем купить шатер Пагода 6х6 м для мероприятий, выставок и торговли. Прочные конструкции, быстрая установка, доставка по России. Гарантия качества от Mobile Tent.",
