...
export const metadata: Metadata = {
  title: "Пагода шатры Лондон | Mobile Tent",
  description: "Купить пагода шатры Лондон в Москве разных конструкций для любых мероприятий. Заказать пагода шатры Лондон по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 (499) 113 36 60.",
