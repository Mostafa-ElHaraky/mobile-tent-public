...
export const metadata: Metadata = {
  title: "Заказать Шатры «Пагода» 10x10 м – быстрый монтаж и премиальное качество от производителя MOBILE TENT",
  description: "Предлагаем шатры «Пагода» размером 10x10 метров с прочным металлокаркасом и водостойким ПВХ-покрытием. Быстрый монтаж без спецтехники, возможность брендирования и дополнительные опции.",
