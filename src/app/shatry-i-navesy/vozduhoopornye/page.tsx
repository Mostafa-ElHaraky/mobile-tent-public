...
export const metadata: Metadata = {
  title: "Купить шатры для мероприятий в Москве и России по лучшей стоимости на Mobile-Tent.ru",
  description: "Купить шатры для мероприятий в Москве и России. Заказать шатры для мероприятий по оптимальным ценам предлагаем на нашем сайте. Звоните: +7 499 325 87 05.",
