...
export const metadata: Metadata = {
  title: "Купить шатер пагода для выставки по выгодным ценам от  MOBILE TENT",
  description: "Купить шатры Пагода для выставок от MOBILE TENT. Изысканный стиль и функциональность. Узнайте цены на шатры Пагода и сделайте ваш выбор сегодня.",
