...
export const metadata: Metadata = {
  title: "Зонты для загородного дома заказать по доступной цене в компании MOBILE TENT",
  description: "Купить зонты для загородного дома недорого от производителя MOBILE TENT. Скидки, акции, оперативная доставка.",
