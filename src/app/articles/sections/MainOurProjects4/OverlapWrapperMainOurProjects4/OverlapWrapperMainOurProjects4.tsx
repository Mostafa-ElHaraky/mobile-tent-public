...
export const OverlapWrapperMainOurProjects4 = (): ReactElement => {
  ...
  return (
    <>
      ...
      <section className="hidden md:block relative w-[1440px] h-[726px] bottom-[28px] rounded-[30px] overflow-hidden shadow-[var(--)] backdrop-blur-[79px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(79px)_brightness(100%)] mx-auto flex justify-center items-center">
        <div className="relative h-[418px] bottom-[20px]">
          <div className="absolute w-full h-[529px] top-[89px] left-0 rounded-[30px] [background:linear-gradient(180deg,rgba(245,246,255,1)_0%,rgba(245,246,255,0)_100%)]" />
