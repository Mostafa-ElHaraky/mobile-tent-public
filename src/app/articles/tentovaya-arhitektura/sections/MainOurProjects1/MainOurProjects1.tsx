...
export const MainOurProjects1 = (): ReactElement => {
  ...
  return (
    <div className="relative w-full">
      ...
      <h1 className="sr-only">Тентовая архитектура - производство и установка каркасно-тентовых сооружений от MobileTent</h1>
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto">
        ...
        <section className="relative rounded-[0px_0px_30px_30px] hidden sm:block">
          ...
          <div className="pt-8 absolute bottom-[485px]">
            <Header />
          </div>
