...
export const metadata: Metadata = {
  title: "Купить шатры Звезда для кафе и ресторанов по лучшей цене в MOBILE TENT",
  description: "Купить шатры Звезда для кафе и ресторанов недорого с быстрой доставкой по всей России. Гарантии качества, выгодные скидки.",
